...
class SkillsStorage:
    ...
    def get_cached_skills(self, context_hash: str) -> Optional[List[str]]:
    ...
    def track_skill_usage(self, mission_id: str, agent_role: str, skill_id: str, injected: bool = True, used: bool = False):
