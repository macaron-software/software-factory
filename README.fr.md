...
Une **application macOS native SwiftUI** (Apple Silicon et Rosetta 2) est disponible en complément de la plateforme web. Elle offre une instance SF locale entièrement hors-ligne ainsi que des connecteurs vers les déploiements OVH et Azure.

<table>
<tr>
<td width="33%">
<strong>Onboarding — Config LLM & Instances</strong><br>
<img src="docs/screenshots/macos/onboarding.png" alt="macOS Onboarding" width="100%">
</td>
<td width="33%">
<strong>Dashboard — Agents & Missions</strong><br>
<img src="docs/screenshots/macos/dashboard.png" alt="macOS Dashboard" width="100%">
</td>
<td width="33%">
<strong>Analytics — DORA & Évaluations</strong><br>
<img src="docs/screenshots/macos/analytics.png" alt="macOS Analytics" width="100%">
</td>
</tr>
</table>
...
```bash
# Télécharger et lancer (Apple Silicon)
...
> Si macOS bloque le binaire : **Réglages système → Confidentialité et sécurité → Ouvrir quand même**

### Fonctionnalités
- **SF locale intégrée** — agents avec Ollama/MLX (Qwen, Llama…) ou clés API — aucun serveur requis
- **3 connecteurs distants** — SF locale / démo OVH / prod Azure (HA 2 nœuds)
- **100% ISO web** — Agents, Missions, Projets, TMA, Wiki, Analytics, DORA, Évals, Idéation, RBAC
- **Assistant d'onboarding** — détecte automatiquement les modèles MLX/Ollama, aucun fichier de config
- **22 tests unitaires** — WSJF, LLMConfig, onboarding, gestion d'instances

### Compiler depuis les sources

```bash
git clone https://github.com/macaron-software/software-factory.git
cd software-factory/sf-swift
swift build -c release
.build/release/SFApp
```

Prérequis : **Xcode 15+**, macOS 14+, Swift 5.9+
