...
Config (env or args):
  JIRA_URL      e.g. https://jira.net.extra.laposte.fr/jira
...
def _get_config() -> Dict[str, str]:
    return {
        "url": os.environ.get("JIRA_URL", "https://jira.net.extra.laposte.fr/jira").rstrip("/"),
        "token": _load_token(),
...
def _anon_issue(issue: Dict) -> Dict:
    ...
    return {
        ...
        "epic_link": fields.get("customfield_10014") or fields.get("epic", {}).get("key", ""),
    }
...
TOOLS = [
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {
                "jql": {"type": "string", "description": "JQL query (ex: 'status = \"In Progress\"')"},
                "project": {"type": "string", "description": "Clé projet (ex: VELIGO). Optionnel si JIRA_PROJECT est set."},
                "max_results": {"type": "integer", "description": "Nombre max de résultats (défaut: 20)", "default": 20},
            },
            "required": ["jql"],
        },
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {
                "issue_key": {"type": "string", "description": "Clé Jira (ex: VELIGO-42)"},
            },
            "required": ["issue_key"],
        },
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {
                "project": {"type": "string", "description": "Clé projet. Optionnel si JIRA_PROJECT est set."},
    ...
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {
                "board_id": {"type": "string", "description": "ID du board. Optionnel si JIRA_BOARD_ID est set."},
            },
        },
    },
    {
...
class MCPJiraServer:
    ...
    def _dispatch(self, name: str, args: Dict) -> str:
        if name == "jira_search":
            return tool_jira_search(args.get("jql", ""), args.get("max_results", 20), args.get("project", ""))
        if name == "jira_get_issue":
            return tool_jira_get_issue(args["issue_key"])
        if name == "jira_get_backlog":
            return tool_jira_get_backlog(args.get("project", ""), args.get("max_results", 30))
