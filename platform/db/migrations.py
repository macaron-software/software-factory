...
def _migrate(conn):
    ...
    _integ_extended = [
        ...
        (
            ...
            "testing",
            "🕷️",
            "github.com/scrapy/scrapy — Web scraping & crawling framework. Agents can schedule and run crawls for competitive intelligence, doc harvesting, and QA link checks.",
        ...
        (
            ...
            "devops",
            "📦",
            "github.com/alibaba/OpenSandbox — Secure sandboxed code execution environment. Agents can run untrusted code safely in isolated containers.",
        ...
        (
            ...
            "testing",
            "🦗",
            "github.com/locustio/locust — Scalable load testing tool in Python. Agents can trigger performance tests and interpret ramp-up results.",
        ...
        (
            ...
            "testing",
            "⚡",
            "github.com/grafana/k6 — Modern load & performance testing. JavaScript-based scenarios, threshold assertions, CI-friendly output.",
        ...
        (
            ...
            "security",
            "🐷",
            "github.com/trufflesecurity/trufflehog — Scan Git history, branches, and PRs for leaked secrets, API keys, and credentials.",
        ...
        (
            ...
            "security",
            "🔍",
            "github.com/returntocorp/semgrep — Fast, lightweight static analysis. 2000+ rules for OWASP, secrets, and code quality across 30+ languages.",
        ...
        (
            ...
            "security",
            "✅",
            "github.com/bridgecrewio/checkov — IaC security scanner for Terraform, CloudFormation, Kubernetes, Dockerfile, Helm.",
        ...
        (
            ...
            "security",
            "🕵️",
            "github.com/zaproxy/zaproxy — Web application security scanner. Automated DAST scans, spider, active attack simulation.",
        ...
        (
            ...
            "devops",
            "♻️",
            "github.com/renovatebot/renovate — Automated dependency updates. Detects outdated packages and opens PRs to upgrade them.",
        ...
        (
            ...
            "devops",
            "🏷️",
            "github.com/semantic-release/semantic-release — Fully automated versioning and package publishing based on commit messages.",
        ...
        (
            ...
            "devops",
            "🐳",
            "github.com/hadolint/hadolint — Dockerfile linter and best practices checker. Agents review Dockerfiles before build.",
        ...
        (
            ...
            "architecture",
            "🧜",
            "github.com/mermaid-js/mermaid — Diagrams as code (flowchart, sequence, ER, Gantt). Agents render architecture diagrams in docs.",
        ...
        (
            ...
            "architecture",
            "🏛️",
            "github.com/structurizr/structurizr-cli — C4 model architecture diagrams as code. Agents can generate and export system context diagrams.",
        ...
        (
            ...
            "devops",
            "📚",
            "github.com/squidfunk/mkdocs-material — Documentation site generator. Agents generate and publish markdown documentation.",
        ...
        (
            ...
            "devops",
            "🔬",
            "github.com/mlflow/mlflow — ML experiment tracking, model registry, and deployment. Agents log LLM experiments and compare results.",
        ...
        (
            ...
            "testing",
            "🌐",
            "github.com/httpie/cli — Human-friendly HTTP client. Agents call and test REST APIs interactively with clear output.",
...
def _migrate_pg(conn):
    ...
    _github_tools = [
        (
            ...
            "testing",
            "🕷️",
            "github.com/scrapy/scrapy — Web scraping & crawling framework.",
            '{"repo_url":"https://github.com/scrapy/scrapy","version":"latest"}',
            '["dev","qa","marketing","data"]',
        ),
        (
            ...
            "devops",
            "📦",
            "github.com/alibaba/OpenSandbox — Secure sandboxed code execution.",
            '{"repo_url":"https://github.com/alibaba/OpenSandbox","version":"latest"}',
            '["dev","security","qa","architecture"]',
        ),
        (
            ...
            "testing",
            "🦗",
            "github.com/locustio/locust — Scalable load testing.",
            '{"repo_url":"https://github.com/locustio/locust","version":"latest","target_url":""}',
            '["qa","dev","architecture"]',
        ),
        (
            ...
            "testing",
            "⚡",
            "github.com/grafana/k6 — Modern load & performance testing.",
            '{"repo_url":"https://github.com/grafana/k6","version":"latest","target_url":""}',
            '["qa","dev","architecture"]',
        ),
        (
            ...
            "security",
            "🐷",
            "github.com/trufflesecurity/trufflehog — Secret scanning.",
            '{"repo_url":"https://github.com/trufflesecurity/trufflehog","scan_depth":"100"}',
            '["security","dev","qa"]',
        ),
        (
            ...
            "security",
            "🔍",
            "github.com/returntocorp/semgrep — Static analysis, 2000+ rules.",
            '{"repo_url":"https://github.com/returntocorp/semgrep","ruleset":"auto"}',
            '["security","dev","qa","reviewer"]',
        ),
        (
            ...
            "security",
            "✅",
            "github.com/bridgecrewio/checkov — IaC security scanner.",
            '{"repo_url":"https://github.com/bridgecrewio/checkov","framework":"terraform,kubernetes"}',
            '["security","architecture","dev"]',
        ),
        (
            ...
            "security",
            "🕵️",
            "github.com/zaproxy/zaproxy — Web application security scanner.",
            '{"repo_url":"https://github.com/zaproxy/zaproxy","target_url":"","scan_mode":"baseline"}',
            '["security","qa","dev"]',
        ),
        (
            ...
            "devops",
            "♻️",
            "github.com/renovatebot/renovate — Automated dependency updates.",
            '{"repo_url":"https://github.com/renovatebot/renovate","auto_merge":"patch"}',
            '["dev","architecture","security"]',
        ),
        (
            ...
            "devops",
            "🏷️",
            "github.com/semantic-release/semantic-release — Automated versioning.",
            '{"repo_url":"https://github.com/semantic-release/semantic-release","branch":"main"}',
            '["dev","architecture"]',
        ),
        (
            ...
            "devops",
            "🐳",
            "github.com/hadolint/hadolint — Dockerfile linter.",
            '{"repo_url":"https://github.com/hadolint/hadolint"}',
            '["dev","security","architecture"]',
        ),
        (
            ...
            "architecture",
            "🧜",
            "github.com/mermaid-js/mermaid — Diagrams as code.",
            '{"repo_url":"https://github.com/mermaid-js/mermaid"}',
            '["architecture","dev","product"]',
        ),
        (
            ...
            "architecture",
            "🏛️",
            "github.com/structurizr/structurizr-cli — C4 model diagrams.",
            '{"repo_url":"https://github.com/structurizr/structurizr-cli"}',
            '["architecture","dev"]',
        ),
        (
            ...
            "devops",
            "📚",
            "github.com/squidfunk/mkdocs-material — Documentation site generator.",
            '{"repo_url":"https://github.com/squidfunk/mkdocs-material","site_dir":"docs/site"}',
            '["dev","architecture","product"]',
        ),
        (
            ...
            "devops",
            "🔬",
            "github.com/mlflow/mlflow — ML experiment tracking.",
            '{"repo_url":"https://github.com/mlflow/mlflow","tracking_uri":""}',
            '["dev","architecture","data"]',
        ),
        (
            ...
            "testing",
            "🌐",
            "github.com/httpie/cli — Human-friendly HTTP client.",
            '{"repo_url":"https://github.com/httpie/cli"}',
            '["dev","qa","security"]',
        ),
    ]
