...
TOOLS = [
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                "agent_id": {
                    "type": "string",
                    "description": "Optional agent ID to get details. Omit to list all.",
                },
            },
        },
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                "mission_id": {
                    "type": "string",
                    "description": "Optional mission ID. Omit to list all.",
                },
            },
        },
    },
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "project_id": {
                    "type": "string",
                    "description": "Project/mission ID. Omit for global memory.",
                },
                "category": {
                    "type": "string",
                    "description": "Filter by category (architecture, vision, team, process, backlog)",
                },
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                "project_id": {
                    "type": "string",
                    "description": "Optional project ID. Omit to list all.",
                },
            },
        },
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "story_points": {
                    "type": "integer",
                    "description": "Story points (for create, default 3)",
                },
            },
            "required": ["epic_id"],
        },
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "severity": {
                    "type": "string",
                    "enum": ["P0", "P1", "P2", "P3"],
                    "description": "Severity (for create, default P2)",
                },
            },
        },
    },
...
async def handle_tool(name: str, args: dict) -> str:
    ...
    try:
        ...
        if name == "platform_missions":
            return _handle_missions(args)
        if name == "platform_phases":
            return _handle_phases(args)
        if name == "platform_messages":
            return _handle_messages(args)
        if name == "platform_memory":
            return _handle_memory(args)
        if name == "platform_git":
            return await _handle_git(args)
        if name == "platform_code":
        ...
        if name == "platform_sprints":
            return _handle_sprints(args)
        if name == "platform_incidents":
            return _handle_incidents(args)
        if name == "platform_llm":
            return _handle_llm(args)
        if name == "platform_search":
