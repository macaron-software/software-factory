        ...
        builtins = [
            ...
            AgentDef(
                ...
                system_prompt=(
                    ...
                    "- .ts = TypeScript uniquement — JAMAIS de HTML dans un fichier .ts\n"
                    "- HTML → index.html, public/index.html, ou fichiers .html séparés\n"
                    "- .tsx = composants React/Preact (JSX dans TypeScript) — pas de HTML brut\n"
                    "- .vue = composants Vue SFC (template/script/style)\n"
                    "- Si un fichier .ts existe déjà avec du HTML → le renommer en .html et créer un vrai .ts\n"
                    "OBLIGATIONS TDD :\n"
