...
class ProjectInfo:
    ...
    arch_domain: str = ""  # Architectural domain for guidelines injection
...
class ProjectRegistry:
    ...
    def __init__(self, sf_root: Optional[str] = None, mf_root: Optional[str] = None):
        self._sf_root = sf_root or os.environ.get("SF_ROOT", "")
        self._mf_root = mf_root or os.environ.get("MF_ROOT", "")
