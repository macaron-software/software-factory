...
Usage in opencode (~/.opencode/opencode.json):
  {
    "agents": {
      "jarvis-veligo": {
        "name": "Jarvis — Veligo CTO",
        "command": "python3",
        "args": ["/path/to/platform/a2a/jarvis_acp.py", "--project", "veligo"]
      }
    }
  }
...
Environment:
  SF_API_URL   — SF platform base URL (default: http://52.143.158.19)
...
PROJECT_ID = "veligo"  # overridden by --project arg
...
def main() -> None:
    ...
    parser.add_argument("--project", default="veligo", help="SF project ID")
