...
class ProductBacklog:
    ...
    def create_feature_as(
        self, feat: FeatureDef, actor_id: str, actor_type: str = "agent"
    ) -> FeatureDef:
    ...
    def create_story_as(
        self, story: UserStoryDef, actor_id: str, actor_type: str = "agent"
    ) -> UserStoryDef:
        """Create user story with RBAC check."""
        self._check(actor_id, actor_type, "user_story", "create")
        return self.create_story(story)

    def update_feature_status_as(
        self, feature_id: str, status: str, actor_id: str, actor_type: str = "agent"
    ):
    ...
    def update_story_status_as(
        self, story_id: str, status: str, actor_id: str, actor_type: str = "agent"
    ):
