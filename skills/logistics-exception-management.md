...
metadata:
  ...
  triggers:
  - when working on logistics exception management
eval_cases:
- id: logistics-exception-management-approach
  prompt: How should I approach logistics exception management for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on logistics exception management
  tags:
  - logistics
- id: logistics-exception-management-best-practices
  prompt: What are the key best practices and pitfalls for logistics exception management?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for logistics exception management
  tags:
  - logistics
  - best-practices
- id: logistics-exception-management-antipatterns
  prompt: What are the most common mistakes to avoid with logistics exception management?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
