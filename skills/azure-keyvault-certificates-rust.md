...
metadata:
  ...
  triggers:
  - when working on azure keyvault certificates rust
eval_cases:
- id: azure-keyvault-certificates-rust-approach
  prompt: How should I approach azure keyvault certificates rust for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure keyvault certificates rust
  tags:
  - azure
- id: azure-keyvault-certificates-rust-best-practices
  prompt: What are the key best practices and pitfalls for azure keyvault certificates
    rust?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure keyvault certificates rust
  tags:
  - azure
  - best-practices
- id: azure-keyvault-certificates-rust-antipatterns
  prompt: What are the most common mistakes to avoid with azure keyvault certificates
    rust?
  should_trigger: true
  checks:
  - length_min:80
