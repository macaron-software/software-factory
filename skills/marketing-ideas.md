...
metadata:
  ...
  triggers:
  - when working on marketing ideas
eval_cases:
- id: marketing-ideas-approach
  prompt: How should I approach marketing ideas for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on marketing ideas
  tags:
  - marketing
- id: marketing-ideas-best-practices
  prompt: What are the key best practices and pitfalls for marketing ideas?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for marketing ideas
  tags:
  - marketing
  - best-practices
- id: marketing-ideas-antipatterns
  prompt: What are the most common mistakes to avoid with marketing ideas?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
