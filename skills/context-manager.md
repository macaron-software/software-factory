...
eval_cases:
- id: context-manager-approach
  prompt: How should I approach context manager for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on context manager
  tags:
  - context
- id: context-manager-best-practices
  prompt: What are the key best practices and pitfalls for context manager?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for context manager
  tags:
  - context
  - best-practices
- id: context-manager-antipatterns
  prompt: What are the most common mistakes to avoid with context manager?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
