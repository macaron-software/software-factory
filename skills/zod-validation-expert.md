...
eval_cases:
- id: zod-validation-expert-approach
  prompt: How should I approach zod validation expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on zod validation expert
  tags:
  - zod
- id: zod-validation-expert-best-practices
  prompt: What are the key best practices and pitfalls for zod validation expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for zod validation expert
  tags:
  - zod
  - best-practices
- id: zod-validation-expert-antipatterns
  prompt: What are the most common mistakes to avoid with zod validation expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
