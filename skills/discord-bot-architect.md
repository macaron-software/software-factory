...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: vibeship-spawner-skills (Apache
    2.0)'
  triggers:
  - when working on discord bot architect
eval_cases:
- id: discord-bot-architect-approach
  prompt: How should I approach discord bot architect for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on discord bot architect
  tags:
  - discord
- id: discord-bot-architect-best-practices
  prompt: What are the key best practices and pitfalls for discord bot architect?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for discord bot architect
  tags:
  - discord
  - best-practices
- id: discord-bot-architect-antipatterns
  prompt: What are the most common mistakes to avoid with discord bot architect?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
