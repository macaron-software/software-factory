...
metadata:
  ...
  triggers:
  - when working on analytics tracking
eval_cases:
- id: analytics-tracking-approach
  prompt: How should I approach analytics tracking for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on analytics tracking
  tags:
  - analytics
- id: analytics-tracking-best-practices
  prompt: What are the key best practices and pitfalls for analytics tracking?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for analytics tracking
  tags:
  - analytics
  - best-practices
- id: analytics-tracking-antipatterns
  prompt: What are the most common mistakes to avoid with analytics tracking?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
