...
eval_cases:
- id: network-engineer-approach
  prompt: How should I approach network engineer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on network engineer
  tags:
  - network
- id: network-engineer-best-practices
  prompt: What are the key best practices and pitfalls for network engineer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for network engineer
  tags:
  - network
  - best-practices
- id: network-engineer-antipatterns
  prompt: What are the most common mistakes to avoid with network engineer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
