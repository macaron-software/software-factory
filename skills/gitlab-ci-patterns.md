...
metadata:
  ...
  triggers:
  - implementing gitlab ci/cd, optimizing pipeline performance, or setting up
eval_cases:
- id: gitlab-ci-patterns-approach
  prompt: How should I approach gitlab ci patterns for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on gitlab ci patterns
  tags:
  - gitlab
- id: gitlab-ci-patterns-best-practices
  prompt: What are the key best practices and pitfalls for gitlab ci patterns?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for gitlab ci patterns
  tags:
  - gitlab
  - best-practices
- id: gitlab-ci-patterns-antipatterns
  prompt: What are the most common mistakes to avoid with gitlab ci patterns?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
