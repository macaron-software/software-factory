...
eval_cases:
- id: interactive-portfolio-approach
  prompt: How should I approach interactive portfolio for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on interactive portfolio
  tags:
  - interactive
- id: interactive-portfolio-best-practices
  prompt: What are the key best practices and pitfalls for interactive portfolio?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for interactive portfolio
  tags:
  - interactive
  - best-practices
- id: interactive-portfolio-antipatterns
  prompt: What are the most common mistakes to avoid with interactive portfolio?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
