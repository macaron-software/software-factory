...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: https://github.com/playwright-community/playwright-go'
  triggers:
  - when working on go playwright
eval_cases:
- id: go-playwright-approach
  prompt: How should I approach go playwright for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on go playwright
  tags:
  - go
- id: go-playwright-best-practices
  prompt: What are the key best practices and pitfalls for go playwright?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for go playwright
  tags:
  - go
  - best-practices
- id: go-playwright-antipatterns
  prompt: What are the most common mistakes to avoid with go playwright?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
