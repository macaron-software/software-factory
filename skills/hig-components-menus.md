...
metadata:
  ...
  triggers:
  - when working on hig components menus
eval_cases:
- id: hig-components-menus-approach
  prompt: How should I approach hig components menus for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hig components menus
  tags:
  - hig
- id: hig-components-menus-best-practices
  prompt: What are the key best practices and pitfalls for hig components menus?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hig components menus
  tags:
  - hig
  - best-practices
- id: hig-components-menus-antipatterns
  prompt: What are the most common mistakes to avoid with hig components menus?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
