...
description: This skill should be used when the user asks to "optimize context", "reduce
  ...
  context", or mentions context l...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on context optimization
eval_cases:
- id: context-optimization-approach
  prompt: How should I approach context optimization for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on context optimization
  tags:
  - context
- id: context-optimization-best-practices
  prompt: What are the key best practices and pitfalls for context optimization?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for context optimization
  tags:
  - context
  - best-practices
- id: context-optimization-antipatterns
  prompt: What are the most common mistakes to avoid with context optimization?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
