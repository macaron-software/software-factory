...
metadata:
  ...
  triggers:
  - when working on metasploit framework
eval_cases:
- id: metasploit-framework-approach
  prompt: How should I approach metasploit framework for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on metasploit framework
  tags:
  - metasploit
- id: metasploit-framework-best-practices
  prompt: What are the key best practices and pitfalls for metasploit framework?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for metasploit framework
  tags:
  - metasploit
  - best-practices
- id: metasploit-framework-antipatterns
  prompt: What are the most common mistakes to avoid with metasploit framework?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
