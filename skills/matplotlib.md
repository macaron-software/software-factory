...
description: Low-level plotting library for full customization. Use when you need
  ...
  with specific scientific workflows. Expo...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - you need fine-grained control over every plot element, creating novel plot types
  - creating any type of plot or chart (line, scatter, bar, histogram, heatmap, cont
eval_cases:
- id: matplotlib-approach
  prompt: How should I approach matplotlib for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on matplotlib
  tags:
  - matplotlib
- id: matplotlib-best-practices
  prompt: What are the key best practices and pitfalls for matplotlib?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for matplotlib
  tags:
  - matplotlib
  - best-practices
- id: matplotlib-antipatterns
  prompt: What are the most common mistakes to avoid with matplotlib?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
