...
eval_cases:
- id: frontend-security-coder-approach
  prompt: How should I approach frontend security coder for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on frontend security coder
  tags:
  - frontend
- id: frontend-security-coder-best-practices
  prompt: What are the key best practices and pitfalls for frontend security coder?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for frontend security coder
  tags:
  - frontend
  - best-practices
- id: frontend-security-coder-antipatterns
  prompt: What are the most common mistakes to avoid with frontend security coder?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
