...
metadata:
  ...
  triggers:
  - implementing univariate/multivariate anomaly detection, time-series analysis,
    or
eval_cases:
- id: azure-ai-anomalydetector-java-approach
  prompt: How should I approach azure ai anomalydetector java for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure ai anomalydetector java
  tags:
  - azure
- id: azure-ai-anomalydetector-java-best-practices
  prompt: What are the key best practices and pitfalls for azure ai anomalydetector
    java?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure ai anomalydetector java
  tags:
  - azure
  - best-practices
- id: azure-ai-anomalydetector-java-antipatterns
  prompt: What are the most common mistakes to avoid with azure ai anomalydetector
    java?
  should_trigger: true
  checks:
  - length_min:80
