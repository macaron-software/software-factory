...
metadata:
  ...
  triggers:
  - when working on laravel expert
eval_cases:
- id: laravel-expert-approach
  prompt: How should I approach laravel expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on laravel expert
  tags:
  - laravel
- id: laravel-expert-best-practices
  prompt: What are the key best practices and pitfalls for laravel expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for laravel expert
  tags:
  - laravel
  - best-practices
- id: laravel-expert-antipatterns
  prompt: What are the most common mistakes to avoid with laravel expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
