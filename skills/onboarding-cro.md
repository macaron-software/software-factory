...
metadata:
  ...
  triggers:
  - the user mentions "onboarding flow," "activation rate," "u
eval_cases:
- id: onboarding-cro-approach
  prompt: How should I approach onboarding cro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on onboarding cro
  tags:
  - onboarding
- id: onboarding-cro-best-practices
  prompt: What are the key best practices and pitfalls for onboarding cro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for onboarding cro
  tags:
  - onboarding
  - best-practices
- id: onboarding-cro-antipatterns
  prompt: What are the most common mistakes to avoid with onboarding cro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
