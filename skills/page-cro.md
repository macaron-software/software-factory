...
metadata:
  ...
  triggers:
  - when working on page cro
eval_cases:
- id: page-cro-approach
  prompt: How should I approach page cro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on page cro
  tags:
  - page
- id: page-cro-best-practices
  prompt: What are the key best practices and pitfalls for page cro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for page cro
  tags:
  - page
  - best-practices
- id: page-cro-antipatterns
  prompt: What are the most common mistakes to avoid with page cro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
