...
metadata:
  ...
  triggers:
  - choosing embedding models, implementing chunking strategies, or optimizing embed
eval_cases:
- id: embedding-strategies-approach
  prompt: How should I approach embedding strategies for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on embedding strategies
  tags:
  - embedding
- id: embedding-strategies-best-practices
  prompt: What are the key best practices and pitfalls for embedding strategies?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for embedding strategies
  tags:
  - embedding
  - best-practices
- id: embedding-strategies-antipatterns
  prompt: What are the most common mistakes to avoid with embedding strategies?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
