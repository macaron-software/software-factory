...
metadata:
  ...
  - implementing defaultazurecredential, managed identity, service principal, or any
eval_cases:
- id: azure-identity-java-approach
  prompt: How should I approach azure identity java for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure identity java
  tags:
  - azure
- id: azure-identity-java-best-practices
  prompt: What are the key best practices and pitfalls for azure identity java?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure identity java
  tags:
  - azure
  - best-practices
- id: azure-identity-java-antipatterns
  prompt: What are the most common mistakes to avoid with azure identity java?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
