...
metadata:
  ...
  triggers:
  - implementing gitops practices, automating kubernetes deplo
  - implement progressive delivery strategies
eval_cases:
- id: gitops-workflow-approach
  prompt: How should I approach gitops workflow for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on gitops workflow
  tags:
  - gitops
- id: gitops-workflow-best-practices
  prompt: What are the key best practices and pitfalls for gitops workflow?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for gitops workflow
  tags:
  - gitops
  - best-practices
- id: gitops-workflow-antipatterns
  prompt: What are the most common mistakes to avoid with gitops workflow?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
