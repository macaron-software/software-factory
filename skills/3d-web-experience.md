...
eval_cases:
- id: 3d-web-experience-approach
  prompt: How should I approach 3d web experience for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on 3d web experience
  tags:
  - 3d
- id: 3d-web-experience-best-practices
  prompt: What are the key best practices and pitfalls for 3d web experience?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for 3d web experience
  tags:
  - 3d
  - best-practices
- id: 3d-web-experience-antipatterns
  prompt: What are the most common mistakes to avoid with 3d web experience?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
