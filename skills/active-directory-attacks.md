...
metadata:
  ...
  triggers:
  - when working on active directory attacks
eval_cases:
- id: active-directory-attacks-approach
  prompt: How should I approach active directory attacks for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on active directory attacks
  tags:
  - active
- id: active-directory-attacks-best-practices
  prompt: What are the key best practices and pitfalls for active directory attacks?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for active directory attacks
  tags:
  - active
  - best-practices
- id: active-directory-attacks-antipatterns
  prompt: What are the most common mistakes to avoid with active directory attacks?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
