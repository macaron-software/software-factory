...
eval_cases:
- id: error-diagnostics-error-trace-approach
  prompt: How should I approach error diagnostics error trace for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on error diagnostics error trace
  tags:
  - error
- id: error-diagnostics-error-trace-best-practices
  ...
  - no_placeholder
  expectations:
  - Lists concrete best practices for error diagnostics error trace
  tags:
  - error
  - best-practices
- id: error-diagnostics-error-trace-antipatterns
