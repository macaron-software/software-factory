...
eval_cases:
- id: seo-snippet-hunter-approach
  prompt: How should I approach seo snippet hunter for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on seo snippet hunter
  tags:
  - seo
- id: seo-snippet-hunter-best-practices
  prompt: What are the key best practices and pitfalls for seo snippet hunter?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for seo snippet hunter
  tags:
  - seo
  - best-practices
- id: seo-snippet-hunter-antipatterns
  prompt: What are the most common mistakes to avoid with seo snippet hunter?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
