...
eval_cases:
- id: architect-review-approach
  prompt: How should I approach architect review for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on architect review
  tags:
  - architect
- id: architect-review-best-practices
  prompt: What are the key best practices and pitfalls for architect review?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for architect review
  tags:
  - architect
  - best-practices
- id: architect-review-antipatterns
  prompt: What are the most common mistakes to avoid with architect review?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
