...
metadata:
  ...
  triggers:
  - user wants to design ui/ux in stitch, create app interfaces, generate mobile/web
eval_cases:
- id: stitch-ui-design-approach
  prompt: How should I approach stitch ui design for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on stitch ui design
  tags:
  - stitch
- id: stitch-ui-design-best-practices
  prompt: What are the key best practices and pitfalls for stitch ui design?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for stitch ui design
  tags:
  - stitch
  - best-practices
- id: stitch-ui-design-antipatterns
  prompt: What are the most common mistakes to avoid with stitch ui design?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
