...
metadata:
  ...
  triggers:
  - starting complex multi-step tasks, research projects, or any task requirin
eval_cases:
- id: planning-with-files-approach
  prompt: How should I approach planning with files for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on planning with files
  tags:
  - planning
- id: planning-with-files-best-practices
  prompt: What are the key best practices and pitfalls for planning with files?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for planning with files
  tags:
  - planning
  - best-practices
- id: planning-with-files-antipatterns
  prompt: What are the most common mistakes to avoid with planning with files?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
