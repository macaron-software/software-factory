...
metadata:
  ...
  triggers:
  - analyzing executables, understanding compiled code, or performing
  - working on binary analysis patterns tasks or workflows
eval_cases:
- id: binary-analysis-patterns-approach
  prompt: How should I approach binary analysis patterns for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on binary analysis patterns
  tags:
  - binary
- id: binary-analysis-patterns-best-practices
  prompt: What are the key best practices and pitfalls for binary analysis patterns?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for binary analysis patterns
  tags:
  - binary
  - best-practices
- id: binary-analysis-patterns-antipatterns
  prompt: What are the most common mistakes to avoid with binary analysis patterns?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
