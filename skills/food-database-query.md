...
metadata:
  ...
  triggers:
  - when working on food database query
eval_cases:
- id: food-database-query-approach
  prompt: How should I approach food database query for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on food database query
  tags:
  - food
- id: food-database-query-best-practices
  prompt: What are the key best practices and pitfalls for food database query?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for food database query
  tags:
  - food
  - best-practices
- id: food-database-query-antipatterns
  prompt: What are the most common mistakes to avoid with food database query?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
