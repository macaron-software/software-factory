...
metadata:
  ...
  triggers:
  - improving spark performance, debugging slow jobs, or scaling data processing pip
eval_cases:
- id: spark-optimization-approach
  prompt: How should I approach spark optimization for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on spark optimization
  tags:
  - spark
- id: spark-optimization-best-practices
  prompt: What are the key best practices and pitfalls for spark optimization?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for spark optimization
  tags:
  - spark
  - best-practices
- id: spark-optimization-antipatterns
  prompt: What are the most common mistakes to avoid with spark optimization?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
