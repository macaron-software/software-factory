...
eval_cases:
- id: firmware-analyst-approach
  prompt: How should I approach firmware analyst for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on firmware analyst
  tags:
  - firmware
- id: firmware-analyst-best-practices
  prompt: What are the key best practices and pitfalls for firmware analyst?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for firmware analyst
  tags:
  - firmware
  - best-practices
- id: firmware-analyst-antipatterns
  prompt: What are the most common mistakes to avoid with firmware analyst?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
