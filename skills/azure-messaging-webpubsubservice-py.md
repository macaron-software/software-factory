...
metadata:
  ...
  triggers:
  - when working on azure messaging webpubsubservice py
eval_cases:
- id: azure-messaging-webpubsubservice-py-approach
  prompt: How should I approach azure messaging webpubsubservice py for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure messaging webpubsubservice py
  tags:
  - azure
- id: azure-messaging-webpubsubservice-py-best-practices
  prompt: What are the key best practices and pitfalls for azure messaging webpubsubservice
    py?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure messaging webpubsubservice py
  tags:
  - azure
  - best-practices
- id: azure-messaging-webpubsubservice-py-antipatterns
  prompt: What are the most common mistakes to avoid with azure messaging webpubsubservice
    py?
  should_trigger: true
  checks:
  - length_min:80
