...
eval_cases:
- id: documentation-generation-doc-generate-approach
  prompt: How should I approach documentation generation doc generate for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on documentation generation doc generate
  tags:
  - documentation
- id: documentation-generation-doc-generate-best-practices
  prompt: What are the key best practices and pitfalls for documentation generation
    doc generate?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for documentation generation doc generate
  tags:
  - documentation
  - best-practices
- id: documentation-generation-doc-generate-antipatterns
  prompt: What are the most common mistakes to avoid with documentation generation
    doc generate?
  should_trigger: true
  checks:
  - length_min:80
