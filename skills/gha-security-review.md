...
description: GitHub Actions security review for workflow exploitation vulnerabilities.
  ...
  "GHA security", "workflow security revie...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - asked to "review github actions", "audit workflows", "check ci security", "gha
    s
eval_cases:
- id: gha-security-review-approach
  prompt: How should I approach gha security review for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on gha security review
  tags:
  - gha
- id: gha-security-review-best-practices
  prompt: What are the key best practices and pitfalls for gha security review?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for gha security review
  tags:
  - gha
  - best-practices
- id: gha-security-review-antipatterns
  prompt: What are the most common mistakes to avoid with gha security review?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
