...
metadata:
  ...
  triggers:
  - when working on shodan reconnaissance
eval_cases:
- id: shodan-reconnaissance-approach
  prompt: How should I approach shodan reconnaissance for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on shodan reconnaissance
  tags:
  - shodan
- id: shodan-reconnaissance-best-practices
  prompt: What are the key best practices and pitfalls for shodan reconnaissance?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for shodan reconnaissance
  tags:
  - shodan
  - best-practices
- id: shodan-reconnaissance-antipatterns
  prompt: What are the most common mistakes to avoid with shodan reconnaissance?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
