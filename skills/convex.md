...
metadata:
  category: ai
  source: 'antigravity-awesome-skills (MIT) — source: https://docs.convex.dev'
  triggers:
...
eval_cases:
- id: convex-approach
  prompt: How should I approach convex for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on convex
  tags:
  - convex
- id: convex-best-practices
  prompt: What are the key best practices and pitfalls for convex?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for convex
  tags:
  - convex
  - best-practices
- id: convex-antipatterns
  prompt: What are the most common mistakes to avoid with convex?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
