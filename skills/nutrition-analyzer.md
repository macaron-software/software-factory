...
metadata:
  ...
  triggers:
  - when working on nutrition analyzer
eval_cases:
- id: nutrition-analyzer-approach
  prompt: How should I approach nutrition analyzer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on nutrition analyzer
  tags:
  - nutrition
- id: nutrition-analyzer-best-practices
  prompt: What are the key best practices and pitfalls for nutrition analyzer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for nutrition analyzer
  tags:
  - nutrition
  - best-practices
- id: nutrition-analyzer-antipatterns
  prompt: What are the most common mistakes to avoid with nutrition analyzer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
