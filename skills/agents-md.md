...
description: This skill should be used when the user asks to "create AGENTS.md", "update
  ...
  concise. Enforces research-bac...
metadata:
  category: ai
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on agents md
eval_cases:
- id: agents-md-approach
  prompt: How should I approach agents md for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on agents md
  tags:
  - agents
- id: agents-md-best-practices
  prompt: What are the key best practices and pitfalls for agents md?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for agents md
  tags:
  - agents
  - best-practices
- id: agents-md-antipatterns
  prompt: What are the most common mistakes to avoid with agents md?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
