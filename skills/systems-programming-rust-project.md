...
eval_cases:
- id: systems-programming-rust-project-approach
  prompt: How should I approach systems programming rust project for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on systems programming rust project
  tags:
  - systems
- id: systems-programming-rust-project-best-practices
  prompt: What are the key best practices and pitfalls for systems programming rust
    project?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for systems programming rust project
  tags:
  - systems
  - best-practices
- id: systems-programming-rust-project-antipatterns
  prompt: What are the most common mistakes to avoid with systems programming rust
    project?
  should_trigger: true
  checks:
  - length_min:80
