...
eval_cases:
- id: copywriting-approach
  prompt: How should I approach copywriting for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on copywriting
  tags:
  - copywriting
- id: copywriting-best-practices
  prompt: What are the key best practices and pitfalls for copywriting?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for copywriting
  tags:
  - copywriting
  - best-practices
- id: copywriting-antipatterns
  prompt: What are the most common mistakes to avoid with copywriting?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
