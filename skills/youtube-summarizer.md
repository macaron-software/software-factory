...
metadata:
  ...
  triggers:
  - when working on youtube summarizer
eval_cases:
- id: youtube-summarizer-approach
  prompt: How should I approach youtube summarizer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on youtube summarizer
  tags:
  - youtube
- id: youtube-summarizer-best-practices
  prompt: What are the key best practices and pitfalls for youtube summarizer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for youtube summarizer
  tags:
  - youtube
  - best-practices
- id: youtube-summarizer-antipatterns
  prompt: What are the most common mistakes to avoid with youtube summarizer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
