...
eval_cases:
- id: rust-pro-approach
  prompt: How should I approach rust pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on rust pro
  tags:
  - rust
- id: rust-pro-best-practices
  prompt: What are the key best practices and pitfalls for rust pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for rust pro
  tags:
  - rust
  - best-practices
- id: rust-pro-antipatterns
  prompt: What are the most common mistakes to avoid with rust pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
