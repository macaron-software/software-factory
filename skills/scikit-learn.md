...
eval_cases:
- id: scikit-learn-approach
  prompt: How should I approach scikit learn for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on scikit learn
  tags:
  - scikit
- id: scikit-learn-best-practices
  prompt: What are the key best practices and pitfalls for scikit learn?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for scikit learn
  tags:
  - scikit
  - best-practices
- id: scikit-learn-antipatterns
  prompt: What are the most common mistakes to avoid with scikit learn?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
