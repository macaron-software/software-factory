...
metadata:
  ...
  triggers:
  - when working on azure ai document intelligence dotnet
eval_cases:
- id: azure-ai-document-intelligence-dotnet-approach
  prompt: How should I approach azure ai document intelligence dotnet for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure ai document intelligence dotnet
  tags:
  - azure
- id: azure-ai-document-intelligence-dotnet-best-practices
  prompt: What are the key best practices and pitfalls for azure ai document intelligence
    dotnet?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure ai document intelligence dotnet
  tags:
  - azure
  - best-practices
- id: azure-ai-document-intelligence-dotnet-antipatterns
  prompt: What are the most common mistakes to avoid with azure ai document intelligence
    dotnet?
  should_trigger: true
  checks:
  - length_min:80
