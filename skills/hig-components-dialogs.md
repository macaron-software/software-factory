...
metadata:
  ...
  triggers:
  - when working on hig components dialogs
eval_cases:
- id: hig-components-dialogs-approach
  prompt: How should I approach hig components dialogs for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hig components dialogs
  tags:
  - hig
- id: hig-components-dialogs-best-practices
  prompt: What are the key best practices and pitfalls for hig components dialogs?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hig components dialogs
  tags:
  - hig
  - best-practices
- id: hig-components-dialogs-antipatterns
  prompt: What are the most common mistakes to avoid with hig components dialogs?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
