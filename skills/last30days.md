...
metadata:
  ...
  triggers:
  - when working on last30days
eval_cases:
- id: last30days-approach
  prompt: How should I approach last30days for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on last30days
  tags:
  - last30days
- id: last30days-best-practices
  prompt: What are the key best practices and pitfalls for last30days?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for last30days
  tags:
  - last30days
  - best-practices
- id: last30days-antipatterns
  prompt: What are the most common mistakes to avoid with last30days?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
