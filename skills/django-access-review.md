...
metadata:
  ...
  triggers:
  - when working on django access review
eval_cases:
- id: django-access-review-approach
  prompt: How should I approach django access review for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on django access review
  tags:
  - django
- id: django-access-review-best-practices
  prompt: What are the key best practices and pitfalls for django access review?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for django access review
  tags:
  - django
  - best-practices
- id: django-access-review-antipatterns
  prompt: What are the most common mistakes to avoid with django access review?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
