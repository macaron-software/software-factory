...
eval_cases:
- id: computer-vision-expert-approach
  prompt: How should I approach computer vision expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on computer vision expert
  tags:
  - computer
- id: computer-vision-expert-best-practices
  prompt: What are the key best practices and pitfalls for computer vision expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for computer vision expert
  tags:
  - computer
  - best-practices
- id: computer-vision-expert-antipatterns
  prompt: What are the most common mistakes to avoid with computer vision expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
