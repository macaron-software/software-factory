...
eval_cases:
- id: backend-security-coder-approach
  prompt: How should I approach backend security coder for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on backend security coder
  tags:
  - backend
- id: backend-security-coder-best-practices
  prompt: What are the key best practices and pitfalls for backend security coder?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for backend security coder
  tags:
  - backend
  - best-practices
- id: backend-security-coder-antipatterns
  prompt: What are the most common mistakes to avoid with backend security coder?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
