...
metadata:
  ...
  triggers:
  - when working on azure eventgrid dotnet
eval_cases:
- id: azure-eventgrid-dotnet-approach
  prompt: How should I approach azure eventgrid dotnet for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure eventgrid dotnet
  tags:
  - azure
- id: azure-eventgrid-dotnet-best-practices
  prompt: What are the key best practices and pitfalls for azure eventgrid dotnet?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure eventgrid dotnet
  tags:
  - azure
  - best-practices
- id: azure-eventgrid-dotnet-antipatterns
  prompt: What are the most common mistakes to avoid with azure eventgrid dotnet?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
