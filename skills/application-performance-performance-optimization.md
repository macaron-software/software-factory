...
metadata:
  ...
  triggers:
  - coordinating performance optimization across the stack
  - designing load tests, performance budgets, or capacity plans
eval_cases:
- id: application-performance-performance-optimization-approach
  prompt: How should I approach application performance performance optimization for
    a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on application performance performance optimization
  tags:
  - application
- id: application-performance-performance-optimization-best-practices
  prompt: What are the key best practices and pitfalls for application performance
  ...
  - no_placeholder
  expectations:
  - Lists concrete best practices for application performance performance optimization
  tags:
  - application
  - best-practices
- id: application-performance-performance-optimization-antipatterns
  prompt: What are the most common mistakes to avoid with application performance
    performance optimization?
  should_trigger: true
  checks:
  - length_min:80
