...
metadata:
  ...
  - creating, managing, or using rsa/ec keys, performing encrypt/decrypt/sign/verify
eval_cases:
- id: azure-security-keyvault-keys-java-approach
  prompt: How should I approach azure security keyvault keys java for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure security keyvault keys java
  tags:
  - azure
- id: azure-security-keyvault-keys-java-best-practices
  ...
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure security keyvault keys java
  tags:
  - azure
  - best-practices
- id: azure-security-keyvault-keys-java-antipatterns
