...
metadata:
  ...
  triggers:
  - when working on unit testing test generate
eval_cases:
- id: unit-testing-test-generate-approach
  prompt: How should I approach unit testing test generate for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on unit testing test generate
  tags:
  - unit
- id: unit-testing-test-generate-best-practices
  prompt: What are the key best practices and pitfalls for unit testing test generate?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for unit testing test generate
  tags:
  - unit
  - best-practices
- id: unit-testing-test-generate-antipatterns
  prompt: What are the most common mistakes to avoid with unit testing test generate?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
