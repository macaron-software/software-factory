...
metadata:
  ...
  triggers:
  - conducting incident reviews, writing postmortem documents, or improving incident
  - the task is unrelated to postmortem writing
eval_cases:
- id: postmortem-writing-approach
  prompt: How should I approach postmortem writing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on postmortem writing
  tags:
  - postmortem
- id: postmortem-writing-best-practices
  prompt: What are the key best practices and pitfalls for postmortem writing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for postmortem writing
  tags:
  - postmortem
  - best-practices
- id: postmortem-writing-antipatterns
  prompt: What are the most common mistakes to avoid with postmortem writing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
