...
metadata:
  ...
  triggers:
  - 'assessing supply chain attack surface, evaluating dependency health, or scoping '
eval_cases:
- id: supply-chain-risk-auditor-approach
  prompt: How should I approach supply chain risk auditor for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on supply chain risk auditor
  tags:
  - supply
- id: supply-chain-risk-auditor-best-practices
  prompt: What are the key best practices and pitfalls for supply chain risk auditor?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for supply chain risk auditor
  tags:
  - supply
  - best-practices
- id: supply-chain-risk-auditor-antipatterns
  prompt: What are the most common mistakes to avoid with supply chain risk auditor?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
