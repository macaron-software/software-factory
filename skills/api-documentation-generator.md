...
metadata:
  ...
  triggers:
  - when working on api documentation generator
eval_cases:
- id: api-documentation-generator-approach
  prompt: How should I approach api documentation generator for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on api documentation generator
  tags:
  - api
- id: api-documentation-generator-best-practices
  prompt: What are the key best practices and pitfalls for api documentation generator?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for api documentation generator
  tags:
  - api
  - best-practices
- id: api-documentation-generator-antipatterns
  prompt: What are the most common mistakes to avoid with api documentation generator?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
