...
metadata:
  ...
  triggers:
  - publishing events, implementing pub/sub patterns, or integrating with azure serv
eval_cases:
- id: azure-eventgrid-java-approach
  prompt: How should I approach azure eventgrid java for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure eventgrid java
  tags:
  - azure
- id: azure-eventgrid-java-best-practices
  prompt: What are the key best practices and pitfalls for azure eventgrid java?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure eventgrid java
  tags:
  - azure
  - best-practices
- id: azure-eventgrid-java-antipatterns
  prompt: What are the most common mistakes to avoid with azure eventgrid java?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
