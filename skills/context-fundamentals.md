...
description: This skill should be used when the user asks to "understand context",
  ...
  "optimize context usage", or discusses context ...
metadata:
  category: ai
...
eval_cases:
- id: context-fundamentals-approach
  prompt: How should I approach context fundamentals for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on context fundamentals
  tags:
  - context
- id: context-fundamentals-best-practices
  prompt: What are the key best practices and pitfalls for context fundamentals?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for context fundamentals
  tags:
  - context
  - best-practices
- id: context-fundamentals-antipatterns
  prompt: What are the most common mistakes to avoid with context fundamentals?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
