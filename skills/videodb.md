...
description: Video and audio perception, indexing, and editing. Ingest files/URLs/live
  ...
  overlays/subtitles, generate media, and c...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on videodb
eval_cases:
- id: videodb-approach
  prompt: How should I approach videodb for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on videodb
  tags:
  - videodb
- id: videodb-best-practices
  prompt: What are the key best practices and pitfalls for videodb?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for videodb
  tags:
  - videodb
  - best-practices
- id: videodb-antipatterns
  prompt: What are the most common mistakes to avoid with videodb?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
