...
eval_cases:
- id: ui-visual-validator-approach
  prompt: How should I approach ui visual validator for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on ui visual validator
  tags:
  - ui
- id: ui-visual-validator-best-practices
  prompt: What are the key best practices and pitfalls for ui visual validator?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for ui visual validator
  tags:
  - ui
  - best-practices
- id: ui-visual-validator-antipatterns
  prompt: What are the most common mistakes to avoid with ui visual validator?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
