...
eval_cases:
- id: mlops-engineer-approach
  prompt: How should I approach mlops engineer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on mlops engineer
  tags:
  - mlops
- id: mlops-engineer-best-practices
  prompt: What are the key best practices and pitfalls for mlops engineer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for mlops engineer
  tags:
  - mlops
  - best-practices
- id: mlops-engineer-antipatterns
  prompt: What are the most common mistakes to avoid with mlops engineer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
