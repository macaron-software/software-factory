...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: vibeship-spawner-skills (Apache
    2.0)'
  triggers:
  - when working on telegram bot builder
eval_cases:
- id: telegram-bot-builder-approach
  prompt: How should I approach telegram bot builder for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on telegram bot builder
  tags:
  - telegram
- id: telegram-bot-builder-best-practices
  prompt: What are the key best practices and pitfalls for telegram bot builder?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for telegram bot builder
  tags:
  - telegram
  - best-practices
- id: telegram-bot-builder-antipatterns
  prompt: What are the most common mistakes to avoid with telegram bot builder?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
