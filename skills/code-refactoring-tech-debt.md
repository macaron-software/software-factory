...
eval_cases:
- id: code-refactoring-tech-debt-approach
  prompt: How should I approach code refactoring tech debt for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on code refactoring tech debt
  tags:
  - code
- id: code-refactoring-tech-debt-best-practices
  prompt: What are the key best practices and pitfalls for code refactoring tech debt?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for code refactoring tech debt
  tags:
  - code
  - best-practices
- id: code-refactoring-tech-debt-antipatterns
  prompt: What are the most common mistakes to avoid with code refactoring tech debt?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
