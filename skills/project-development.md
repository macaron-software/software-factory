...
description: This skill should be used when the user asks to "start an LLM project",
  ...
  mentions pipeline architecture, agent-assis...
metadata:
  category: ai
...
eval_cases:
- id: project-development-approach
  prompt: How should I approach project development for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on project development
  tags:
  - project
- id: project-development-best-practices
  prompt: What are the key best practices and pitfalls for project development?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for project development
  tags:
  - project
  - best-practices
- id: project-development-antipatterns
  prompt: What are the most common mistakes to avoid with project development?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
