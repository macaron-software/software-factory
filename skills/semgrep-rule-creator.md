...
eval_cases:
- id: semgrep-rule-creator-approach
  prompt: How should I approach semgrep rule creator for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on semgrep rule creator
  tags:
  - semgrep
- id: semgrep-rule-creator-best-practices
  prompt: What are the key best practices and pitfalls for semgrep rule creator?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for semgrep rule creator
  tags:
  - semgrep
  - best-practices
- id: semgrep-rule-creator-antipatterns
  prompt: What are the most common mistakes to avoid with semgrep rule creator?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
