...
metadata:
  ...
  triggers:
  - when working on linux troubleshooting
eval_cases:
- id: linux-troubleshooting-approach
  prompt: How should I approach linux troubleshooting for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on linux troubleshooting
  tags:
  - linux
- id: linux-troubleshooting-best-practices
  prompt: What are the key best practices and pitfalls for linux troubleshooting?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for linux troubleshooting
  tags:
  - linux
  - best-practices
- id: linux-troubleshooting-antipatterns
  prompt: What are the most common mistakes to avoid with linux troubleshooting?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
