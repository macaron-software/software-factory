...
eval_cases:
- id: arm-cortex-expert-approach
  prompt: How should I approach arm cortex expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on arm cortex expert
  tags:
  - arm
- id: arm-cortex-expert-best-practices
  prompt: What are the key best practices and pitfalls for arm cortex expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for arm cortex expert
  tags:
  - arm
  - best-practices
- id: arm-cortex-expert-antipatterns
  prompt: What are the most common mistakes to avoid with arm cortex expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
