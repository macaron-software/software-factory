...
metadata:
  ...
  triggers:
  - when working on hugging face paper publisher
eval_cases:
- id: hugging-face-paper-publisher-approach
  prompt: How should I approach hugging face paper publisher for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hugging face paper publisher
  tags:
  - hugging
- id: hugging-face-paper-publisher-best-practices
  prompt: What are the key best practices and pitfalls for hugging face paper publisher?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hugging face paper publisher
  tags:
  - hugging
  - best-practices
- id: hugging-face-paper-publisher-antipatterns
  prompt: What are the most common mistakes to avoid with hugging face paper publisher?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
