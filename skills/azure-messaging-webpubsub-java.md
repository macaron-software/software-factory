...
metadata:
  ...
  triggers:
  - implementing websocket-based messaging, live updates, chat applications, or serv
eval_cases:
- id: azure-messaging-webpubsub-java-approach
  prompt: How should I approach azure messaging webpubsub java for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure messaging webpubsub java
  tags:
  - azure
- id: azure-messaging-webpubsub-java-best-practices
  prompt: What are the key best practices and pitfalls for azure messaging webpubsub
    java?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure messaging webpubsub java
  tags:
  - azure
  - best-practices
- id: azure-messaging-webpubsub-java-antipatterns
  prompt: What are the most common mistakes to avoid with azure messaging webpubsub
    java?
  should_trigger: true
  checks:
  - length_min:80
