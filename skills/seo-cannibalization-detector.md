...
eval_cases:
- id: seo-cannibalization-detector-approach
  prompt: How should I approach seo cannibalization detector for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on seo cannibalization detector
  tags:
  - seo
- id: seo-cannibalization-detector-best-practices
  prompt: What are the key best practices and pitfalls for seo cannibalization detector?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for seo cannibalization detector
  tags:
  - seo
  - best-practices
- id: seo-cannibalization-detector-antipatterns
  prompt: What are the most common mistakes to avoid with seo cannibalization detector?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
