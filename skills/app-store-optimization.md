...
metadata:
  ...
  triggers:
  - when working on app store optimization
eval_cases:
- id: app-store-optimization-approach
  prompt: How should I approach app store optimization for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on app store optimization
  tags:
  - app
- id: app-store-optimization-best-practices
  prompt: What are the key best practices and pitfalls for app store optimization?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for app store optimization
  tags:
  - app
  - best-practices
- id: app-store-optimization-antipatterns
  prompt: What are the most common mistakes to avoid with app store optimization?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
