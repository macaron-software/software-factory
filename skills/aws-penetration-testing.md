...
metadata:
  ...
  triggers:
  - when working on aws penetration testing
eval_cases:
- id: aws-penetration-testing-approach
  prompt: How should I approach aws penetration testing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on aws penetration testing
  tags:
  - aws
- id: aws-penetration-testing-best-practices
  prompt: What are the key best practices and pitfalls for aws penetration testing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for aws penetration testing
  tags:
  - aws
  - best-practices
- id: aws-penetration-testing-antipatterns
  prompt: What are the most common mistakes to avoid with aws penetration testing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
