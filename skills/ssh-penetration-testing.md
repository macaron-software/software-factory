...
metadata:
  ...
  triggers:
  - when working on ssh penetration testing
eval_cases:
- id: ssh-penetration-testing-approach
  prompt: How should I approach ssh penetration testing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on ssh penetration testing
  tags:
  - ssh
- id: ssh-penetration-testing-best-practices
  prompt: What are the key best practices and pitfalls for ssh penetration testing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for ssh penetration testing
  tags:
  - ssh
  - best-practices
- id: ssh-penetration-testing-antipatterns
  prompt: What are the most common mistakes to avoid with ssh penetration testing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
