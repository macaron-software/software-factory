...
metadata:
  ...
  triggers:
  - when working on cloud penetration testing
eval_cases:
- id: cloud-penetration-testing-approach
  prompt: How should I approach cloud penetration testing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on cloud penetration testing
  tags:
  - cloud
- id: cloud-penetration-testing-best-practices
  prompt: What are the key best practices and pitfalls for cloud penetration testing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for cloud penetration testing
  tags:
  - cloud
  - best-practices
- id: cloud-penetration-testing-antipatterns
  prompt: What are the most common mistakes to avoid with cloud penetration testing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
