...
eval_cases:
- id: postgresql-approach
  prompt: How should I approach postgresql for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on postgresql
  tags:
  - postgresql
- id: postgresql-best-practices
  prompt: What are the key best practices and pitfalls for postgresql?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for postgresql
  tags:
  - postgresql
  - best-practices
- id: postgresql-antipatterns
  prompt: What are the most common mistakes to avoid with postgresql?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
