...
metadata:
  ...
  triggers:
  - when working on design orchestration
eval_cases:
- id: design-orchestration-approach
  prompt: How should I approach design orchestration for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on design orchestration
  tags:
  - design
- id: design-orchestration-best-practices
  prompt: What are the key best practices and pitfalls for design orchestration?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for design orchestration
  tags:
  - design
  - best-practices
- id: design-orchestration-antipatterns
  prompt: What are the most common mistakes to avoid with design orchestration?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
