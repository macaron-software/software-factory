...
description: Use this skill when the user wants to build tool/scripts or achieve a
  ...
  when chaining or combining API calls or t...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on hugging face tool builder
eval_cases:
- id: hugging-face-tool-builder-approach
  prompt: How should I approach hugging face tool builder for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hugging face tool builder
  tags:
  - hugging
- id: hugging-face-tool-builder-best-practices
  prompt: What are the key best practices and pitfalls for hugging face tool builder?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hugging face tool builder
  tags:
  - hugging
  - best-practices
- id: hugging-face-tool-builder-antipatterns
  prompt: What are the most common mistakes to avoid with hugging face tool builder?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
