...
metadata:
  ...
  triggers:
  - when working on linux shell scripting
eval_cases:
- id: linux-shell-scripting-approach
  prompt: How should I approach linux shell scripting for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on linux shell scripting
  tags:
  - linux
- id: linux-shell-scripting-best-practices
  prompt: What are the key best practices and pitfalls for linux shell scripting?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for linux shell scripting
  tags:
  - linux
  - best-practices
- id: linux-shell-scripting-antipatterns
  prompt: What are the most common mistakes to avoid with linux shell scripting?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
