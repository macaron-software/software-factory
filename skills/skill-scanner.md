...
description: Scan agent skills for security issues. Use when asked to "scan a skill",
  ...
  SKILL.md", or assess whether an agent skill...
metadata:
  category: ai
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - 'asked to "scan a skill", "audit a skill", "review skill security", "check skill '
eval_cases:
- id: skill-scanner-approach
  prompt: How should I approach skill scanner for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on skill scanner
  tags:
  - skill
- id: skill-scanner-best-practices
  prompt: What are the key best practices and pitfalls for skill scanner?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for skill scanner
  tags:
  - skill
  - best-practices
- id: skill-scanner-antipatterns
  prompt: What are the most common mistakes to avoid with skill scanner?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
