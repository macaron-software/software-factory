...
eval_cases:
- id: c4-context-approach
  prompt: How should I approach c4 context for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on c4 context
  tags:
  - c4
- id: c4-context-best-practices
  prompt: What are the key best practices and pitfalls for c4 context?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for c4 context
  tags:
  - c4
  - best-practices
- id: c4-context-antipatterns
  prompt: What are the most common mistakes to avoid with c4 context?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
