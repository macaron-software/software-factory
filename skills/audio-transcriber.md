...
metadata:
  ...
  triggers:
  - when working on audio transcriber
eval_cases:
- id: audio-transcriber-approach
  prompt: How should I approach audio transcriber for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on audio transcriber
  tags:
  - audio
- id: audio-transcriber-best-practices
  prompt: What are the key best practices and pitfalls for audio transcriber?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for audio transcriber
  tags:
  - audio
  - best-practices
- id: audio-transcriber-antipatterns
  prompt: What are the most common mistakes to avoid with audio transcriber?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
