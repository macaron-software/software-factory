...
metadata:
  ...
  triggers:
  - when working on multi agent brainstorming
eval_cases:
- id: multi-agent-brainstorming-approach
  prompt: How should I approach multi agent brainstorming for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on multi agent brainstorming
  tags:
  - multi
- id: multi-agent-brainstorming-best-practices
  prompt: What are the key best practices and pitfalls for multi agent brainstorming?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for multi agent brainstorming
  tags:
  - multi
  - best-practices
- id: multi-agent-brainstorming-antipatterns
  prompt: What are the most common mistakes to avoid with multi agent brainstorming?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
