...
metadata:
  ...
  triggers:
  - when working on schema markup
eval_cases:
- id: schema-markup-approach
  prompt: How should I approach schema markup for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on schema markup
  tags:
  - schema
- id: schema-markup-best-practices
  prompt: What are the key best practices and pitfalls for schema markup?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for schema markup
  tags:
  - schema
  - best-practices
- id: schema-markup-antipatterns
  prompt: What are the most common mistakes to avoid with schema markup?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
