...
metadata:
  ...
  triggers:
  - the user mentions 'ppc,' 'paid media,' '
eval_cases:
- id: paid-ads-approach
  prompt: How should I approach paid ads for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on paid ads
  tags:
  - paid
- id: paid-ads-best-practices
  prompt: What are the key best practices and pitfalls for paid ads?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for paid ads
  tags:
  - paid
  - best-practices
- id: paid-ads-antipatterns
  prompt: What are the most common mistakes to avoid with paid ads?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
