...
metadata:
  category: ai
  source: 'antigravity-awesome-skills (MIT) — source: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/tree/main/skills/tool-design'
  triggers:
  - creating new tools for agent systems
  - debugging tool-related failures or misuse
eval_cases:
- id: tool-design-approach
  prompt: How should I approach tool design for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on tool design
  tags:
  - tool
- id: tool-design-best-practices
  prompt: What are the key best practices and pitfalls for tool design?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for tool design
  tags:
  - tool
  - best-practices
- id: tool-design-antipatterns
  prompt: What are the most common mistakes to avoid with tool design?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
