...
eval_cases:
- id: bash-scripting-approach
  prompt: How should I approach bash scripting for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on bash scripting
  tags:
  - bash
- id: bash-scripting-best-practices
  prompt: What are the key best practices and pitfalls for bash scripting?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for bash scripting
  tags:
  - bash
  - best-practices
- id: bash-scripting-antipatterns
  prompt: What are the most common mistakes to avoid with bash scripting?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
