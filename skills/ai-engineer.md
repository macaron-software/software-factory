...
eval_cases:
- id: ai-engineer-approach
  prompt: How should I approach ai engineer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on ai engineer
  tags:
  - ai
- id: ai-engineer-best-practices
  prompt: What are the key best practices and pitfalls for ai engineer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for ai engineer
  tags:
  - ai
  - best-practices
- id: ai-engineer-antipatterns
  prompt: What are the most common mistakes to avoid with ai engineer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
