...
metadata:
  ...
  triggers:
  - setting up linkerd, configuring traffic policies, or implementing zero-trust net
eval_cases:
- id: linkerd-patterns-approach
  prompt: How should I approach linkerd patterns for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on linkerd patterns
  tags:
  - linkerd
- id: linkerd-patterns-best-practices
  prompt: What are the key best practices and pitfalls for linkerd patterns?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for linkerd patterns
  tags:
  - linkerd
  - best-practices
- id: linkerd-patterns-antipatterns
  prompt: What are the most common mistakes to avoid with linkerd patterns?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
