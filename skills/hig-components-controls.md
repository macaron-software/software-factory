...
metadata:
  ...
  triggers:
  - when working on hig components controls
eval_cases:
- id: hig-components-controls-approach
  prompt: How should I approach hig components controls for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hig components controls
  tags:
  - hig
- id: hig-components-controls-best-practices
  prompt: What are the key best practices and pitfalls for hig components controls?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hig components controls
  tags:
  - hig
  - best-practices
- id: hig-components-controls-antipatterns
  prompt: What are the most common mistakes to avoid with hig components controls?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
