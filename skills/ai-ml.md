...
eval_cases:
- id: ai-ml-approach
  prompt: How should I approach ai ml for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on ai ml
  tags:
  - ai
- id: ai-ml-best-practices
  prompt: What are the key best practices and pitfalls for ai ml?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for ai ml
  tags:
  - ai
  - best-practices
- id: ai-ml-antipatterns
  prompt: What are the most common mistakes to avoid with ai ml?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
