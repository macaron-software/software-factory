...
metadata:
  ...
  triggers:
  - when working on api security testing
eval_cases:
- id: api-security-testing-approach
  prompt: How should I approach api security testing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on api security testing
  tags:
  - api
- id: api-security-testing-best-practices
  prompt: What are the key best practices and pitfalls for api security testing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for api security testing
  tags:
  - api
  - best-practices
- id: api-security-testing-antipatterns
  prompt: What are the most common mistakes to avoid with api security testing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
