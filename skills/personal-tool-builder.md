...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: vibeship-spawner-skills (Apache
    2.0)'
  triggers:
  - when working on personal tool builder
eval_cases:
- id: personal-tool-builder-approach
  prompt: How should I approach personal tool builder for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on personal tool builder
  tags:
  - personal
- id: personal-tool-builder-best-practices
  prompt: What are the key best practices and pitfalls for personal tool builder?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for personal tool builder
  tags:
  - personal
  - best-practices
- id: personal-tool-builder-antipatterns
  prompt: What are the most common mistakes to avoid with personal tool builder?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
