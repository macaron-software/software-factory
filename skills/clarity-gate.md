...
description: Pre-ingestion verification for epistemic quality in RAG systems. Ensures
  ...
  Documents) and validates SOT (...
metadata:
  category: ai
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on clarity gate
eval_cases:
- id: clarity-gate-approach
  prompt: How should I approach clarity gate for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on clarity gate
  tags:
  - clarity
- id: clarity-gate-best-practices
  prompt: What are the key best practices and pitfalls for clarity gate?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for clarity gate
  tags:
  - clarity
  - best-practices
- id: clarity-gate-antipatterns
  prompt: What are the most common mistakes to avoid with clarity gate?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
