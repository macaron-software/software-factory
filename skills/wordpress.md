...
eval_cases:
- id: wordpress-approach
  prompt: How should I approach wordpress for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on wordpress
  tags:
  - wordpress
- id: wordpress-best-practices
  prompt: What are the key best practices and pitfalls for wordpress?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for wordpress
  tags:
  - wordpress
  - best-practices
- id: wordpress-antipatterns
  prompt: What are the most common mistakes to avoid with wordpress?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
