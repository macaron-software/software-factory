...
eval_cases:
- id: performance-engineer-approach
  prompt: How should I approach performance engineer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on performance engineer
  tags:
  - performance
- id: performance-engineer-best-practices
  prompt: What are the key best practices and pitfalls for performance engineer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for performance engineer
  tags:
  - performance
  - best-practices
- id: performance-engineer-antipatterns
  prompt: What are the most common mistakes to avoid with performance engineer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
