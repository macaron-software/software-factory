...
metadata:
  ...
  triggers:
  - when working on azure mgmt weightsandbiases dotnet
eval_cases:
- id: azure-mgmt-weightsandbiases-dotnet-approach
  prompt: How should I approach azure mgmt weightsandbiases dotnet for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure mgmt weightsandbiases dotnet
  tags:
  - azure
- id: azure-mgmt-weightsandbiases-dotnet-best-practices
  prompt: What are the key best practices and pitfalls for azure mgmt weightsandbiases
    dotnet?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure mgmt weightsandbiases dotnet
  tags:
  - azure
  - best-practices
- id: azure-mgmt-weightsandbiases-dotnet-antipatterns
  prompt: What are the most common mistakes to avoid with azure mgmt weightsandbiases
    dotnet?
  should_trigger: true
  checks:
  - length_min:80
