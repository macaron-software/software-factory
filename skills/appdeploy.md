...
metadata:
  category: ai
  source: 'antigravity-awesome-skills (MIT) — source: AppDeploy (MIT)'
  triggers:
  - the user asks to deploy or publish a website or web app and wants a public url
  - use when planning or building apps and web apps
eval_cases:
- id: appdeploy-approach
  prompt: How should I approach appdeploy for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on appdeploy
  tags:
  - appdeploy
- id: appdeploy-best-practices
  prompt: What are the key best practices and pitfalls for appdeploy?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for appdeploy
  tags:
  - appdeploy
  - best-practices
- id: appdeploy-antipatterns
  prompt: What are the most common mistakes to avoid with appdeploy?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
