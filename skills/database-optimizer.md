...
eval_cases:
- id: database-optimizer-approach
  prompt: How should I approach database optimizer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on database optimizer
  tags:
  - database
- id: database-optimizer-best-practices
  prompt: What are the key best practices and pitfalls for database optimizer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for database optimizer
  tags:
  - database
  - best-practices
- id: database-optimizer-antipatterns
  prompt: What are the most common mistakes to avoid with database optimizer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
