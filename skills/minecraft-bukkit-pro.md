...
eval_cases:
- id: minecraft-bukkit-pro-approach
  prompt: How should I approach minecraft bukkit pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on minecraft bukkit pro
  tags:
  - minecraft
- id: minecraft-bukkit-pro-best-practices
  prompt: What are the key best practices and pitfalls for minecraft bukkit pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for minecraft bukkit pro
  tags:
  - minecraft
  - best-practices
- id: minecraft-bukkit-pro-antipatterns
  prompt: What are the most common mistakes to avoid with minecraft bukkit pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
