...
metadata:
  ...
  triggers:
  - building business dashboards, selecting metrics, or designing data
  - the task is unrelated to kpi dashboard design
eval_cases:
- id: kpi-dashboard-design-approach
  prompt: How should I approach kpi dashboard design for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on kpi dashboard design
  tags:
  - kpi
- id: kpi-dashboard-design-best-practices
  prompt: What are the key best practices and pitfalls for kpi dashboard design?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for kpi dashboard design
  tags:
  - kpi
  - best-practices
- id: kpi-dashboard-design-antipatterns
  prompt: What are the most common mistakes to avoid with kpi dashboard design?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
