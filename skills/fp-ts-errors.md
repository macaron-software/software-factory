...
eval_cases:
- id: fp-ts-errors-approach
  prompt: How should I approach fp ts errors for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on fp ts errors
  tags:
  - fp
- id: fp-ts-errors-best-practices
  prompt: What are the key best practices and pitfalls for fp ts errors?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for fp ts errors
  tags:
  - fp
  - best-practices
- id: fp-ts-errors-antipatterns
  prompt: What are the most common mistakes to avoid with fp ts errors?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
