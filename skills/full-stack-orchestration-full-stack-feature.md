...
metadata:
  ...
  triggers:
  - working with full stack orchestration full stack feature
  - working on full stack orchestration full stack feature tasks or workflows
eval_cases:
- id: full-stack-orchestration-full-stack-feature-approach
  prompt: How should I approach full stack orchestration full stack feature for a
    production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on full stack orchestration full stack feature
  tags:
  - full
- id: full-stack-orchestration-full-stack-feature-best-practices
  prompt: What are the key best practices and pitfalls for full stack orchestration
    full stack feature?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for full stack orchestration full stack feature
  tags:
  - full
  - best-practices
- id: full-stack-orchestration-full-stack-feature-antipatterns
  prompt: What are the most common mistakes to avoid with full stack orchestration
    full stack feature?
  should_trigger: true
  checks:
  - length_min:80
