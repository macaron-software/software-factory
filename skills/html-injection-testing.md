...
metadata:
  ...
  triggers:
  - when working on html injection testing
eval_cases:
- id: html-injection-testing-approach
  prompt: How should I approach html injection testing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on html injection testing
  tags:
  - html
- id: html-injection-testing-best-practices
  prompt: What are the key best practices and pitfalls for html injection testing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for html injection testing
  tags:
  - html
  - best-practices
- id: html-injection-testing-antipatterns
  prompt: What are the most common mistakes to avoid with html injection testing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
