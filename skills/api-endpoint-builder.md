...
eval_cases:
- id: api-endpoint-builder-approach
  prompt: How should I approach api endpoint builder for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on api endpoint builder
  tags:
  - api
- id: api-endpoint-builder-best-practices
  prompt: What are the key best practices and pitfalls for api endpoint builder?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for api endpoint builder
  tags:
  - api
  - best-practices
- id: api-endpoint-builder-antipatterns
  prompt: What are the most common mistakes to avoid with api endpoint builder?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
