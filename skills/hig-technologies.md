...
metadata:
  ...
  triggers:
  - when working on hig technologies
eval_cases:
- id: hig-technologies-approach
  prompt: How should I approach hig technologies for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hig technologies
  tags:
  - hig
- id: hig-technologies-best-practices
  prompt: What are the key best practices and pitfalls for hig technologies?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hig technologies
  tags:
  - hig
  - best-practices
- id: hig-technologies-antipatterns
  prompt: What are the most common mistakes to avoid with hig technologies?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
