...
eval_cases:
- id: agents-v2-py-approach
  prompt: How should I approach agents v2 py for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on agents v2 py
  tags:
  - agents
- id: agents-v2-py-best-practices
  prompt: What are the key best practices and pitfalls for agents v2 py?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for agents v2 py
  tags:
  - agents
  - best-practices
- id: agents-v2-py-antipatterns
  prompt: What are the most common mistakes to avoid with agents v2 py?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
