...
metadata:
  ...
  triggers:
  - when working on marketing psychology
eval_cases:
- id: marketing-psychology-approach
  prompt: How should I approach marketing psychology for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on marketing psychology
  tags:
  - marketing
- id: marketing-psychology-best-practices
  prompt: What are the key best practices and pitfalls for marketing psychology?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for marketing psychology
  tags:
  - marketing
  - best-practices
- id: marketing-psychology-antipatterns
  prompt: What are the most common mistakes to avoid with marketing psychology?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
