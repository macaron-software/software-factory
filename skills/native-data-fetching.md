...
description: Use when implementing or debugging ANY network request, API call, or
  ...
  support, and Expo Router data loaders (useLo...
metadata:
  category: design
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - implementing or debugging any network request, api call, or data fetching
  - implementing api requests
  - setting up data fetching (react query, swr)
eval_cases:
- id: native-data-fetching-approach
  prompt: How should I approach native data fetching for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on native data fetching
  tags:
  - native
- id: native-data-fetching-best-practices
  prompt: What are the key best practices and pitfalls for native data fetching?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for native data fetching
  tags:
  - native
  - best-practices
- id: native-data-fetching-antipatterns
  prompt: What are the most common mistakes to avoid with native data fetching?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
