...
eval_cases:
- id: content-marketer-approach
  prompt: How should I approach content marketer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on content marketer
  tags:
  - content
- id: content-marketer-best-practices
  prompt: What are the key best practices and pitfalls for content marketer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for content marketer
  tags:
  - content
  - best-practices
- id: content-marketer-antipatterns
  prompt: What are the most common mistakes to avoid with content marketer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
