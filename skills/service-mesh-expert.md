...
metadata:
  ...
  triggers:
  - when working on service mesh expert
eval_cases:
- id: service-mesh-expert-approach
  prompt: How should I approach service mesh expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on service mesh expert
  tags:
  - service
- id: service-mesh-expert-best-practices
  prompt: What are the key best practices and pitfalls for service mesh expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for service mesh expert
  tags:
  - service
  - best-practices
- id: service-mesh-expert-antipatterns
  prompt: What are the most common mistakes to avoid with service mesh expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
