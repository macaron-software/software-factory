...
metadata:
  ...
  triggers:
  - when working on filesystem context
eval_cases:
- id: filesystem-context-approach
  prompt: How should I approach filesystem context for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on filesystem context
  tags:
  - filesystem
- id: filesystem-context-best-practices
  prompt: What are the key best practices and pitfalls for filesystem context?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for filesystem context
  tags:
  - filesystem
  - best-practices
- id: filesystem-context-antipatterns
  prompt: What are the most common mistakes to avoid with filesystem context?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
