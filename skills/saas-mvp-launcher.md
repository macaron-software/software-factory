...
metadata:
  ...
  triggers:
  - planning or building a saas mvp from scratch
  - use when setting up authentication, billing, or database for a saas
eval_cases:
- id: saas-mvp-launcher-approach
  prompt: How should I approach saas mvp launcher for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on saas mvp launcher
  tags:
  - saas
- id: saas-mvp-launcher-best-practices
  prompt: What are the key best practices and pitfalls for saas mvp launcher?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for saas mvp launcher
  tags:
  - saas
  - best-practices
- id: saas-mvp-launcher-antipatterns
  prompt: What are the most common mistakes to avoid with saas mvp launcher?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
