...
metadata:
  ...
  triggers:
  - writing blog posts, creati
eval_cases:
- id: content-creator-approach
  prompt: How should I approach content creator for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on content creator
  tags:
  - content
- id: content-creator-best-practices
  prompt: What are the key best practices and pitfalls for content creator?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for content creator
  tags:
  - content
  - best-practices
- id: content-creator-antipatterns
  prompt: What are the most common mistakes to avoid with content creator?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
