...
eval_cases:
- id: javascript-pro-approach
  prompt: How should I approach javascript pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on javascript pro
  tags:
  - javascript
- id: javascript-pro-best-practices
  prompt: What are the key best practices and pitfalls for javascript pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for javascript pro
  tags:
  - javascript
  - best-practices
- id: javascript-pro-antipatterns
  prompt: What are the most common mistakes to avoid with javascript pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
