...
eval_cases:
- id: team-composition-analysis-approach
  prompt: How should I approach team composition analysis for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on team composition analysis
  tags:
  - team
- id: team-composition-analysis-best-practices
  prompt: What are the key best practices and pitfalls for team composition analysis?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for team composition analysis
  tags:
  - team
  - best-practices
- id: team-composition-analysis-antipatterns
  prompt: What are the most common mistakes to avoid with team composition analysis?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
