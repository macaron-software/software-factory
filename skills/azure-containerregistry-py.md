...
metadata:
  ...
  triggers:
  - when working on azure containerregistry py
eval_cases:
- id: azure-containerregistry-py-approach
  prompt: How should I approach azure containerregistry py for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure containerregistry py
  tags:
  - azure
- id: azure-containerregistry-py-best-practices
  prompt: What are the key best practices and pitfalls for azure containerregistry
    py?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure containerregistry py
  tags:
  - azure
  - best-practices
- id: azure-containerregistry-py-antipatterns
  prompt: What are the most common mistakes to avoid with azure containerregistry
    py?
  should_trigger: true
  checks:
  - length_min:80
