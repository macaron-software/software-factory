...
description: Validate n8n expression syntax and fix common errors. Use when writing
  ...
  expression errors, or working with webhoo...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - writing n8n expressions, using {{}} syntax, accessing $json/$node variables, tro
eval_cases:
- id: n8n-expression-syntax-approach
  prompt: How should I approach n8n expression syntax for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on n8n expression syntax
  tags:
  - n8n
- id: n8n-expression-syntax-best-practices
  prompt: What are the key best practices and pitfalls for n8n expression syntax?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for n8n expression syntax
  tags:
  - n8n
  - best-practices
- id: n8n-expression-syntax-antipatterns
  prompt: What are the most common mistakes to avoid with n8n expression syntax?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
