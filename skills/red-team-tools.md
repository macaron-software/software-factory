...
metadata:
  ...
  triggers:
  - when working on red team tools
eval_cases:
- id: red-team-tools-approach
  prompt: How should I approach red team tools for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on red team tools
  tags:
  - red
- id: red-team-tools-best-practices
  prompt: What are the key best practices and pitfalls for red team tools?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for red team tools
  tags:
  - red
  - best-practices
- id: red-team-tools-antipatterns
  prompt: What are the most common mistakes to avoid with red team tools?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
