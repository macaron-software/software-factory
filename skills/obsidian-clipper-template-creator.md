...
metadata:
  ...
  triggers:
  - you want to create a new clipping template, understand available variables, or
    f
eval_cases:
- id: obsidian-clipper-template-creator-approach
  prompt: How should I approach obsidian clipper template creator for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on obsidian clipper template creator
  tags:
  - obsidian
- id: obsidian-clipper-template-creator-best-practices
  prompt: What are the key best practices and pitfalls for obsidian clipper template
    creator?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for obsidian clipper template creator
  tags:
  - obsidian
  - best-practices
- id: obsidian-clipper-template-creator-antipatterns
  prompt: What are the most common mistakes to avoid with obsidian clipper template
    creator?
  should_trigger: true
  checks:
  - length_min:80
