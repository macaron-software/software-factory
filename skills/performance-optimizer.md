...
metadata:
  ...
  triggers:
  - when working on performance optimizer
eval_cases:
- id: performance-optimizer-approach
  prompt: How should I approach performance optimizer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on performance optimizer
  tags:
  - performance
- id: performance-optimizer-best-practices
  prompt: What are the key best practices and pitfalls for performance optimizer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for performance optimizer
  tags:
  - performance
  - best-practices
- id: performance-optimizer-antipatterns
  prompt: What are the most common mistakes to avoid with performance optimizer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
