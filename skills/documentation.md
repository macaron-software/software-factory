...
- id: documentation-approach
  prompt: How should I approach documentation for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on documentation
  tags:
  - documentation
- id: documentation-best-practices
  prompt: What are the key best practices and pitfalls for documentation?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for documentation
  tags:
  - documentation
  - best-practices
- id: documentation-antipatterns
  prompt: What are the most common mistakes to avoid with documentation?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
