...
metadata:
  ...
  triggers:
  - implementing web services for course management, user tracking, quiz operations,
...
eval_cases:
- id: moodle-external-api-development-approach
  prompt: How should I approach moodle external api development for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on moodle external api development
  tags:
  - moodle
- id: moodle-external-api-development-best-practices
  prompt: What are the key best practices and pitfalls for moodle external api development?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for moodle external api development
  tags:
  - moodle
  - best-practices
- id: moodle-external-api-development-antipatterns
  prompt: What are the most common mistakes to avoid with moodle external api development?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
