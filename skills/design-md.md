...
metadata:
  category: design
  source: 'antigravity-awesome-skills (MIT) — source: https://github.com/google-labs-code/stitch-skills/tree/main/skills/design-md'
  triggers:
  - creating design.md files
  - synthesizing semantic design systems
eval_cases:
- id: design-md-approach
  prompt: How should I approach design md for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on design md
  tags:
  - design
- id: design-md-best-practices
  prompt: What are the key best practices and pitfalls for design md?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for design md
  tags:
  - design
  - best-practices
- id: design-md-antipatterns
  prompt: What are the most common mistakes to avoid with design md?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
