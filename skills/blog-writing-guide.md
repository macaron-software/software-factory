...
description: Write, review, and improve blog posts for the Sentry engineering blog
  ...
  skill whenever someone asks to write a blog pos...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on blog writing guide
eval_cases:
- id: blog-writing-guide-approach
  prompt: How should I approach blog writing guide for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on blog writing guide
  tags:
  - blog
- id: blog-writing-guide-best-practices
  prompt: What are the key best practices and pitfalls for blog writing guide?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for blog writing guide
  tags:
  - blog
  - best-practices
- id: blog-writing-guide-antipatterns
  prompt: What are the most common mistakes to avoid with blog writing guide?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
