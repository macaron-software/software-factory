...
metadata:
  ...
  triggers:
  - when working on hig components layout
eval_cases:
- id: hig-components-layout-approach
  prompt: How should I approach hig components layout for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hig components layout
  tags:
  - hig
- id: hig-components-layout-best-practices
  prompt: What are the key best practices and pitfalls for hig components layout?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hig components layout
  tags:
  - hig
  - best-practices
- id: hig-components-layout-antipatterns
  prompt: What are the most common mistakes to avoid with hig components layout?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
