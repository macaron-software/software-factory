...
metadata:
  ...
  triggers:
  - when working on fitness analyzer
eval_cases:
- id: fitness-analyzer-approach
  prompt: How should I approach fitness analyzer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on fitness analyzer
  tags:
  - fitness
- id: fitness-analyzer-best-practices
  prompt: What are the key best practices and pitfalls for fitness analyzer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for fitness analyzer
  tags:
  - fitness
  - best-practices
- id: fitness-analyzer-antipatterns
  prompt: What are the most common mistakes to avoid with fitness analyzer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
