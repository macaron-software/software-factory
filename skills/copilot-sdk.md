...
metadata:
  ...
  triggers:
  - creating programmatic integrations with copilot across node
eval_cases:
- id: copilot-sdk-approach
  prompt: How should I approach copilot sdk for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on copilot sdk
  tags:
  - copilot
- id: copilot-sdk-best-practices
  prompt: What are the key best practices and pitfalls for copilot sdk?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for copilot sdk
  tags:
  - copilot
  - best-practices
- id: copilot-sdk-antipatterns
  prompt: What are the most common mistakes to avoid with copilot sdk?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
