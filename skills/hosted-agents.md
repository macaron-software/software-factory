...
eval_cases:
- id: hosted-agents-approach
  prompt: How should I approach hosted agents for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hosted agents
  tags:
  - hosted
- id: hosted-agents-best-practices
  prompt: What are the key best practices and pitfalls for hosted agents?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hosted agents
  tags:
  - hosted
  - best-practices
- id: hosted-agents-antipatterns
  prompt: What are the most common mistakes to avoid with hosted agents?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
