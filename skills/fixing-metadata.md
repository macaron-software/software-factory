...
version: 1.0.0
description: fixing metadata skill
metadata:
...
eval_cases:
- id: fixing-metadata-approach
  prompt: How should I approach fixing metadata for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on fixing metadata
  tags:
  - fixing
- id: fixing-metadata-best-practices
  prompt: What are the key best practices and pitfalls for fixing metadata?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for fixing metadata
  tags:
  - fixing
  - best-practices
- id: fixing-metadata-antipatterns
  prompt: What are the most common mistakes to avoid with fixing metadata?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
