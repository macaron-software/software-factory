...
metadata:
  ...
  triggers:
  - when working on azure keyvault keys rust
eval_cases:
- id: azure-keyvault-keys-rust-approach
  prompt: How should I approach azure keyvault keys rust for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure keyvault keys rust
  tags:
  - azure
- id: azure-keyvault-keys-rust-best-practices
  prompt: What are the key best practices and pitfalls for azure keyvault keys rust?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure keyvault keys rust
  tags:
  - azure
  - best-practices
- id: azure-keyvault-keys-rust-antipatterns
  prompt: What are the most common mistakes to avoid with azure keyvault keys rust?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
