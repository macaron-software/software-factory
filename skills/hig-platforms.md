...
metadata:
  ...
  triggers:
  - when working on hig platforms
eval_cases:
- id: hig-platforms-approach
  prompt: How should I approach hig platforms for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hig platforms
  tags:
  - hig
- id: hig-platforms-best-practices
  prompt: What are the key best practices and pitfalls for hig platforms?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hig platforms
  tags:
  - hig
  - best-practices
- id: hig-platforms-antipatterns
  prompt: What are the most common mistakes to avoid with hig platforms?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
