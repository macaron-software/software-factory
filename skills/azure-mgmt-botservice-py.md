...
metadata:
  ...
  triggers:
  - when working on azure mgmt botservice py
eval_cases:
- id: azure-mgmt-botservice-py-approach
  prompt: How should I approach azure mgmt botservice py for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure mgmt botservice py
  tags:
  - azure
- id: azure-mgmt-botservice-py-best-practices
  prompt: What are the key best practices and pitfalls for azure mgmt botservice py?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure mgmt botservice py
  tags:
  - azure
  - best-practices
- id: azure-mgmt-botservice-py-antipatterns
  prompt: What are the most common mistakes to avoid with azure mgmt botservice py?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
