...
eval_cases:
- id: build-approach
  prompt: How should I approach build for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on build
  tags:
  - build
- id: build-best-practices
  prompt: What are the key best practices and pitfalls for build?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for build
  tags:
  - build
  - best-practices
- id: build-antipatterns
  prompt: What are the most common mistakes to avoid with build?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
