...
description: Standard single-cell RNA-seq analysis pipeline. Use for QC, normalization,
  ...
  and visualization. Best for exploratory sc...
metadata:
...
eval_cases:
- id: scanpy-approach
  prompt: How should I approach scanpy for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on scanpy
  tags:
  - scanpy
- id: scanpy-best-practices
  prompt: What are the key best practices and pitfalls for scanpy?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for scanpy
  tags:
  - scanpy
  - best-practices
- id: scanpy-antipatterns
  prompt: What are the most common mistakes to avoid with scanpy?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
