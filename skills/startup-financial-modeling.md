...
eval_cases:
- id: startup-financial-modeling-approach
  prompt: How should I approach startup financial modeling for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on startup financial modeling
  tags:
  - startup
- id: startup-financial-modeling-best-practices
  prompt: What are the key best practices and pitfalls for startup financial modeling?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for startup financial modeling
  tags:
  - startup
  - best-practices
- id: startup-financial-modeling-antipatterns
  prompt: What are the most common mistakes to avoid with startup financial modeling?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
