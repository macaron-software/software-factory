...
eval_cases:
- id: ruby-pro-approach
  prompt: How should I approach ruby pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on ruby pro
  tags:
  - ruby
- id: ruby-pro-best-practices
  prompt: What are the key best practices and pitfalls for ruby pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for ruby pro
  tags:
  - ruby
  - best-practices
- id: ruby-pro-antipatterns
  prompt: What are the most common mistakes to avoid with ruby pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
