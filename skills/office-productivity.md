...
eval_cases:
- id: office-productivity-approach
  prompt: How should I approach office productivity for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on office productivity
  tags:
  - office
- id: office-productivity-best-practices
  prompt: What are the key best practices and pitfalls for office productivity?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for office productivity
  tags:
  - office
  - best-practices
- id: office-productivity-antipatterns
  prompt: What are the most common mistakes to avoid with office productivity?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
