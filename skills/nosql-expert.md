...
metadata:
  ...
  triggers:
  - '**designing for scale**: moving beyond simple single-node databases to distribut'
eval_cases:
- id: nosql-expert-approach
  prompt: How should I approach nosql expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on nosql expert
  tags:
  - nosql
- id: nosql-expert-best-practices
  prompt: What are the key best practices and pitfalls for nosql expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for nosql expert
  tags:
  - nosql
  - best-practices
- id: nosql-expert-antipatterns
  prompt: What are the most common mistakes to avoid with nosql expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
