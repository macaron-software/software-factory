...
metadata:
  ...
  triggers:
  - upgrading framework versions, updating major dependencies, or managing brea
eval_cases:
- id: dependency-upgrade-approach
  prompt: How should I approach dependency upgrade for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on dependency upgrade
  tags:
  - dependency
- id: dependency-upgrade-best-practices
  prompt: What are the key best practices and pitfalls for dependency upgrade?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for dependency upgrade
  tags:
  - dependency
  - best-practices
- id: dependency-upgrade-antipatterns
  prompt: What are the most common mistakes to avoid with dependency upgrade?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
