...
eval_cases:
- id: backend-architect-approach
  prompt: How should I approach backend architect for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on backend architect
  tags:
  - backend
- id: backend-architect-best-practices
  prompt: What are the key best practices and pitfalls for backend architect?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for backend architect
  tags:
  - backend
  - best-practices
- id: backend-architect-antipatterns
  prompt: What are the most common mistakes to avoid with backend architect?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
