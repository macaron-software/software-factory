...
eval_cases:
- id: customer-support-approach
  prompt: How should I approach customer support for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on customer support
  tags:
  - customer
- id: customer-support-best-practices
  prompt: What are the key best practices and pitfalls for customer support?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for customer support
  tags:
  - customer
  - best-practices
- id: customer-support-antipatterns
  prompt: What are the most common mistakes to avoid with customer support?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
