...
eval_cases:
- id: payment-integration-approach
  prompt: How should I approach payment integration for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on payment integration
  tags:
  - payment
- id: payment-integration-best-practices
  prompt: What are the key best practices and pitfalls for payment integration?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for payment integration
  tags:
  - payment
  - best-practices
- id: payment-integration-antipatterns
  prompt: What are the most common mistakes to avoid with payment integration?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
