...
metadata:
  ...
  triggers:
  - when working on frontend dev guidelines
eval_cases:
- id: frontend-dev-guidelines-approach
  prompt: How should I approach frontend dev guidelines for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on frontend dev guidelines
  tags:
  - frontend
- id: frontend-dev-guidelines-best-practices
  prompt: What are the key best practices and pitfalls for frontend dev guidelines?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for frontend dev guidelines
  tags:
  - frontend
  - best-practices
- id: frontend-dev-guidelines-antipatterns
  prompt: What are the most common mistakes to avoid with frontend dev guidelines?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
