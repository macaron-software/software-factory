...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: vibeship-spawner-skills (Apache
    2.0)'
  triggers:
  - when working on langfuse
eval_cases:
- id: langfuse-approach
  prompt: How should I approach langfuse for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on langfuse
  tags:
  - langfuse
- id: langfuse-best-practices
  prompt: What are the key best practices and pitfalls for langfuse?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for langfuse
  tags:
  - langfuse
  - best-practices
- id: langfuse-antipatterns
  prompt: What are the most common mistakes to avoid with langfuse?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
