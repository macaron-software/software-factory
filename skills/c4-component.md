...
eval_cases:
- id: c4-component-approach
  prompt: How should I approach c4 component for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on c4 component
  tags:
  - c4
- id: c4-component-best-practices
  prompt: What are the key best practices and pitfalls for c4 component?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for c4 component
  tags:
  - c4
  - best-practices
- id: c4-component-antipatterns
  prompt: What are the most common mistakes to avoid with c4 component?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
