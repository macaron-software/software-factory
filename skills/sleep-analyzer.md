...
metadata:
  ...
  triggers:
  - when working on sleep analyzer
eval_cases:
- id: sleep-analyzer-approach
  prompt: How should I approach sleep analyzer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on sleep analyzer
  tags:
  - sleep
- id: sleep-analyzer-best-practices
  prompt: What are the key best practices and pitfalls for sleep analyzer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for sleep analyzer
  tags:
  - sleep
  - best-practices
- id: sleep-analyzer-antipatterns
  prompt: What are the most common mistakes to avoid with sleep analyzer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
