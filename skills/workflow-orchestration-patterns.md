...
eval_cases:
- id: workflow-orchestration-patterns-approach
  prompt: How should I approach workflow orchestration patterns for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on workflow orchestration patterns
  tags:
  - workflow
- id: workflow-orchestration-patterns-best-practices
  prompt: What are the key best practices and pitfalls for workflow orchestration
    patterns?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for workflow orchestration patterns
  tags:
  - workflow
  - best-practices
- id: workflow-orchestration-patterns-antipatterns
  prompt: What are the most common mistakes to avoid with workflow orchestration patterns?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
