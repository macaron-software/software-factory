...
eval_cases:
- id: conductor-status-approach
  prompt: How should I approach conductor status for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on conductor status
  tags:
  - conductor
- id: conductor-status-best-practices
  prompt: What are the key best practices and pitfalls for conductor status?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for conductor status
  tags:
  - conductor
  - best-practices
- id: conductor-status-antipatterns
  prompt: What are the most common mistakes to avoid with conductor status?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
