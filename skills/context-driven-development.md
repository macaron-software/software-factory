...
metadata:
  ...
  triggers:
  - when working on context driven development
eval_cases:
- id: context-driven-development-approach
  prompt: How should I approach context driven development for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on context driven development
  tags:
  - context
- id: context-driven-development-best-practices
  prompt: What are the key best practices and pitfalls for context driven development?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for context driven development
  tags:
  - context
  - best-practices
- id: context-driven-development-antipatterns
  prompt: What are the most common mistakes to avoid with context driven development?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
