...
metadata:
  ...
  triggers:
  - when working on ethical hacking methodology
eval_cases:
- id: ethical-hacking-methodology-approach
  prompt: How should I approach ethical hacking methodology for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on ethical hacking methodology
  tags:
  - ethical
- id: ethical-hacking-methodology-best-practices
  prompt: What are the key best practices and pitfalls for ethical hacking methodology?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for ethical hacking methodology
  tags:
  - ethical
  - best-practices
- id: ethical-hacking-methodology-antipatterns
  prompt: What are the most common mistakes to avoid with ethical hacking methodology?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
