...
eval_cases:
- id: terraform-infrastructure-approach
  prompt: How should I approach terraform infrastructure for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on terraform infrastructure
  tags:
  - terraform
- id: terraform-infrastructure-best-practices
  prompt: What are the key best practices and pitfalls for terraform infrastructure?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for terraform infrastructure
  tags:
  - terraform
  - best-practices
- id: terraform-infrastructure-antipatterns
  prompt: What are the most common mistakes to avoid with terraform infrastructure?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
