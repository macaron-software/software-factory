...
metadata:
  ...
  triggers:
  - when working on favicon
eval_cases:
- id: favicon-approach
  prompt: How should I approach favicon for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on favicon
  tags:
  - favicon
- id: favicon-best-practices
  prompt: What are the key best practices and pitfalls for favicon?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for favicon
  tags:
  - favicon
  - best-practices
- id: favicon-antipatterns
  prompt: What are the most common mistakes to avoid with favicon?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
