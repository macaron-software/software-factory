...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: vibeship-spawner-skills (Apache
    2.0)'
  triggers:
  - when working on aws serverless
eval_cases:
- id: aws-serverless-approach
  prompt: How should I approach aws serverless for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on aws serverless
  tags:
  - aws
- id: aws-serverless-best-practices
  prompt: What are the key best practices and pitfalls for aws serverless?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for aws serverless
  tags:
  - aws
  - best-practices
- id: aws-serverless-antipatterns
  prompt: What are the most common mistakes to avoid with aws serverless?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
