...
eval_cases:
- id: tutorial-engineer-approach
  prompt: How should I approach tutorial engineer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on tutorial engineer
  tags:
  - tutorial
- id: tutorial-engineer-best-practices
  prompt: What are the key best practices and pitfalls for tutorial engineer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for tutorial engineer
  tags:
  - tutorial
  - best-practices
- id: tutorial-engineer-antipatterns
  prompt: What are the most common mistakes to avoid with tutorial engineer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
