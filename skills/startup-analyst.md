...
eval_cases:
- id: startup-analyst-approach
  prompt: How should I approach startup analyst for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on startup analyst
  tags:
  - startup
- id: startup-analyst-best-practices
  prompt: What are the key best practices and pitfalls for startup analyst?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for startup analyst
  tags:
  - startup
  - best-practices
- id: startup-analyst-antipatterns
  prompt: What are the most common mistakes to avoid with startup analyst?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
