...
eval_cases:
- id: bug-hunter-approach
  prompt: How should I approach bug hunter for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on bug hunter
  tags:
  - bug
- id: bug-hunter-best-practices
  prompt: What are the key best practices and pitfalls for bug hunter?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for bug hunter
  tags:
  - bug
  - best-practices
- id: bug-hunter-antipatterns
  prompt: What are the most common mistakes to avoid with bug hunter?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
