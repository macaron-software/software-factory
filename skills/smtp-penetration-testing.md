...
metadata:
  ...
  triggers:
  - when working on smtp penetration testing
eval_cases:
- id: smtp-penetration-testing-approach
  prompt: How should I approach smtp penetration testing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on smtp penetration testing
  tags:
  - smtp
- id: smtp-penetration-testing-best-practices
  prompt: What are the key best practices and pitfalls for smtp penetration testing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for smtp penetration testing
  tags:
  - smtp
  - best-practices
- id: smtp-penetration-testing-antipatterns
  prompt: What are the most common mistakes to avoid with smtp penetration testing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
