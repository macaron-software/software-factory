...
eval_cases:
- id: data-scientist-approach
  prompt: How should I approach data scientist for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on data scientist
  tags:
  - data
- id: data-scientist-best-practices
  prompt: What are the key best practices and pitfalls for data scientist?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for data scientist
  tags:
  - data
  - best-practices
- id: data-scientist-antipatterns
  prompt: What are the most common mistakes to avoid with data scientist?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
