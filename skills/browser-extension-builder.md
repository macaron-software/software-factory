...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: vibeship-spawner-skills (Apache
    2.0)'
  triggers:
  - when working on browser extension builder
eval_cases:
- id: browser-extension-builder-approach
  prompt: How should I approach browser extension builder for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on browser extension builder
  tags:
  - browser
- id: browser-extension-builder-best-practices
  prompt: What are the key best practices and pitfalls for browser extension builder?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for browser extension builder
  tags:
  - browser
  - best-practices
- id: browser-extension-builder-antipatterns
  prompt: What are the most common mistakes to avoid with browser extension builder?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
