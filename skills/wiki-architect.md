...
metadata:
  ...
  triggers:
  - the user wants to create a wiki, generate documentation, map a codebase structur
  - user asks to "create a wiki", "document this repo", "generate docs"
eval_cases:
- id: wiki-architect-approach
  prompt: How should I approach wiki architect for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on wiki architect
  tags:
  - wiki
- id: wiki-architect-best-practices
  prompt: What are the key best practices and pitfalls for wiki architect?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for wiki architect
  tags:
  - wiki
  - best-practices
- id: wiki-architect-antipatterns
  prompt: What are the most common mistakes to avoid with wiki architect?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
