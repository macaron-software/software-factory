...
eval_cases:
- id: seo-content-planner-approach
  prompt: How should I approach seo content planner for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on seo content planner
  tags:
  - seo
- id: seo-content-planner-best-practices
  prompt: What are the key best practices and pitfalls for seo content planner?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for seo content planner
  tags:
  - seo
  - best-practices
- id: seo-content-planner-antipatterns
  prompt: What are the most common mistakes to avoid with seo content planner?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
