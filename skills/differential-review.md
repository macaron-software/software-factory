...
description: Performs security-focused differential review of code changes (PRs, commits,
  ...
  blast radius, checks test cover...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on differential review
eval_cases:
- id: differential-review-approach
  prompt: How should I approach differential review for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on differential review
  tags:
  - differential
- id: differential-review-best-practices
  prompt: What are the key best practices and pitfalls for differential review?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for differential review
  tags:
  - differential
  - best-practices
- id: differential-review-antipatterns
  prompt: What are the most common mistakes to avoid with differential review?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
