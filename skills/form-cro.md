...
metadata:
  ...
  - premature redesigns
eval_cases:
- id: form-cro-approach
  prompt: How should I approach form cro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on form cro
  tags:
  - form
- id: form-cro-best-practices
  prompt: What are the key best practices and pitfalls for form cro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for form cro
  tags:
  - form
  - best-practices
- id: form-cro-antipatterns
  prompt: What are the most common mistakes to avoid with form cro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
