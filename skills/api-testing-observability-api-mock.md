...
eval_cases:
- id: api-testing-observability-api-mock-approach
  prompt: How should I approach api testing observability api mock for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on api testing observability api mock
  tags:
  - api
- id: api-testing-observability-api-mock-best-practices
  prompt: What are the key best practices and pitfalls for api testing observability
    api mock?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for api testing observability api mock
  tags:
  - api
  - best-practices
- id: api-testing-observability-api-mock-antipatterns
  prompt: What are the most common mistakes to avoid with api testing observability
    api mock?
  should_trigger: true
  checks:
  - length_min:80
