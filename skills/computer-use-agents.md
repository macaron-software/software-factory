...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: vibeship-spawner-skills (Apache
    2.0)'
  triggers:
  - when working on computer use agents
eval_cases:
- id: computer-use-agents-approach
  prompt: How should I approach computer use agents for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on computer use agents
  tags:
  - computer
- id: computer-use-agents-best-practices
  prompt: What are the key best practices and pitfalls for computer use agents?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for computer use agents
  tags:
  - computer
  - best-practices
- id: computer-use-agents-antipatterns
  prompt: What are the most common mistakes to avoid with computer use agents?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
