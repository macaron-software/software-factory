...
description: This skill should be used when the user asks to "diagnose context problems",
  ...
  or mentions context degradation, at...
metadata:
  category: ai
...
eval_cases:
- id: context-degradation-approach
  prompt: How should I approach context degradation for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on context degradation
  tags:
  - context
- id: context-degradation-best-practices
  prompt: What are the key best practices and pitfalls for context degradation?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for context degradation
  tags:
  - context
  - best-practices
- id: context-degradation-antipatterns
  prompt: What are the most common mistakes to avoid with context degradation?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
