...
metadata:
  ...
  triggers:
  - processing invoices, receipts, ids, forms, or building cu
eval_cases:
- id: azure-ai-document-intelligence-ts-approach
  prompt: How should I approach azure ai document intelligence ts for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure ai document intelligence ts
  tags:
  - azure
- id: azure-ai-document-intelligence-ts-best-practices
  ...
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure ai document intelligence ts
  tags:
  - azure
  - best-practices
- id: azure-ai-document-intelligence-ts-antipatterns
