...
eval_cases:
- id: haskell-pro-approach
  prompt: How should I approach haskell pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on haskell pro
  tags:
  - haskell
- id: haskell-pro-best-practices
  prompt: What are the key best practices and pitfalls for haskell pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for haskell pro
  tags:
  - haskell
  - best-practices
- id: haskell-pro-antipatterns
  prompt: What are the most common mistakes to avoid with haskell pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
