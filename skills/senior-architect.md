...
metadata:
  ...
  triggers:
  - when working on senior architect
eval_cases:
- id: senior-architect-approach
  prompt: How should I approach senior architect for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on senior architect
  tags:
  - senior
- id: senior-architect-best-practices
  prompt: What are the key best practices and pitfalls for senior architect?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for senior architect
  tags:
  - senior
  - best-practices
- id: senior-architect-antipatterns
  prompt: What are the most common mistakes to avoid with senior architect?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
