...
metadata:
  ...
  triggers:
  - when working on hig foundations
eval_cases:
- id: hig-foundations-approach
  prompt: How should I approach hig foundations for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hig foundations
  tags:
  - hig
- id: hig-foundations-best-practices
  prompt: What are the key best practices and pitfalls for hig foundations?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hig foundations
  tags:
  - hig
  - best-practices
- id: hig-foundations-antipatterns
  prompt: What are the most common mistakes to avoid with hig foundations?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
