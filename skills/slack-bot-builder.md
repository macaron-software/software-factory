...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: vibeship-spawner-skills (Apache
    2.0)'
  triggers:
  - when working on slack bot builder
eval_cases:
- id: slack-bot-builder-approach
  prompt: How should I approach slack bot builder for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on slack bot builder
  tags:
  - slack
- id: slack-bot-builder-best-practices
  prompt: What are the key best practices and pitfalls for slack bot builder?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for slack bot builder
  tags:
  - slack
  - best-practices
- id: slack-bot-builder-antipatterns
  prompt: What are the most common mistakes to avoid with slack bot builder?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
