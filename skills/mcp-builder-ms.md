...
metadata:
  ...
  triggers:
  - building mcp servers to integrate exte
eval_cases:
- id: mcp-builder-ms-approach
  prompt: How should I approach mcp builder ms for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on mcp builder ms
  tags:
  - mcp
- id: mcp-builder-ms-best-practices
  prompt: What are the key best practices and pitfalls for mcp builder ms?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for mcp builder ms
  tags:
  - mcp
  - best-practices
- id: mcp-builder-ms-antipatterns
  prompt: What are the most common mistakes to avoid with mcp builder ms?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
