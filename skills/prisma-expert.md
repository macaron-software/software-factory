...
metadata:
  ...
  triggers:
  - when working on prisma expert
eval_cases:
- id: prisma-expert-approach
  prompt: How should I approach prisma expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on prisma expert
  tags:
  - prisma
- id: prisma-expert-best-practices
  prompt: What are the key best practices and pitfalls for prisma expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for prisma expert
  tags:
  - prisma
  - best-practices
- id: prisma-expert-antipatterns
  prompt: What are the most common mistakes to avoid with prisma expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
