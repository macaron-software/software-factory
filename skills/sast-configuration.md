...
metadata:
  ...
  triggers:
  - setting up security scanning, implementing devsecops practices, or aut
  - create custom security rules for your codebase
eval_cases:
- id: sast-configuration-approach
  prompt: How should I approach sast configuration for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on sast configuration
  tags:
  - sast
- id: sast-configuration-best-practices
  prompt: What are the key best practices and pitfalls for sast configuration?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for sast configuration
  tags:
  - sast
  - best-practices
- id: sast-configuration-antipatterns
  prompt: What are the most common mistakes to avoid with sast configuration?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
