...
eval_cases:
- id: frontend-developer-approach
  prompt: How should I approach frontend developer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on frontend developer
  tags:
  - frontend
- id: frontend-developer-best-practices
  prompt: What are the key best practices and pitfalls for frontend developer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for frontend developer
  tags:
  - frontend
  - best-practices
- id: frontend-developer-antipatterns
  prompt: What are the most common mistakes to avoid with frontend developer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
