...
eval_cases:
- id: chrome-extension-developer-approach
  prompt: How should I approach chrome extension developer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on chrome extension developer
  tags:
  - chrome
- id: chrome-extension-developer-best-practices
  prompt: What are the key best practices and pitfalls for chrome extension developer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for chrome extension developer
  tags:
  - chrome
  - best-practices
- id: chrome-extension-developer-antipatterns
  prompt: What are the most common mistakes to avoid with chrome extension developer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
