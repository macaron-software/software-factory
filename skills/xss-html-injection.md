...
eval_cases:
- id: xss-html-injection-approach
  prompt: How should I approach xss html injection for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on xss html injection
  tags:
  - xss
- id: xss-html-injection-best-practices
  prompt: What are the key best practices and pitfalls for xss html injection?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for xss html injection
  tags:
  - xss
  - best-practices
- id: xss-html-injection-antipatterns
  prompt: What are the most common mistakes to avoid with xss html injection?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
