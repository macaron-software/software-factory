...
metadata:
  ...
  triggers:
  - when working on returns reverse logistics
eval_cases:
- id: returns-reverse-logistics-approach
  prompt: How should I approach returns reverse logistics for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on returns reverse logistics
  tags:
  - returns
- id: returns-reverse-logistics-best-practices
  prompt: What are the key best practices and pitfalls for returns reverse logistics?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for returns reverse logistics
  tags:
  - returns
  - best-practices
- id: returns-reverse-logistics-antipatterns
  prompt: What are the most common mistakes to avoid with returns reverse logistics?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
