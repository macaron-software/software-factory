...
eval_cases:
- id: python-pro-approach
  prompt: How should I approach python pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on python pro
  tags:
  - python
- id: python-pro-best-practices
  prompt: What are the key best practices and pitfalls for python pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for python pro
  tags:
  - python
  - best-practices
- id: python-pro-antipatterns
  prompt: What are the most common mistakes to avoid with python pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
