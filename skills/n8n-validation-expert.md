...
description: Interpret validation errors and guide fixing them. Use when encountering
  ...
  or need help understanding validation re...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - encountering validation errors, validation warnings, false positives, operator
    s
eval_cases:
- id: n8n-validation-expert-approach
  prompt: How should I approach n8n validation expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on n8n validation expert
  tags:
  - n8n
- id: n8n-validation-expert-best-practices
  prompt: What are the key best practices and pitfalls for n8n validation expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for n8n validation expert
  tags:
  - n8n
  - best-practices
- id: n8n-validation-expert-antipatterns
  prompt: What are the most common mistakes to avoid with n8n validation expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
