...
eval_cases:
- id: django-pro-approach
  prompt: How should I approach django pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on django pro
  tags:
  - django
- id: django-pro-best-practices
  prompt: What are the key best practices and pitfalls for django pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for django pro
  tags:
  - django
  - best-practices
- id: django-pro-antipatterns
  prompt: What are the most common mistakes to avoid with django pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
