...
metadata:
  ...
  triggers:
  - implementing paypal payments, processing online transactions, or building e-com
eval_cases:
- id: paypal-integration-approach
  prompt: How should I approach paypal integration for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on paypal integration
  tags:
  - paypal
- id: paypal-integration-best-practices
  prompt: What are the key best practices and pitfalls for paypal integration?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for paypal integration
  tags:
  - paypal
  - best-practices
- id: paypal-integration-antipatterns
  prompt: What are the most common mistakes to avoid with paypal integration?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
