...
metadata:
  ...
  triggers:
  - when working on environment setup guide
eval_cases:
- id: environment-setup-guide-approach
  prompt: How should I approach environment setup guide for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on environment setup guide
  tags:
  - environment
- id: environment-setup-guide-best-practices
  prompt: What are the key best practices and pitfalls for environment setup guide?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for environment setup guide
  tags:
  - environment
  - best-practices
- id: environment-setup-guide-antipatterns
  prompt: What are the most common mistakes to avoid with environment setup guide?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
