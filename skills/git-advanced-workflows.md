...
metadata:
  ...
  triggers:
  - managing complex git histories, co
eval_cases:
- id: git-advanced-workflows-approach
  prompt: How should I approach git advanced workflows for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on git advanced workflows
  tags:
  - git
- id: git-advanced-workflows-best-practices
  prompt: What are the key best practices and pitfalls for git advanced workflows?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for git advanced workflows
  tags:
  - git
  - best-practices
- id: git-advanced-workflows-antipatterns
  prompt: What are the most common mistakes to avoid with git advanced workflows?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
