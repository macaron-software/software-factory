...
metadata:
  ...
  triggers:
  - the user wants onboarding documentation fo
eval_cases:
- id: wiki-onboarding-approach
  prompt: How should I approach wiki onboarding for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on wiki onboarding
  tags:
  - wiki
- id: wiki-onboarding-best-practices
  prompt: What are the key best practices and pitfalls for wiki onboarding?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for wiki onboarding
  tags:
  - wiki
  - best-practices
- id: wiki-onboarding-antipatterns
  prompt: What are the most common mistakes to avoid with wiki onboarding?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
