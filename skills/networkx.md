...
name: networkx
version: 1.0.0
description: networkx skill
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - '**creating graphs**: building network structures from data, adding nodes and
    edg'
eval_cases:
- id: networkx-approach
  prompt: How should I approach networkx for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on networkx
  tags:
  - networkx
- id: networkx-best-practices
  prompt: What are the key best practices and pitfalls for networkx?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for networkx
  tags:
  - networkx
  - best-practices
- id: networkx-antipatterns
  prompt: What are the most common mistakes to avoid with networkx?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
