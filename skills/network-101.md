...
metadata:
  ...
  triggers:
  - when working on network 101
eval_cases:
- id: network-101-approach
  prompt: How should I approach network 101 for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on network 101
  tags:
  - network
- id: network-101-best-practices
  prompt: What are the key best practices and pitfalls for network 101?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for network 101
  tags:
  - network
  - best-practices
- id: network-101-antipatterns
  prompt: What are the most common mistakes to avoid with network 101?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
