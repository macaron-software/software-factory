...
eval_cases:
- id: cloud-architect-approach
  prompt: How should I approach cloud architect for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on cloud architect
  tags:
  - cloud
- id: cloud-architect-best-practices
  prompt: What are the key best practices and pitfalls for cloud architect?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for cloud architect
  tags:
  - cloud
  - best-practices
- id: cloud-architect-antipatterns
  prompt: What are the most common mistakes to avoid with cloud architect?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
