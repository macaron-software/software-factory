...
metadata:
  ...
  triggers:
  - the user pastes bug info, error messages, or informal descriptions and wan
eval_cases:
- id: github-issue-creator-approach
  prompt: How should I approach github issue creator for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on github issue creator
  tags:
  - github
- id: github-issue-creator-best-practices
  prompt: What are the key best practices and pitfalls for github issue creator?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for github issue creator
  tags:
  - github
  - best-practices
- id: github-issue-creator-antipatterns
  prompt: What are the most common mistakes to avoid with github issue creator?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
