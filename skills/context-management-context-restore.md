...
metadata:
  ...
  triggers:
  - working with context management context restore
  - 'working on context restoration: advanced semantic memory rehydration tasks or
    wo'
eval_cases:
- id: context-management-context-restore-approach
  prompt: How should I approach context management context restore for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on context management context restore
  tags:
  - context
- id: context-management-context-restore-best-practices
  prompt: What are the key best practices and pitfalls for context management context
    restore?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for context management context restore
  tags:
  - context
  - best-practices
- id: context-management-context-restore-antipatterns
  prompt: What are the most common mistakes to avoid with context management context
    restore?
  should_trigger: true
  checks:
  - length_min:80
