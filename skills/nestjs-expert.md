...
metadata:
  ...
  triggers:
  - when working on nestjs expert
eval_cases:
- id: nestjs-expert-approach
  prompt: How should I approach nestjs expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on nestjs expert
  tags:
  - nestjs
- id: nestjs-expert-best-practices
  prompt: What are the key best practices and pitfalls for nestjs expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for nestjs expert
  tags:
  - nestjs
  - best-practices
- id: nestjs-expert-antipatterns
  prompt: What are the most common mistakes to avoid with nestjs expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
