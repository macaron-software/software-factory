...
metadata:
  ...
  triggers:
  - improving agent performance, throughput, or reliability
  - designing orchestration strategies for complex workflows
eval_cases:
- id: agent-orchestration-multi-agent-optimize-approach
  prompt: How should I approach agent orchestration multi agent optimize for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on agent orchestration multi agent optimize
  tags:
  - agent
- id: agent-orchestration-multi-agent-optimize-best-practices
  prompt: What are the key best practices and pitfalls for agent orchestration multi
    agent optimize?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for agent orchestration multi agent optimize
  tags:
  - agent
  - best-practices
- id: agent-orchestration-multi-agent-optimize-antipatterns
  prompt: What are the most common mistakes to avoid with agent orchestration multi
    agent optimize?
  should_trigger: true
  checks:
  - length_min:80
