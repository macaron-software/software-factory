...
description: Add and manage evaluation results in Hugging Face model cards. Supports
  ...
  API, and running custom model evaluatio...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on hugging face evaluation
eval_cases:
- id: hugging-face-evaluation-approach
  prompt: How should I approach hugging face evaluation for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hugging face evaluation
  tags:
  - hugging
- id: hugging-face-evaluation-best-practices
  prompt: What are the key best practices and pitfalls for hugging face evaluation?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hugging face evaluation
  tags:
  - hugging
  - best-practices
- id: hugging-face-evaluation-antipatterns
  prompt: What are the most common mistakes to avoid with hugging face evaluation?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
