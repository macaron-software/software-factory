...
eval_cases:
- id: data-engineering-data-pipeline-approach
  prompt: How should I approach data engineering data pipeline for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on data engineering data pipeline
  tags:
  - data
- id: data-engineering-data-pipeline-best-practices
  prompt: What are the key best practices and pitfalls for data engineering data pipeline?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for data engineering data pipeline
  tags:
  - data
  - best-practices
- id: data-engineering-data-pipeline-antipatterns
  prompt: What are the most common mistakes to avoid with data engineering data pipeline?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
