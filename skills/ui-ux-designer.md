...
eval_cases:
- id: ui-ux-designer-approach
  prompt: How should I approach ui ux designer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on ui ux designer
  tags:
  - ui
- id: ui-ux-designer-best-practices
  prompt: What are the key best practices and pitfalls for ui ux designer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for ui ux designer
  tags:
  - ui
  - best-practices
- id: ui-ux-designer-antipatterns
  prompt: What are the most common mistakes to avoid with ui ux designer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
