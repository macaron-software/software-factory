...
metadata:
  ...
  triggers:
  - when working on ffuf web fuzzing
eval_cases:
- id: ffuf-web-fuzzing-approach
  prompt: How should I approach ffuf web fuzzing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on ffuf web fuzzing
  tags:
  - ffuf
- id: ffuf-web-fuzzing-best-practices
  prompt: What are the key best practices and pitfalls for ffuf web fuzzing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for ffuf web fuzzing
  tags:
  - ffuf
  - best-practices
- id: ffuf-web-fuzzing-antipatterns
  prompt: What are the most common mistakes to avoid with ffuf web fuzzing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
