...
metadata:
  ...
  triggers:
  - when working on ddd strategic design
eval_cases:
- id: ddd-strategic-design-approach
  prompt: How should I approach ddd strategic design for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on ddd strategic design
  tags:
  - ddd
- id: ddd-strategic-design-best-practices
  prompt: What are the key best practices and pitfalls for ddd strategic design?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for ddd strategic design
  tags:
  - ddd
  - best-practices
- id: ddd-strategic-design-antipatterns
  prompt: What are the most common mistakes to avoid with ddd strategic design?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
