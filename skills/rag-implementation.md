...
eval_cases:
- id: rag-implementation-approach
  prompt: How should I approach rag implementation for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on rag implementation
  tags:
  - rag
- id: rag-implementation-best-practices
  prompt: What are the key best practices and pitfalls for rag implementation?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for rag implementation
  tags:
  - rag
  - best-practices
- id: rag-implementation-antipatterns
  prompt: What are the most common mistakes to avoid with rag implementation?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
