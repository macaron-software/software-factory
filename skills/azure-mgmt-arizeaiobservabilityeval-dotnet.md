...
metadata:
  ...
  triggers:
  - when working on azure mgmt arizeaiobservabilityeval dotnet
eval_cases:
- id: azure-mgmt-arizeaiobservabilityeval-dotnet-approach
  prompt: How should I approach azure mgmt arizeaiobservabilityeval dotnet for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure mgmt arizeaiobservabilityeval dotnet
  tags:
  - azure
- id: azure-mgmt-arizeaiobservabilityeval-dotnet-best-practices
  prompt: What are the key best practices and pitfalls for azure mgmt arizeaiobservabilityeval
    dotnet?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure mgmt arizeaiobservabilityeval dotnet
  tags:
  - azure
  - best-practices
- id: azure-mgmt-arizeaiobservabilityeval-dotnet-antipatterns
  prompt: What are the most common mistakes to avoid with azure mgmt arizeaiobservabilityeval
    dotnet?
  should_trigger: true
  checks:
  - length_min:80
