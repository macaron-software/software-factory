...
eval_cases:
- id: testing-qa-approach
  prompt: How should I approach testing qa for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on testing qa
  tags:
  - testing
- id: testing-qa-best-practices
  prompt: What are the key best practices and pitfalls for testing qa?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for testing qa
  tags:
  - testing
  - best-practices
- id: testing-qa-antipatterns
  prompt: What are the most common mistakes to avoid with testing qa?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
