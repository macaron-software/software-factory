...
metadata:
  ...
  triggers:
  - storing, retrieving, or managing passwords, api keys, connection strings, or oth
eval_cases:
- id: azure-security-keyvault-secrets-java-approach
  prompt: How should I approach azure security keyvault secrets java for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure security keyvault secrets java
  tags:
  - azure
- id: azure-security-keyvault-secrets-java-best-practices
  prompt: What are the key best practices and pitfalls for azure security keyvault
    secrets java?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure security keyvault secrets java
  tags:
  - azure
  - best-practices
- id: azure-security-keyvault-secrets-java-antipatterns
  prompt: What are the most common mistakes to avoid with azure security keyvault
    secrets java?
  should_trigger: true
  checks:
  - length_min:80
