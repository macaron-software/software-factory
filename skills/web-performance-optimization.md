...
metadata:
  ...
  triggers:
  - when working on web performance optimization
eval_cases:
- id: web-performance-optimization-approach
  prompt: How should I approach web performance optimization for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on web performance optimization
  tags:
  - web
- id: web-performance-optimization-best-practices
  prompt: What are the key best practices and pitfalls for web performance optimization?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for web performance optimization
  tags:
  - web
  - best-practices
- id: web-performance-optimization-antipatterns
  prompt: What are the most common mistakes to avoid with web performance optimization?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
