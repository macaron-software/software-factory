...
metadata:
  ...
  triggers:
  - when working on expo tailwind setup
eval_cases:
- id: expo-tailwind-setup-approach
  prompt: How should I approach expo tailwind setup for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on expo tailwind setup
  tags:
  - expo
- id: expo-tailwind-setup-best-practices
  prompt: What are the key best practices and pitfalls for expo tailwind setup?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for expo tailwind setup
  tags:
  - expo
  - best-practices
- id: expo-tailwind-setup-antipatterns
  prompt: What are the most common mistakes to avoid with expo tailwind setup?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
