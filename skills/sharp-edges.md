...
eval_cases:
- id: sharp-edges-approach
  prompt: How should I approach sharp edges for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on sharp edges
  tags:
  - sharp
- id: sharp-edges-best-practices
  prompt: What are the key best practices and pitfalls for sharp edges?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for sharp edges
  tags:
  - sharp
  - best-practices
- id: sharp-edges-antipatterns
  prompt: What are the most common mistakes to avoid with sharp edges?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
