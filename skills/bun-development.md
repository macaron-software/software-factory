...
metadata:
  ...
  triggers:
  - working with bun, optimizing js/ts development speed, o
eval_cases:
- id: bun-development-approach
  prompt: How should I approach bun development for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on bun development
  tags:
  - bun
- id: bun-development-best-practices
  prompt: What are the key best practices and pitfalls for bun development?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for bun development
  tags:
  - bun
  - best-practices
- id: bun-development-antipatterns
  prompt: What are the most common mistakes to avoid with bun development?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
