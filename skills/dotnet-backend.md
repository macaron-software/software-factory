...
eval_cases:
- id: dotnet-backend-approach
  prompt: How should I approach dotnet backend for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on dotnet backend
  tags:
  - dotnet
- id: dotnet-backend-best-practices
  prompt: What are the key best practices and pitfalls for dotnet backend?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for dotnet backend
  tags:
  - dotnet
  - best-practices
- id: dotnet-backend-antipatterns
  prompt: What are the most common mistakes to avoid with dotnet backend?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
