...
eval_cases:
- id: frontend-mobile-development-component-scaffold-approach
  prompt: How should I approach frontend mobile development component scaffold for
    a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on frontend mobile development component scaffold
  tags:
  - frontend
- id: frontend-mobile-development-component-scaffold-best-practices
  prompt: What are the key best practices and pitfalls for frontend mobile development
    component scaffold?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for frontend mobile development component scaffold
  tags:
  - frontend
  - best-practices
- id: frontend-mobile-development-component-scaffold-antipatterns
  prompt: What are the most common mistakes to avoid with frontend mobile development
    component scaffold?
  should_trigger: true
  checks:
  - length_min:80
