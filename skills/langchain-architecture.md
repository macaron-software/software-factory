...
metadata:
  ...
  triggers:
  - building langchain applications, implementing ai agents, or creating complex llm
eval_cases:
- id: langchain-architecture-approach
  prompt: How should I approach langchain architecture for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on langchain architecture
  tags:
  - langchain
- id: langchain-architecture-best-practices
  prompt: What are the key best practices and pitfalls for langchain architecture?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for langchain architecture
  tags:
  - langchain
  - best-practices
- id: langchain-architecture-antipatterns
  prompt: What are the most common mistakes to avoid with langchain architecture?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
