...
eval_cases:
- id: radix-ui-design-system-approach
  prompt: How should I approach radix ui design system for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on radix ui design system
  tags:
  - radix
- id: radix-ui-design-system-best-practices
  prompt: What are the key best practices and pitfalls for radix ui design system?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for radix ui design system
  tags:
  - radix
  - best-practices
- id: radix-ui-design-system-antipatterns
  prompt: What are the most common mistakes to avoid with radix ui design system?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
