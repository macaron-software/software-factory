...
metadata:
  ...
  triggers:
  - working with comprehensive review full review
  - working on comprehensive review full review tasks or workflows
  - needing guidance, best practices, or checklists for comprehensive review full
    re
  - the task is unrelated to comprehensive review full review
eval_cases:
- id: comprehensive-review-full-review-approach
  prompt: How should I approach comprehensive review full review for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on comprehensive review full review
  tags:
  - comprehensive
- id: comprehensive-review-full-review-best-practices
  prompt: What are the key best practices and pitfalls for comprehensive review full
    review?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for comprehensive review full review
  tags:
  - comprehensive
  - best-practices
- id: comprehensive-review-full-review-antipatterns
  prompt: What are the most common mistakes to avoid with comprehensive review full
    review?
  should_trigger: true
  checks:
  - length_min:80
