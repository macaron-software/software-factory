...
eval_cases:
- id: programmatic-seo-approach
  prompt: How should I approach programmatic seo for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on programmatic seo
  tags:
  - programmatic
- id: programmatic-seo-best-practices
  prompt: What are the key best practices and pitfalls for programmatic seo?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for programmatic seo
  tags:
  - programmatic
  - best-practices
- id: programmatic-seo-antipatterns
  prompt: What are the most common mistakes to avoid with programmatic seo?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
