...
description: Audits GitHub Actions workflows for security vulnerabilities in AI agent
  ...
  AI Inference. Detects attack vectors where a...
metadata:
  category: ai
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - reviewing ci/cd configurations that invoke claude code action, gemini cli, or
    op
eval_cases:
- id: agentic-actions-auditor-approach
  prompt: How should I approach agentic actions auditor for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on agentic actions auditor
  tags:
  - agentic
- id: agentic-actions-auditor-best-practices
  prompt: What are the key best practices and pitfalls for agentic actions auditor?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for agentic actions auditor
  tags:
  - agentic
  - best-practices
- id: agentic-actions-auditor-antipatterns
  prompt: What are the most common mistakes to avoid with agentic actions auditor?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
