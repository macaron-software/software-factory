...
eval_cases:
- id: cirq-approach
  prompt: How should I approach cirq for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on cirq
  tags:
  - cirq
- id: cirq-best-practices
  prompt: What are the key best practices and pitfalls for cirq?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for cirq
  tags:
  - cirq
  - best-practices
- id: cirq-antipatterns
  prompt: What are the most common mistakes to avoid with cirq?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
