...
metadata:
  ...
  triggers:
  - when working on azure mgmt fabric py
eval_cases:
- id: azure-mgmt-fabric-py-approach
  prompt: How should I approach azure mgmt fabric py for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure mgmt fabric py
  tags:
  - azure
- id: azure-mgmt-fabric-py-best-practices
  prompt: What are the key best practices and pitfalls for azure mgmt fabric py?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure mgmt fabric py
  tags:
  - azure
  - best-practices
- id: azure-mgmt-fabric-py-antipatterns
  prompt: What are the most common mistakes to avoid with azure mgmt fabric py?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
