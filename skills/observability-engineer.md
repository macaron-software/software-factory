...
eval_cases:
- id: observability-engineer-approach
  prompt: How should I approach observability engineer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on observability engineer
  tags:
  - observability
- id: observability-engineer-best-practices
  prompt: What are the key best practices and pitfalls for observability engineer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for observability engineer
  tags:
  - observability
  - best-practices
- id: observability-engineer-antipatterns
  prompt: What are the most common mistakes to avoid with observability engineer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
