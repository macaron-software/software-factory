...
description: Write copy following Sentry brand guidelines. Use when writing UI text,
  ...
  copy, or any user-facing content. Covers ...
metadata:
  category: design
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - writing ui text, error messages, empty states, onboarding flows, 404 pages, docu
eval_cases:
- id: brand-guidelines-approach
  prompt: How should I approach brand guidelines for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on brand guidelines
  tags:
  - brand
- id: brand-guidelines-best-practices
  prompt: What are the key best practices and pitfalls for brand guidelines?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for brand guidelines
  tags:
  - brand
  - best-practices
- id: brand-guidelines-antipatterns
  prompt: What are the most common mistakes to avoid with brand guidelines?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
