...
metadata:
  ...
  triggers:
  - when working on new rails project
eval_cases:
- id: new-rails-project-approach
  prompt: How should I approach new rails project for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on new rails project
  tags:
  - new
- id: new-rails-project-best-practices
  prompt: What are the key best practices and pitfalls for new rails project?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for new rails project
  tags:
  - new
  - best-practices
- id: new-rails-project-antipatterns
  prompt: What are the most common mistakes to avoid with new rails project?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
