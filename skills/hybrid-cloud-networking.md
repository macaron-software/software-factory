...
metadata:
  ...
  triggers:
  - building hybrid cloud architectures, connecting
  - the task is unrelated to hybrid cloud networking
eval_cases:
- id: hybrid-cloud-networking-approach
  prompt: How should I approach hybrid cloud networking for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hybrid cloud networking
  tags:
  - hybrid
- id: hybrid-cloud-networking-best-practices
  prompt: What are the key best practices and pitfalls for hybrid cloud networking?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hybrid cloud networking
  tags:
  - hybrid
  - best-practices
- id: hybrid-cloud-networking-antipatterns
  prompt: What are the most common mistakes to avoid with hybrid cloud networking?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
