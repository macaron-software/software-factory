...
metadata:
  ...
  triggers:
  - when working on azure identity py
eval_cases:
- id: azure-identity-py-approach
  prompt: How should I approach azure identity py for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure identity py
  tags:
  - azure
- id: azure-identity-py-best-practices
  prompt: What are the key best practices and pitfalls for azure identity py?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure identity py
  tags:
  - azure
  - best-practices
- id: azure-identity-py-antipatterns
  prompt: What are the most common mistakes to avoid with azure identity py?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
