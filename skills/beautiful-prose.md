...
metadata:
  ...
  triggers:
  - users ask for prose or rewrites that must be clean, exact, concrete, and free
    of
eval_cases:
- id: beautiful-prose-approach
  prompt: How should I approach beautiful prose for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on beautiful prose
  tags:
  - beautiful
- id: beautiful-prose-best-practices
  prompt: What are the key best practices and pitfalls for beautiful prose?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for beautiful prose
  tags:
  - beautiful
  - best-practices
- id: beautiful-prose-antipatterns
  prompt: What are the most common mistakes to avoid with beautiful prose?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
