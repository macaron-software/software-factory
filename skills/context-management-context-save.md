...
metadata:
  ...
  triggers:
  - working with context management context save
  - 'working on context save tool: intelligent context management specialist tasks
    or'
eval_cases:
- id: context-management-context-save-approach
  prompt: How should I approach context management context save for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on context management context save
  tags:
  - context
- id: context-management-context-save-best-practices
  ...
  - no_placeholder
  expectations:
  - Lists concrete best practices for context management context save
  tags:
  - context
  - best-practices
- id: context-management-context-save-antipatterns
