...
metadata:
  ...
  triggers:
  - when working on hig patterns
eval_cases:
- id: hig-patterns-approach
  prompt: How should I approach hig patterns for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hig patterns
  tags:
  - hig
- id: hig-patterns-best-practices
  prompt: What are the key best practices and pitfalls for hig patterns?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hig patterns
  tags:
  - hig
  - best-practices
- id: hig-patterns-antipatterns
  prompt: What are the most common mistakes to avoid with hig patterns?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
