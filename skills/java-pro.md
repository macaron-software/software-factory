...
eval_cases:
- id: java-pro-approach
  prompt: How should I approach java pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on java pro
  tags:
  - java
- id: java-pro-best-practices
  prompt: What are the key best practices and pitfalls for java pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for java pro
  tags:
  - java
  - best-practices
- id: java-pro-antipatterns
  prompt: What are the most common mistakes to avoid with java pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
