...
eval_cases:
- id: api-documentation-approach
  prompt: How should I approach api documentation for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on api documentation
  tags:
  - api
- id: api-documentation-best-practices
  prompt: What are the key best practices and pitfalls for api documentation?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for api documentation
  tags:
  - api
  - best-practices
- id: api-documentation-antipatterns
  prompt: What are the most common mistakes to avoid with api documentation?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
