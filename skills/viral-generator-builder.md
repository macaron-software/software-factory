...
eval_cases:
- id: viral-generator-builder-approach
  prompt: How should I approach viral generator builder for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on viral generator builder
  tags:
  - viral
- id: viral-generator-builder-best-practices
  prompt: What are the key best practices and pitfalls for viral generator builder?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for viral generator builder
  tags:
  - viral
  - best-practices
- id: viral-generator-builder-antipatterns
  prompt: What are the most common mistakes to avoid with viral generator builder?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
