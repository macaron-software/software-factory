...
metadata:
  ...
  triggers:
  - when working on senior fullstack
eval_cases:
- id: senior-fullstack-approach
  prompt: How should I approach senior fullstack for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on senior fullstack
  tags:
  - senior
- id: senior-fullstack-best-practices
  prompt: What are the key best practices and pitfalls for senior fullstack?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for senior fullstack
  tags:
  - senior
  - best-practices
- id: senior-fullstack-antipatterns
  prompt: What are the most common mistakes to avoid with senior fullstack?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
