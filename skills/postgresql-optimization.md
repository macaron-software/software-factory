...
eval_cases:
- id: postgresql-optimization-approach
  prompt: How should I approach postgresql optimization for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on postgresql optimization
  tags:
  - postgresql
- id: postgresql-optimization-best-practices
  prompt: What are the key best practices and pitfalls for postgresql optimization?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for postgresql optimization
  tags:
  - postgresql
  - best-practices
- id: postgresql-optimization-antipatterns
  prompt: What are the most common mistakes to avoid with postgresql optimization?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
