...
description: Proven workflow architectural patterns from real n8n workflows. Use when
  ...
  planning workflow architecture, or asking ...
metadata:
...
eval_cases:
- id: n8n-workflow-patterns-approach
  prompt: How should I approach n8n workflow patterns for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on n8n workflow patterns
  tags:
  - n8n
- id: n8n-workflow-patterns-best-practices
  prompt: What are the key best practices and pitfalls for n8n workflow patterns?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for n8n workflow patterns
  tags:
  - n8n
  - best-practices
- id: n8n-workflow-patterns-antipatterns
  prompt: What are the most common mistakes to avoid with n8n workflow patterns?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
