...
eval_cases:
- id: database-migrations-migration-observability-approach
  prompt: How should I approach database migrations migration observability for a
    production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on database migrations migration observability
  tags:
  - database
- id: database-migrations-migration-observability-best-practices
  prompt: What are the key best practices and pitfalls for database migrations migration
    observability?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for database migrations migration observability
  tags:
  - database
  - best-practices
- id: database-migrations-migration-observability-antipatterns
  prompt: What are the most common mistakes to avoid with database migrations migration
    observability?
  should_trigger: true
  checks:
  - length_min:80
