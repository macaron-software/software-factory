...
eval_cases:
- id: react-nextjs-development-approach
  prompt: How should I approach react nextjs development for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on react nextjs development
  tags:
  - react
- id: react-nextjs-development-best-practices
  prompt: What are the key best practices and pitfalls for react nextjs development?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for react nextjs development
  tags:
  - react
  - best-practices
- id: react-nextjs-development-antipatterns
  prompt: What are the most common mistakes to avoid with react nextjs development?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
