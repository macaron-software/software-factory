...
metadata:
  ...
  triggers:
  - testing solidity contracts, setting up blockchain test suites, or va
eval_cases:
- id: web3-testing-approach
  prompt: How should I approach web3 testing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on web3 testing
  tags:
  - web3
- id: web3-testing-best-practices
  prompt: What are the key best practices and pitfalls for web3 testing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for web3 testing
  tags:
  - web3
  - best-practices
- id: web3-testing-antipatterns
  prompt: What are the most common mistakes to avoid with web3 testing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
