...
metadata:
  ...
  triggers:
  - when working on geo fundamentals
eval_cases:
- id: geo-fundamentals-approach
  prompt: How should I approach geo fundamentals for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on geo fundamentals
  tags:
  - geo
- id: geo-fundamentals-best-practices
  prompt: What are the key best practices and pitfalls for geo fundamentals?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for geo fundamentals
  tags:
  - geo
  - best-practices
- id: geo-fundamentals-antipatterns
  prompt: What are the most common mistakes to avoid with geo fundamentals?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
