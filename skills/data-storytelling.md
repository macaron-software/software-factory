...
metadata:
  ...
  triggers:
  - presenting analytics to stakeholders, creating data reports, or building executi
eval_cases:
- id: data-storytelling-approach
  prompt: How should I approach data storytelling for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on data storytelling
  tags:
  - data
- id: data-storytelling-best-practices
  prompt: What are the key best practices and pitfalls for data storytelling?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for data storytelling
  tags:
  - data
  - best-practices
- id: data-storytelling-antipatterns
  prompt: What are the most common mistakes to avoid with data storytelling?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
