...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: https://github.com/huggingface/skills/tree/main/skills/hugging-face-cli'
  triggers:
  - the user needs to download models/datasets/spaces, upload files to hub repositor
  - creating hugging face repositories
eval_cases:
- id: hugging-face-cli-approach
  prompt: How should I approach hugging face cli for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hugging face cli
  tags:
  - hugging
- id: hugging-face-cli-best-practices
  prompt: What are the key best practices and pitfalls for hugging face cli?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hugging face cli
  tags:
  - hugging
  - best-practices
- id: hugging-face-cli-antipatterns
  prompt: What are the most common mistakes to avoid with hugging face cli?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
