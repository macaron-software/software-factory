...
metadata:
  ...
  triggers:
  - when working on top web vulnerabilities
eval_cases:
- id: top-web-vulnerabilities-approach
  prompt: How should I approach top web vulnerabilities for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on top web vulnerabilities
  tags:
  - top
- id: top-web-vulnerabilities-best-practices
  prompt: What are the key best practices and pitfalls for top web vulnerabilities?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for top web vulnerabilities
  tags:
  - top
  - best-practices
- id: top-web-vulnerabilities-antipatterns
  prompt: What are the most common mistakes to avoid with top web vulnerabilities?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
