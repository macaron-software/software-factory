...
description: Find similar vulnerabilities and bugs across codebases using pattern-based
  ...
  security vulnerabilities, or performin...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - hunting bug variants, building codeql/semgrep queries, analyzing security vulner
  - building or refining codeql/semgrep queries for security patterns
eval_cases:
- id: variant-analysis-approach
  prompt: How should I approach variant analysis for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on variant analysis
  tags:
  - variant
- id: variant-analysis-best-practices
  prompt: What are the key best practices and pitfalls for variant analysis?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for variant analysis
  tags:
  - variant
  - best-practices
- id: variant-analysis-antipatterns
  prompt: What are the most common mistakes to avoid with variant analysis?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
