...
metadata:
  ...
  triggers:
  - when working on burp suite testing
eval_cases:
- id: burp-suite-testing-approach
  prompt: How should I approach burp suite testing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on burp suite testing
  tags:
  - burp
- id: burp-suite-testing-best-practices
  prompt: What are the key best practices and pitfalls for burp suite testing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for burp suite testing
  tags:
  - burp
  - best-practices
- id: burp-suite-testing-antipatterns
  prompt: What are the most common mistakes to avoid with burp suite testing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
