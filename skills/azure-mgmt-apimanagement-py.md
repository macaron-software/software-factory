...
metadata:
  ...
  triggers:
  - when working on azure mgmt apimanagement py
eval_cases:
- id: azure-mgmt-apimanagement-py-approach
  prompt: How should I approach azure mgmt apimanagement py for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure mgmt apimanagement py
  tags:
  - azure
- id: azure-mgmt-apimanagement-py-best-practices
  ...
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure mgmt apimanagement py
  tags:
  - azure
  - best-practices
- id: azure-mgmt-apimanagement-py-antipatterns
