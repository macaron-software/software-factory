...
eval_cases:
- id: cloudflare-workers-expert-approach
  prompt: How should I approach cloudflare workers expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on cloudflare workers expert
  tags:
  - cloudflare
- id: cloudflare-workers-expert-best-practices
  prompt: What are the key best practices and pitfalls for cloudflare workers expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for cloudflare workers expert
  tags:
  - cloudflare
  - best-practices
- id: cloudflare-workers-expert-antipatterns
  prompt: What are the most common mistakes to avoid with cloudflare workers expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
