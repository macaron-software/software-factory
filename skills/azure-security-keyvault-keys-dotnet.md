...
metadata:
  ...
  triggers:
  - when working on azure security keyvault keys dotnet
eval_cases:
- id: azure-security-keyvault-keys-dotnet-approach
  prompt: How should I approach azure security keyvault keys dotnet for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure security keyvault keys dotnet
  tags:
  - azure
- id: azure-security-keyvault-keys-dotnet-best-practices
  ...
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure security keyvault keys dotnet
  tags:
  - azure
  - best-practices
- id: azure-security-keyvault-keys-dotnet-antipatterns
