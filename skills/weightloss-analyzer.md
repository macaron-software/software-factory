...
metadata:
  ...
  triggers:
  - when working on weightloss analyzer
eval_cases:
- id: weightloss-analyzer-approach
  prompt: How should I approach weightloss analyzer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on weightloss analyzer
  tags:
  - weightloss
- id: weightloss-analyzer-best-practices
  prompt: What are the key best practices and pitfalls for weightloss analyzer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for weightloss analyzer
  tags:
  - weightloss
  - best-practices
- id: weightloss-analyzer-antipatterns
  prompt: What are the most common mistakes to avoid with weightloss analyzer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
