...
eval_cases:
- id: sql-pro-approach
  prompt: How should I approach sql pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on sql pro
  tags:
  - sql
- id: sql-pro-best-practices
  prompt: What are the key best practices and pitfalls for sql pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for sql pro
  tags:
  - sql
  - best-practices
- id: sql-pro-antipatterns
  prompt: What are the most common mistakes to avoid with sql pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
