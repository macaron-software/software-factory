...
eval_cases:
- id: kubernetes-deployment-approach
  prompt: How should I approach kubernetes deployment for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on kubernetes deployment
  tags:
  - kubernetes
- id: kubernetes-deployment-best-practices
  prompt: What are the key best practices and pitfalls for kubernetes deployment?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for kubernetes deployment
  tags:
  - kubernetes
  - best-practices
- id: kubernetes-deployment-antipatterns
  prompt: What are the most common mistakes to avoid with kubernetes deployment?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
