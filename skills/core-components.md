...
eval_cases:
- id: core-components-approach
  prompt: How should I approach core components for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on core components
  tags:
  - core
- id: core-components-best-practices
  prompt: What are the key best practices and pitfalls for core components?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for core components
  tags:
  - core
  - best-practices
- id: core-components-antipatterns
  prompt: What are the most common mistakes to avoid with core components?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
