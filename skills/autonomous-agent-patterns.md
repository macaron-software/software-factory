...
eval_cases:
- id: autonomous-agent-patterns-approach
  prompt: How should I approach autonomous agent patterns for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on autonomous agent patterns
  tags:
  - autonomous
- id: autonomous-agent-patterns-best-practices
  prompt: What are the key best practices and pitfalls for autonomous agent patterns?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for autonomous agent patterns
  tags:
  - autonomous
  - best-practices
- id: autonomous-agent-patterns-antipatterns
  prompt: What are the most common mistakes to avoid with autonomous agent patterns?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
