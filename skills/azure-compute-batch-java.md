...
metadata:
  ...
  triggers:
  - when working on azure compute batch java
eval_cases:
- id: azure-compute-batch-java-approach
  prompt: How should I approach azure compute batch java for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure compute batch java
  tags:
  - azure
- id: azure-compute-batch-java-best-practices
  prompt: What are the key best practices and pitfalls for azure compute batch java?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure compute batch java
  tags:
  - azure
  - best-practices
- id: azure-compute-batch-java-antipatterns
  prompt: What are the most common mistakes to avoid with azure compute batch java?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
