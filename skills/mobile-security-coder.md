...
eval_cases:
- id: mobile-security-coder-approach
  prompt: How should I approach mobile security coder for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on mobile security coder
  tags:
  - mobile
- id: mobile-security-coder-best-practices
  prompt: What are the key best practices and pitfalls for mobile security coder?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for mobile security coder
  tags:
  - mobile
  - best-practices
- id: mobile-security-coder-antipatterns
  prompt: What are the most common mistakes to avoid with mobile security coder?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
