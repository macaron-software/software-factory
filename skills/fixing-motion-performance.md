...
description: Audit and fix animation performance issues including layout thrashing,
  ...
  stutter, transitions jank, or reviewing CSS...
metadata:
  category: design
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - animations stutter, transitions jank, or reviewing css
eval_cases:
- id: fixing-motion-performance-approach
  prompt: How should I approach fixing motion performance for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on fixing motion performance
  tags:
  - fixing
- id: fixing-motion-performance-best-practices
  prompt: What are the key best practices and pitfalls for fixing motion performance?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for fixing motion performance
  tags:
  - fixing
  - best-practices
- id: fixing-motion-performance-antipatterns
  prompt: What are the most common mistakes to avoid with fixing motion performance?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
