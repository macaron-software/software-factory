...
metadata:
  ...
  triggers:
  - when working on sexual health analyzer
eval_cases:
- id: sexual-health-analyzer-approach
  prompt: How should I approach sexual health analyzer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on sexual health analyzer
  tags:
  - sexual
- id: sexual-health-analyzer-best-practices
  prompt: What are the key best practices and pitfalls for sexual health analyzer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for sexual health analyzer
  tags:
  - sexual
  - best-practices
- id: sexual-health-analyzer-antipatterns
  prompt: What are the most common mistakes to avoid with sexual health analyzer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
