...
eval_cases:
- id: hybrid-cloud-architect-approach
  prompt: How should I approach hybrid cloud architect for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hybrid cloud architect
  tags:
  - hybrid
- id: hybrid-cloud-architect-best-practices
  prompt: What are the key best practices and pitfalls for hybrid cloud architect?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hybrid cloud architect
  tags:
  - hybrid
  - best-practices
- id: hybrid-cloud-architect-antipatterns
  prompt: What are the most common mistakes to avoid with hybrid cloud architect?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
