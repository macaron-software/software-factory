...
eval_cases:
- id: conductor-new-track-approach
  prompt: How should I approach conductor new track for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on conductor new track
  tags:
  - conductor
- id: conductor-new-track-best-practices
  prompt: What are the key best practices and pitfalls for conductor new track?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for conductor new track
  tags:
  - conductor
  - best-practices
- id: conductor-new-track-antipatterns
  prompt: What are the most common mistakes to avoid with conductor new track?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
