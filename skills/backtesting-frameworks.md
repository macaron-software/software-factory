...
metadata:
  ...
  triggers:
  - developing trading algorithms, validating strateg
  - building backtesting infrastructure
eval_cases:
- id: backtesting-frameworks-approach
  prompt: How should I approach backtesting frameworks for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on backtesting frameworks
  tags:
  - backtesting
- id: backtesting-frameworks-best-practices
  prompt: What are the key best practices and pitfalls for backtesting frameworks?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for backtesting frameworks
  tags:
  - backtesting
  - best-practices
- id: backtesting-frameworks-antipatterns
  prompt: What are the most common mistakes to avoid with backtesting frameworks?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
