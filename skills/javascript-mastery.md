...
eval_cases:
- id: javascript-mastery-approach
  prompt: How should I approach javascript mastery for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on javascript mastery
  tags:
  - javascript
- id: javascript-mastery-best-practices
  prompt: What are the key best practices and pitfalls for javascript mastery?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for javascript mastery
  tags:
  - javascript
  - best-practices
- id: javascript-mastery-antipatterns
  prompt: What are the most common mistakes to avoid with javascript mastery?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
