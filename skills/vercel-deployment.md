...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: vibeship-spawner-skills (Apache
    2.0)'
  triggers:
  - vercel, deploy, deployment, hosting, production
  - working with vercel deployment
eval_cases:
- id: vercel-deployment-approach
  prompt: How should I approach vercel deployment for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on vercel deployment
  tags:
  - vercel
- id: vercel-deployment-best-practices
  prompt: What are the key best practices and pitfalls for vercel deployment?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for vercel deployment
  tags:
  - vercel
  - best-practices
- id: vercel-deployment-antipatterns
  prompt: What are the most common mistakes to avoid with vercel deployment?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
