...
description: 'CRITICAL: Use for makepad-skills self-evolution and contribution. Triggers
  ...
  add pattern, new pattern, capture learnin...'
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on evolution
eval_cases:
- id: evolution-approach
  prompt: How should I approach evolution for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on evolution
  tags:
  - evolution
- id: evolution-best-practices
  prompt: What are the key best practices and pitfalls for evolution?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for evolution
  tags:
  - evolution
  - best-practices
- id: evolution-antipatterns
  prompt: What are the most common mistakes to avoid with evolution?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
