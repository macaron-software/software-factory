...
eval_cases:
- id: business-analyst-approach
  prompt: How should I approach business analyst for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on business analyst
  tags:
  - business
- id: business-analyst-best-practices
  prompt: What are the key best practices and pitfalls for business analyst?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for business analyst
  tags:
  - business
  - best-practices
- id: business-analyst-antipatterns
  prompt: What are the most common mistakes to avoid with business analyst?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
