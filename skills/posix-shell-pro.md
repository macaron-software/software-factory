...
eval_cases:
- id: posix-shell-pro-approach
  prompt: How should I approach posix shell pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on posix shell pro
  tags:
  - posix
- id: posix-shell-pro-best-practices
  prompt: What are the key best practices and pitfalls for posix shell pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for posix shell pro
  tags:
  - posix
  - best-practices
- id: posix-shell-pro-antipatterns
  prompt: What are the most common mistakes to avoid with posix shell pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
