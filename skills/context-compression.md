...
description: This skill should be used when the user asks to "compress context", "summarize
  ...
  context compression, structured summa...
metadata:
...
eval_cases:
- id: context-compression-approach
  prompt: How should I approach context compression for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on context compression
  tags:
  - context
- id: context-compression-best-practices
  prompt: What are the key best practices and pitfalls for context compression?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for context compression
  tags:
  - context
  - best-practices
- id: context-compression-antipatterns
  prompt: What are the most common mistakes to avoid with context compression?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
