...
eval_cases:
- id: mobile-developer-approach
  prompt: How should I approach mobile developer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on mobile developer
  tags:
  - mobile
- id: mobile-developer-best-practices
  prompt: What are the key best practices and pitfalls for mobile developer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for mobile developer
  tags:
  - mobile
  - best-practices
- id: mobile-developer-antipatterns
  prompt: What are the most common mistakes to avoid with mobile developer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
