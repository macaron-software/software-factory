...
metadata:
  ...
  triggers:
  - building type-safe database layers with drizzle
...
eval_cases:
- id: drizzle-orm-expert-approach
  prompt: How should I approach drizzle orm expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on drizzle orm expert
  tags:
  - drizzle
- id: drizzle-orm-expert-best-practices
  prompt: What are the key best practices and pitfalls for drizzle orm expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for drizzle orm expert
  tags:
  - drizzle
  - best-practices
- id: drizzle-orm-expert-antipatterns
  prompt: What are the most common mistakes to avoid with drizzle orm expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
