...
metadata:
  ...
  triggers:
  - when working on mental health analyzer
eval_cases:
- id: mental-health-analyzer-approach
  prompt: How should I approach mental health analyzer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on mental health analyzer
  tags:
  - mental
- id: mental-health-analyzer-best-practices
  prompt: What are the key best practices and pitfalls for mental health analyzer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for mental health analyzer
  tags:
  - mental
  - best-practices
- id: mental-health-analyzer-antipatterns
  prompt: What are the most common mistakes to avoid with mental health analyzer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
