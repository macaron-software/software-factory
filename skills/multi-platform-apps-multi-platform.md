...
eval_cases:
- id: multi-platform-apps-multi-platform-approach
  prompt: How should I approach multi platform apps multi platform for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on multi platform apps multi platform
  tags:
  - multi
- id: multi-platform-apps-multi-platform-best-practices
  prompt: What are the key best practices and pitfalls for multi platform apps multi
    platform?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for multi platform apps multi platform
  tags:
  - multi
  - best-practices
- id: multi-platform-apps-multi-platform-antipatterns
  prompt: What are the most common mistakes to avoid with multi platform apps multi
    platform?
  should_trigger: true
  checks:
  - length_min:80
