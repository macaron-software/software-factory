...
eval_cases:
- id: framework-migration-legacy-modernize-approach
  prompt: How should I approach framework migration legacy modernize for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on framework migration legacy modernize
  tags:
  - framework
- id: framework-migration-legacy-modernize-best-practices
  prompt: What are the key best practices and pitfalls for framework migration legacy
    modernize?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for framework migration legacy modernize
  tags:
  - framework
  - best-practices
- id: framework-migration-legacy-modernize-antipatterns
  prompt: What are the most common mistakes to avoid with framework migration legacy
    modernize?
  should_trigger: true
  checks:
  - length_min:80
