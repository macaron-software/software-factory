...
metadata:
  ...
  triggers:
  - migrating databases, changing schemas, performing data tr
eval_cases:
- id: database-migration-approach
  prompt: How should I approach database migration for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on database migration
  tags:
  - database
- id: database-migration-best-practices
  prompt: What are the key best practices and pitfalls for database migration?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for database migration
  tags:
  - database
  - best-practices
- id: database-migration-antipatterns
  prompt: What are the most common mistakes to avoid with database migration?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
