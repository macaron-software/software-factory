...
eval_cases:
- id: typescript-pro-approach
  prompt: How should I approach typescript pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on typescript pro
  tags:
  - typescript
- id: typescript-pro-best-practices
  prompt: What are the key best practices and pitfalls for typescript pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for typescript pro
  tags:
  - typescript
  - best-practices
- id: typescript-pro-antipatterns
  prompt: What are the most common mistakes to avoid with typescript pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
