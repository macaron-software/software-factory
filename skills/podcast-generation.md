...
metadata:
  ...
  triggers:
  - building text-to-speech features, audio narrative generation, podcast creatio
eval_cases:
- id: podcast-generation-approach
  prompt: How should I approach podcast generation for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on podcast generation
  tags:
  - podcast
- id: podcast-generation-best-practices
  prompt: What are the key best practices and pitfalls for podcast generation?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for podcast generation
  tags:
  - podcast
  - best-practices
- id: podcast-generation-antipatterns
  prompt: What are the most common mistakes to avoid with podcast generation?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
