...
eval_cases:
- id: hr-pro-approach
  prompt: How should I approach hr pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hr pro
  tags:
  - hr
- id: hr-pro-best-practices
  prompt: What are the key best practices and pitfalls for hr pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hr pro
  tags:
  - hr
  - best-practices
- id: hr-pro-antipatterns
  prompt: What are the most common mistakes to avoid with hr pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
