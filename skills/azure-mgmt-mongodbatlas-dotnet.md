...
metadata:
  ...
  triggers:
  - creating, updating, listing, or deleting mongodb atlas organizations through azu
eval_cases:
- id: azure-mgmt-mongodbatlas-dotnet-approach
  prompt: How should I approach azure mgmt mongodbatlas dotnet for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure mgmt mongodbatlas dotnet
  tags:
  - azure
- id: azure-mgmt-mongodbatlas-dotnet-best-practices
  prompt: What are the key best practices and pitfalls for azure mgmt mongodbatlas
    dotnet?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure mgmt mongodbatlas dotnet
  tags:
  - azure
  - best-practices
- id: azure-mgmt-mongodbatlas-dotnet-antipatterns
  prompt: What are the most common mistakes to avoid with azure mgmt mongodbatlas
    dotnet?
  should_trigger: true
  checks:
  - length_min:80
