...
eval_cases:
- id: molykit-approach
  prompt: How should I approach molykit for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on molykit
  tags:
  - molykit
- id: molykit-best-practices
  prompt: What are the key best practices and pitfalls for molykit?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for molykit
  tags:
  - molykit
  - best-practices
- id: molykit-antipatterns
  prompt: What are the most common mistakes to avoid with molykit?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
