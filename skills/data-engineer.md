...
eval_cases:
- id: data-engineer-approach
  prompt: How should I approach data engineer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on data engineer
  tags:
  - data
- id: data-engineer-best-practices
  prompt: What are the key best practices and pitfalls for data engineer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for data engineer
  tags:
  - data
  - best-practices
- id: data-engineer-antipatterns
  prompt: What are the most common mistakes to avoid with data engineer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
