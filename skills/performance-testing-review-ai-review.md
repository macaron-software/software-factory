...
eval_cases:
- id: performance-testing-review-ai-review-approach
  prompt: How should I approach performance testing review ai review for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on performance testing review ai review
  tags:
  - performance
- id: performance-testing-review-ai-review-best-practices
  ...
  - no_placeholder
  expectations:
  - Lists concrete best practices for performance testing review ai review
  tags:
  - performance
  - best-practices
- id: performance-testing-review-ai-review-antipatterns
