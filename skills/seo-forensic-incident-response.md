...
metadata:
  ...
  triggers:
  - when working on seo forensic incident response
eval_cases:
- id: seo-forensic-incident-response-approach
  prompt: How should I approach seo forensic incident response for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on seo forensic incident response
  tags:
  - seo
- id: seo-forensic-incident-response-best-practices
  prompt: What are the key best practices and pitfalls for seo forensic incident response?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for seo forensic incident response
  tags:
  - seo
  - best-practices
- id: seo-forensic-incident-response-antipatterns
  prompt: What are the most common mistakes to avoid with seo forensic incident response?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
