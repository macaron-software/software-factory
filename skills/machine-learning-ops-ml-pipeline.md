...
metadata:
  ...
  triggers:
  - working on machine learning pipeline - multi-agent mlops orchestration tasks or
eval_cases:
- id: machine-learning-ops-ml-pipeline-approach
  prompt: How should I approach machine learning ops ml pipeline for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on machine learning ops ml pipeline
  tags:
  - machine
- id: machine-learning-ops-ml-pipeline-best-practices
  prompt: What are the key best practices and pitfalls for machine learning ops ml
    pipeline?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for machine learning ops ml pipeline
  tags:
  - machine
  - best-practices
- id: machine-learning-ops-ml-pipeline-antipatterns
  prompt: What are the most common mistakes to avoid with machine learning ops ml
    pipeline?
  should_trigger: true
  checks:
  - length_min:80
