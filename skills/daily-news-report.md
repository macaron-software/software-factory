...
metadata:
  ...
  triggers:
  - when working on daily news report
eval_cases:
- id: daily-news-report-approach
  prompt: How should I approach daily news report for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on daily news report
  tags:
  - daily
- id: daily-news-report-best-practices
  prompt: What are the key best practices and pitfalls for daily news report?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for daily news report
  tags:
  - daily
  - best-practices
- id: daily-news-report-antipatterns
  prompt: What are the most common mistakes to avoid with daily news report?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
