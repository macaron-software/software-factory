...
metadata:
  ...
  triggers:
  - when working on audit context building
eval_cases:
- id: audit-context-building-approach
  prompt: How should I approach audit context building for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on audit context building
  tags:
  - audit
- id: audit-context-building-best-practices
  prompt: What are the key best practices and pitfalls for audit context building?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for audit context building
  tags:
  - audit
  - best-practices
- id: audit-context-building-antipatterns
  prompt: What are the most common mistakes to avoid with audit context building?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
