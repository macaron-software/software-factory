...
metadata:
  ...
  triggers:
  - setting up nx, configuring project boundaries, optimizing build caching, or impl
eval_cases:
- id: nx-workspace-patterns-approach
  prompt: How should I approach nx workspace patterns for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on nx workspace patterns
  tags:
  - nx
- id: nx-workspace-patterns-best-practices
  prompt: What are the key best practices and pitfalls for nx workspace patterns?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for nx workspace patterns
  tags:
  - nx
  - best-practices
- id: nx-workspace-patterns-antipatterns
  prompt: What are the most common mistakes to avoid with nx workspace patterns?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
