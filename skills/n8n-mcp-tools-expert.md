...
metadata:
  ...
  triggers:
  - searching for nodes, validating configurations, accessing templates, managing
    wo
eval_cases:
- id: n8n-mcp-tools-expert-approach
  prompt: How should I approach n8n mcp tools expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on n8n mcp tools expert
  tags:
  - n8n
- id: n8n-mcp-tools-expert-best-practices
  prompt: What are the key best practices and pitfalls for n8n mcp tools expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for n8n mcp tools expert
  tags:
  - n8n
  - best-practices
- id: n8n-mcp-tools-expert-antipatterns
  prompt: What are the most common mistakes to avoid with n8n mcp tools expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
