...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/tree/main/skills/memory-systems'
  triggers:
  - building agents that must persist across sessions
  - implementing reasoning over accumulated knowledge
eval_cases:
- id: memory-systems-approach
  prompt: How should I approach memory systems for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on memory systems
  tags:
  - memory
- id: memory-systems-best-practices
  prompt: What are the key best practices and pitfalls for memory systems?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for memory systems
  tags:
  - memory
  - best-practices
- id: memory-systems-antipatterns
  prompt: What are the most common mistakes to avoid with memory systems?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
