...
metadata:
  ...
  triggers:
  - setting up linting infrastructure, fixing code issues, or ensuring script portab
eval_cases:
- id: shellcheck-configuration-approach
  prompt: How should I approach shellcheck configuration for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on shellcheck configuration
  tags:
  - shellcheck
- id: shellcheck-configuration-best-practices
  prompt: What are the key best practices and pitfalls for shellcheck configuration?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for shellcheck configuration
  tags:
  - shellcheck
  - best-practices
- id: shellcheck-configuration-antipatterns
  prompt: What are the most common mistakes to avoid with shellcheck configuration?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
