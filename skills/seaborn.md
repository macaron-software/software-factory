...
name: seaborn
version: 1.0.0
description: seaborn skill
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on seaborn
eval_cases:
- id: seaborn-approach
  prompt: How should I approach seaborn for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on seaborn
  tags:
  - seaborn
- id: seaborn-best-practices
  prompt: What are the key best practices and pitfalls for seaborn?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for seaborn
  tags:
  - seaborn
  - best-practices
- id: seaborn-antipatterns
  prompt: What are the most common mistakes to avoid with seaborn?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
