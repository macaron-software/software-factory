...
metadata:
  ...
  triggers:
  - implementing queues, topics/subscriptions, message sessions, dead-letter handlin
eval_cases:
- id: azure-servicebus-ts-approach
  prompt: How should I approach azure servicebus ts for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure servicebus ts
  tags:
  - azure
- id: azure-servicebus-ts-best-practices
  prompt: What are the key best practices and pitfalls for azure servicebus ts?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure servicebus ts
  tags:
  - azure
  - best-practices
- id: azure-servicebus-ts-antipatterns
  prompt: What are the most common mistakes to avoid with azure servicebus ts?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
