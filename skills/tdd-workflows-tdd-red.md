...
eval_cases:
- id: tdd-workflows-tdd-red-approach
  prompt: How should I approach tdd workflows tdd red for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on tdd workflows tdd red
  tags:
  - tdd
- id: tdd-workflows-tdd-red-best-practices
  prompt: What are the key best practices and pitfalls for tdd workflows tdd red?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for tdd workflows tdd red
  tags:
  - tdd
  - best-practices
- id: tdd-workflows-tdd-red-antipatterns
  prompt: What are the most common mistakes to avoid with tdd workflows tdd red?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
