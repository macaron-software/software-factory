...
eval_cases:
- id: market-sizing-analysis-approach
  prompt: How should I approach market sizing analysis for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on market sizing analysis
  tags:
  - market
- id: market-sizing-analysis-best-practices
  prompt: What are the key best practices and pitfalls for market sizing analysis?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for market sizing analysis
  tags:
  - market
  - best-practices
- id: market-sizing-analysis-antipatterns
  prompt: What are the most common mistakes to avoid with market sizing analysis?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
