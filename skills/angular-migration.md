...
metadata:
  ...
  triggers:
  - upgrading angularjs applications, planning framework migrations, or
eval_cases:
- id: angular-migration-approach
  prompt: How should I approach angular migration for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on angular migration
  tags:
  - angular
- id: angular-migration-best-practices
  prompt: What are the key best practices and pitfalls for angular migration?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for angular migration
  tags:
  - angular
  - best-practices
- id: angular-migration-antipatterns
  prompt: What are the most common mistakes to avoid with angular migration?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
