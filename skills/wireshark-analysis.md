...
metadata:
  ...
  triggers:
  - when working on wireshark analysis
eval_cases:
- id: wireshark-analysis-approach
  prompt: How should I approach wireshark analysis for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on wireshark analysis
  tags:
  - wireshark
- id: wireshark-analysis-best-practices
  prompt: What are the key best practices and pitfalls for wireshark analysis?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for wireshark analysis
  tags:
  - wireshark
  - best-practices
- id: wireshark-analysis-antipatterns
  prompt: What are the most common mistakes to avoid with wireshark analysis?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
