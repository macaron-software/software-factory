...
eval_cases:
- id: stitch-loop-approach
  prompt: How should I approach stitch loop for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on stitch loop
  tags:
  - stitch
- id: stitch-loop-best-practices
  prompt: What are the key best practices and pitfalls for stitch loop?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for stitch loop
  tags:
  - stitch
  - best-practices
- id: stitch-loop-antipatterns
  prompt: What are the most common mistakes to avoid with stitch loop?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
