...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: https://github.com/go-rod/rod'
  triggers:
  - when working on go rod master
eval_cases:
- id: go-rod-master-approach
  prompt: How should I approach go rod master for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on go rod master
  tags:
  - go
- id: go-rod-master-best-practices
  prompt: What are the key best practices and pitfalls for go rod master?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for go rod master
  tags:
  - go
  - best-practices
- id: go-rod-master-antipatterns
  prompt: What are the most common mistakes to avoid with go rod master?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
