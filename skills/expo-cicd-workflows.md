...
description: Helps understand and write EAS workflow YAML files for Expo projects.
  ...
  mentions .eas/workflows/, or wants help w...
metadata:
  category: ops
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on expo cicd workflows
eval_cases:
- id: expo-cicd-workflows-approach
  prompt: How should I approach expo cicd workflows for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on expo cicd workflows
  tags:
  - expo
- id: expo-cicd-workflows-best-practices
  prompt: What are the key best practices and pitfalls for expo cicd workflows?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for expo cicd workflows
  tags:
  - expo
  - best-practices
- id: expo-cicd-workflows-antipatterns
  prompt: What are the most common mistakes to avoid with expo cicd workflows?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
