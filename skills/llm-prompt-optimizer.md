...
eval_cases:
- id: llm-prompt-optimizer-approach
  prompt: How should I approach llm prompt optimizer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on llm prompt optimizer
  tags:
  - llm
- id: llm-prompt-optimizer-best-practices
  prompt: What are the key best practices and pitfalls for llm prompt optimizer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for llm prompt optimizer
  tags:
  - llm
  - best-practices
- id: llm-prompt-optimizer-antipatterns
  prompt: What are the most common mistakes to avoid with llm prompt optimizer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
