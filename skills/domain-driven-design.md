...
eval_cases:
- id: domain-driven-design-approach
  prompt: How should I approach domain driven design for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on domain driven design
  tags:
  - domain
- id: domain-driven-design-best-practices
  prompt: What are the key best practices and pitfalls for domain driven design?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for domain driven design
  tags:
  - domain
  - best-practices
- id: domain-driven-design-antipatterns
  prompt: What are the most common mistakes to avoid with domain driven design?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
