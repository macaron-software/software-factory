...
metadata:
  ...
  triggers:
  - when working on wordpress penetration testing
eval_cases:
- id: wordpress-penetration-testing-approach
  prompt: How should I approach wordpress penetration testing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on wordpress penetration testing
  tags:
  - wordpress
- id: wordpress-penetration-testing-best-practices
  prompt: What are the key best practices and pitfalls for wordpress penetration testing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for wordpress penetration testing
  tags:
  - wordpress
  - best-practices
- id: wordpress-penetration-testing-antipatterns
  prompt: What are the most common mistakes to avoid with wordpress penetration testing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
