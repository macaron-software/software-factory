...
metadata:
  category: ops
  source: 'antigravity-awesome-skills (MIT) — source: https://github.com/antonbabenko/terraform-skill'
  triggers:
  - creating new terraform or opentofu configurations or modules
  - setting up testing infrastructure for iac code
eval_cases:
- id: terraform-skill-approach
  prompt: How should I approach terraform skill for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on terraform skill
  tags:
  - terraform
- id: terraform-skill-best-practices
  prompt: What are the key best practices and pitfalls for terraform skill?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for terraform skill
  tags:
  - terraform
  - best-practices
- id: terraform-skill-antipatterns
  prompt: What are the most common mistakes to avoid with terraform skill?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
