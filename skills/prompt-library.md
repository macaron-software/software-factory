...
metadata:
  ...
  triggers:
  - user needs prompt templates, role-
eval_cases:
- id: prompt-library-approach
  prompt: How should I approach prompt library for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on prompt library
  tags:
  - prompt
- id: prompt-library-best-practices
  prompt: What are the key best practices and pitfalls for prompt library?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for prompt library
  tags:
  - prompt
  - best-practices
- id: prompt-library-antipatterns
  prompt: What are the most common mistakes to avoid with prompt library?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
