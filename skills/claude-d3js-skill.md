...
metadata:
  ...
  triggers:
  - when working on claude d3js skill
eval_cases:
- id: claude-d3js-skill-approach
  prompt: How should I approach claude d3js skill for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on claude d3js skill
  tags:
  - claude
- id: claude-d3js-skill-best-practices
  prompt: What are the key best practices and pitfalls for claude d3js skill?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for claude d3js skill
  tags:
  - claude
  - best-practices
- id: claude-d3js-skill-antipatterns
  prompt: What are the most common mistakes to avoid with claude d3js skill?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
