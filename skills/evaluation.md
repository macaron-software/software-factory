...
metadata:
  category: ai
  source: 'antigravity-awesome-skills (MIT) — source: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/tree/main/skills/evaluation'
  triggers:
  - when working on evaluation
eval_cases:
- id: evaluation-approach
  prompt: How should I approach evaluation for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on evaluation
  tags:
  - evaluation
- id: evaluation-best-practices
  prompt: What are the key best practices and pitfalls for evaluation?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for evaluation
  tags:
  - evaluation
  - best-practices
- id: evaluation-antipatterns
  prompt: What are the most common mistakes to avoid with evaluation?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
