...
metadata:
  ...
  triggers:
  - asked to create, write, or update skills
eval_cases:
- id: skill-writer-approach
  prompt: How should I approach skill writer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on skill writer
  tags:
  - skill
- id: skill-writer-best-practices
  prompt: What are the key best practices and pitfalls for skill writer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for skill writer
  tags:
  - skill
  - best-practices
- id: skill-writer-antipatterns
  prompt: What are the most common mistakes to avoid with skill writer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
