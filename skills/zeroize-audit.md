...
eval_cases:
- id: zeroize-audit-approach
  prompt: How should I approach zeroize audit for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on zeroize audit
  tags:
  - zeroize
- id: zeroize-audit-best-practices
  prompt: What are the key best practices and pitfalls for zeroize audit?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for zeroize audit
  tags:
  - zeroize
  - best-practices
- id: zeroize-audit-antipatterns
  prompt: What are the most common mistakes to avoid with zeroize audit?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
