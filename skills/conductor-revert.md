...
eval_cases:
- id: conductor-revert-approach
  prompt: How should I approach conductor revert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on conductor revert
  tags:
  - conductor
- id: conductor-revert-best-practices
  prompt: What are the key best practices and pitfalls for conductor revert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for conductor revert
  tags:
  - conductor
  - best-practices
- id: conductor-revert-antipatterns
  prompt: What are the most common mistakes to avoid with conductor revert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
