...
metadata:
  ...
  triggers:
  - when working on conductor setup
eval_cases:
- id: conductor-setup-approach
  prompt: How should I approach conductor setup for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on conductor setup
  tags:
  - conductor
- id: conductor-setup-best-practices
  prompt: What are the key best practices and pitfalls for conductor setup?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for conductor setup
  tags:
  - conductor
  - best-practices
- id: conductor-setup-antipatterns
  prompt: What are the most common mistakes to avoid with conductor setup?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
