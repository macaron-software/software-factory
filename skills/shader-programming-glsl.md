...
eval_cases:
- id: shader-programming-glsl-approach
  prompt: How should I approach shader programming glsl for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on shader programming glsl
  tags:
  - shader
- id: shader-programming-glsl-best-practices
  prompt: What are the key best practices and pitfalls for shader programming glsl?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for shader programming glsl
  tags:
  - shader
  - best-practices
- id: shader-programming-glsl-antipatterns
  prompt: What are the most common mistakes to avoid with shader programming glsl?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
