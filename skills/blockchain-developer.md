...
eval_cases:
- id: blockchain-developer-approach
  prompt: How should I approach blockchain developer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on blockchain developer
  tags:
  - blockchain
- id: blockchain-developer-best-practices
  prompt: What are the key best practices and pitfalls for blockchain developer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for blockchain developer
  tags:
  - blockchain
  - best-practices
- id: blockchain-developer-antipatterns
  prompt: What are the most common mistakes to avoid with blockchain developer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
