...
metadata:
  ...
  triggers:
  - building ui components, handling async data, or managing component states
eval_cases:
- id: angular-ui-patterns-approach
  prompt: How should I approach angular ui patterns for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on angular ui patterns
  tags:
  - angular
- id: angular-ui-patterns-best-practices
  prompt: What are the key best practices and pitfalls for angular ui patterns?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for angular ui patterns
  tags:
  - angular
  - best-practices
- id: angular-ui-patterns-antipatterns
  prompt: What are the most common mistakes to avoid with angular ui patterns?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
