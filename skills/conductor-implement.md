...
eval_cases:
- id: conductor-implement-approach
  prompt: How should I approach conductor implement for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on conductor implement
  tags:
  - conductor
- id: conductor-implement-best-practices
  prompt: What are the key best practices and pitfalls for conductor implement?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for conductor implement
  tags:
  - conductor
  - best-practices
- id: conductor-implement-antipatterns
  prompt: What are the most common mistakes to avoid with conductor implement?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
