...
metadata:
  ...
  triggers:
  - when working on m365 agents py
eval_cases:
- id: m365-agents-py-approach
  prompt: How should I approach m365 agents py for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on m365 agents py
  tags:
  - m365
- id: m365-agents-py-best-practices
  prompt: What are the key best practices and pitfalls for m365 agents py?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for m365 agents py
  tags:
  - m365
  - best-practices
- id: m365-agents-py-antipatterns
  prompt: What are the most common mistakes to avoid with m365 agents py?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
