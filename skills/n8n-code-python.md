...
metadata:
  ...
  triggers:
  - writing python in n8n, using _input/_json/_node syntax, working with standard
    li
eval_cases:
- id: n8n-code-python-approach
  prompt: How should I approach n8n code python for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on n8n code python
  tags:
  - n8n
- id: n8n-code-python-best-practices
  prompt: What are the key best practices and pitfalls for n8n code python?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for n8n code python
  tags:
  - n8n
  - best-practices
- id: n8n-code-python-antipatterns
  prompt: What are the most common mistakes to avoid with n8n code python?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
