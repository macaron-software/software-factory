...
eval_cases:
- id: ml-engineer-approach
  prompt: How should I approach ml engineer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on ml engineer
  tags:
  - ml
- id: ml-engineer-best-practices
  prompt: What are the key best practices and pitfalls for ml engineer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for ml engineer
  tags:
  - ml
  - best-practices
- id: ml-engineer-antipatterns
  prompt: What are the most common mistakes to avoid with ml engineer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
