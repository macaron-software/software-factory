...
metadata:
  ...
  triggers:
  - when working on varlock
eval_cases:
- id: varlock-approach
  prompt: How should I approach varlock for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on varlock
  tags:
  - varlock
- id: varlock-best-practices
  prompt: What are the key best practices and pitfalls for varlock?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for varlock
  tags:
  - varlock
  - best-practices
- id: varlock-antipatterns
  prompt: What are the most common mistakes to avoid with varlock?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
