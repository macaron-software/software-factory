...
metadata:
  ...
  triggers:
  - integrating stripe payments, building subscription systems, or
eval_cases:
- id: stripe-integration-approach
  prompt: How should I approach stripe integration for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on stripe integration
  tags:
  - stripe
- id: stripe-integration-best-practices
  prompt: What are the key best practices and pitfalls for stripe integration?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for stripe integration
  tags:
  - stripe
  - best-practices
- id: stripe-integration-antipatterns
  prompt: What are the most common mistakes to avoid with stripe integration?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
