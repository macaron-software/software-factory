...
description: >
  ...
  Used by compliance critic agents on Solaris /  frontend projects.
metadata:
  category: compliance
  domain: solaris
  triggers:
...
Solaris is the **official  Design System**. Custom components replacing Solaris components
...
### 4. Angular Best Practices ( context)
