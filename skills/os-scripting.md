...
eval_cases:
- id: os-scripting-approach
  prompt: How should I approach os scripting for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on os scripting
  tags:
  - os
- id: os-scripting-best-practices
  prompt: What are the key best practices and pitfalls for os scripting?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for os scripting
  tags:
  - os
  - best-practices
- id: os-scripting-antipatterns
  prompt: What are the most common mistakes to avoid with os scripting?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
