...
eval_cases:
- id: error-debugging-error-analysis-approach
  prompt: How should I approach error debugging error analysis for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on error debugging error analysis
  tags:
  - error
- id: error-debugging-error-analysis-best-practices
  prompt: What are the key best practices and pitfalls for error debugging error analysis?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for error debugging error analysis
  tags:
  - error
  - best-practices
- id: error-debugging-error-analysis-antipatterns
  prompt: What are the most common mistakes to avoid with error debugging error analysis?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
