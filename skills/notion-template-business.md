...
eval_cases:
- id: notion-template-business-approach
  prompt: How should I approach notion template business for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on notion template business
  tags:
  - notion
- id: notion-template-business-best-practices
  prompt: What are the key best practices and pitfalls for notion template business?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for notion template business
  tags:
  - notion
  - best-practices
- id: notion-template-business-antipatterns
  prompt: What are the most common mistakes to avoid with notion template business?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
