...
metadata:
  ...
  triggers:
  - when working on inventory demand planning
eval_cases:
- id: inventory-demand-planning-approach
  prompt: How should I approach inventory demand planning for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on inventory demand planning
  tags:
  - inventory
- id: inventory-demand-planning-best-practices
  prompt: What are the key best practices and pitfalls for inventory demand planning?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for inventory demand planning
  tags:
  - inventory
  - best-practices
- id: inventory-demand-planning-antipatterns
  prompt: What are the most common mistakes to avoid with inventory demand planning?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
