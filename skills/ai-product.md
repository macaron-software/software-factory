...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: vibeship-spawner-skills (Apache
    2.0)'
  triggers:
  - when working on ai product
eval_cases:
- id: ai-product-approach
  prompt: How should I approach ai product for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on ai product
  tags:
  - ai
- id: ai-product-best-practices
  prompt: What are the key best practices and pitfalls for ai product?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for ai product
  tags:
  - ai
  - best-practices
- id: ai-product-antipatterns
  prompt: What are the most common mistakes to avoid with ai product?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
