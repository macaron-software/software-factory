...
metadata:
  ...
  triggers:
  - the user mentions 'linkedin
  - are you building personal brand, company brand, or both?
eval_cases:
- id: social-content-approach
  prompt: How should I approach social content for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on social content
  tags:
  - social
- id: social-content-best-practices
  prompt: What are the key best practices and pitfalls for social content?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for social content
  tags:
  - social
  - best-practices
- id: social-content-antipatterns
  prompt: What are the most common mistakes to avoid with social content?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
