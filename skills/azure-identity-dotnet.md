...
metadata:
  ...
  triggers:
  - when working on azure identity dotnet
eval_cases:
- id: azure-identity-dotnet-approach
  prompt: How should I approach azure identity dotnet for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure identity dotnet
  tags:
  - azure
- id: azure-identity-dotnet-best-practices
  prompt: What are the key best practices and pitfalls for azure identity dotnet?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure identity dotnet
  tags:
  - azure
  - best-practices
- id: azure-identity-dotnet-antipatterns
  prompt: What are the most common mistakes to avoid with azure identity dotnet?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
