...
metadata:
  ...
  triggers:
  - when working on azure keyvault py
eval_cases:
- id: azure-keyvault-py-approach
  prompt: How should I approach azure keyvault py for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure keyvault py
  tags:
  - azure
- id: azure-keyvault-py-best-practices
  prompt: What are the key best practices and pitfalls for azure keyvault py?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure keyvault py
  tags:
  - azure
  - best-practices
- id: azure-keyvault-py-antipatterns
  prompt: What are the most common mistakes to avoid with azure keyvault py?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
