...
eval_cases:
- id: codebase-audit-pre-push-approach
  prompt: How should I approach codebase audit pre push for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on codebase audit pre push
  tags:
  - codebase
- id: codebase-audit-pre-push-best-practices
  prompt: What are the key best practices and pitfalls for codebase audit pre push?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for codebase audit pre push
  tags:
  - codebase
  - best-practices
- id: codebase-audit-pre-push-antipatterns
  prompt: What are the most common mistakes to avoid with codebase audit pre push?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
