...
metadata:
  ...
  triggers:
  - when working on azure identity rust
eval_cases:
- id: azure-identity-rust-approach
  prompt: How should I approach azure identity rust for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure identity rust
  tags:
  - azure
- id: azure-identity-rust-best-practices
  prompt: What are the key best practices and pitfalls for azure identity rust?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure identity rust
  tags:
  - azure
  - best-practices
- id: azure-identity-rust-antipatterns
  prompt: What are the most common mistakes to avoid with azure identity rust?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
