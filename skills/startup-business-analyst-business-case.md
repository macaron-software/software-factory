...
eval_cases:
- id: startup-business-analyst-business-case-approach
  prompt: How should I approach startup business analyst business case for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on startup business analyst business case
  tags:
  - startup
- id: startup-business-analyst-business-case-best-practices
  ...
  - no_placeholder
  expectations:
  - Lists concrete best practices for startup business analyst business case
  tags:
  - startup
  - best-practices
- id: startup-business-analyst-business-case-antipatterns
