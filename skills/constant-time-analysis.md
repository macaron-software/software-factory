...
description: Detects timing side-channel vulnerabilities in cryptographic code. Use
  ...
  branches, or constant-time prog...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - implementing or reviewing crypto code, encountering division on secrets, secret-
  - user implements signature, encryption, or key derivation
eval_cases:
- id: constant-time-analysis-approach
  prompt: How should I approach constant time analysis for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on constant time analysis
  tags:
  - constant
- id: constant-time-analysis-best-practices
  prompt: What are the key best practices and pitfalls for constant time analysis?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for constant time analysis
  tags:
  - constant
  - best-practices
- id: constant-time-analysis-antipatterns
  prompt: What are the most common mistakes to avoid with constant time analysis?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
