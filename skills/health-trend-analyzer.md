...
metadata:
  ...
  triggers:
  - when working on health trend analyzer
eval_cases:
- id: health-trend-analyzer-approach
  prompt: How should I approach health trend analyzer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on health trend analyzer
  tags:
  - health
- id: health-trend-analyzer-best-practices
  prompt: What are the key best practices and pitfalls for health trend analyzer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for health trend analyzer
  tags:
  - health
  - best-practices
- id: health-trend-analyzer-antipatterns
  prompt: What are the most common mistakes to avoid with health trend analyzer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
