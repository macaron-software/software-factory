...
eval_cases:
- id: ios-developer-approach
  prompt: How should I approach ios developer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on ios developer
  tags:
  - ios
- id: ios-developer-best-practices
  prompt: What are the key best practices and pitfalls for ios developer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for ios developer
  tags:
  - ios
  - best-practices
- id: ios-developer-antipatterns
  prompt: What are the most common mistakes to avoid with ios developer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
