...
metadata:
  ...
  triggers:
  - when working on carrier relationship management
eval_cases:
- id: carrier-relationship-management-approach
  prompt: How should I approach carrier relationship management for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on carrier relationship management
  tags:
  - carrier
- id: carrier-relationship-management-best-practices
  prompt: What are the key best practices and pitfalls for carrier relationship management?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for carrier relationship management
  tags:
  - carrier
  - best-practices
- id: carrier-relationship-management-antipatterns
  prompt: What are the most common mistakes to avoid with carrier relationship management?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
