...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: vibeship-spawner-skills (Apache
    2.0)'
  triggers:
  - when working on micro saas launcher
eval_cases:
- id: micro-saas-launcher-approach
  prompt: How should I approach micro saas launcher for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on micro saas launcher
  tags:
  - micro
- id: micro-saas-launcher-best-practices
  prompt: What are the key best practices and pitfalls for micro saas launcher?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for micro saas launcher
  tags:
  - micro
  - best-practices
- id: micro-saas-launcher-antipatterns
  prompt: What are the most common mistakes to avoid with micro saas launcher?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
