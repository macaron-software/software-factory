...
metadata:
  ...
  triggers:
  - when working on prompt engineer
eval_cases:
- id: prompt-engineer-approach
  prompt: How should I approach prompt engineer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on prompt engineer
  tags:
  - prompt
- id: prompt-engineer-best-practices
  prompt: What are the key best practices and pitfalls for prompt engineer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for prompt engineer
  tags:
  - prompt
  - best-practices
- id: prompt-engineer-antipatterns
  prompt: What are the most common mistakes to avoid with prompt engineer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
