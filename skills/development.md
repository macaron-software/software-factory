...
- id: development-approach
  prompt: How should I approach development for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on development
  tags:
  - development
- id: development-best-practices
  prompt: What are the key best practices and pitfalls for development?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for development
  tags:
  - development
  - best-practices
- id: development-antipatterns
  prompt: What are the most common mistakes to avoid with development?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
