...
metadata:
  ...
  triggers:
  - when working on hig inputs
eval_cases:
- id: hig-inputs-approach
  prompt: How should I approach hig inputs for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hig inputs
  tags:
  - hig
- id: hig-inputs-best-practices
  prompt: What are the key best practices and pitfalls for hig inputs?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hig inputs
  tags:
  - hig
  - best-practices
- id: hig-inputs-antipatterns
  prompt: What are the most common mistakes to avoid with hig inputs?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
