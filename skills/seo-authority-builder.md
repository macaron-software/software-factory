...
eval_cases:
- id: seo-authority-builder-approach
  prompt: How should I approach seo authority builder for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on seo authority builder
  tags:
  - seo
- id: seo-authority-builder-best-practices
  prompt: What are the key best practices and pitfalls for seo authority builder?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for seo authority builder
  tags:
  - seo
  - best-practices
- id: seo-authority-builder-antipatterns
  prompt: What are the most common mistakes to avoid with seo authority builder?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
