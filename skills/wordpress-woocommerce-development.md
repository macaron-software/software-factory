...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: personal'
  triggers:
  - setting up woocommerce stores
eval_cases:
- id: wordpress-woocommerce-development-approach
  prompt: How should I approach wordpress woocommerce development for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on wordpress woocommerce development
  tags:
  - wordpress
- id: wordpress-woocommerce-development-best-practices
  prompt: What are the key best practices and pitfalls for wordpress woocommerce development?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for wordpress woocommerce development
  tags:
  - wordpress
  - best-practices
- id: wordpress-woocommerce-development-antipatterns
  prompt: What are the most common mistakes to avoid with wordpress woocommerce development?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
