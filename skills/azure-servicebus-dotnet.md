...
metadata:
  ...
  triggers:
  - when working on azure servicebus dotnet
eval_cases:
- id: azure-servicebus-dotnet-approach
  prompt: How should I approach azure servicebus dotnet for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure servicebus dotnet
  tags:
  - azure
- id: azure-servicebus-dotnet-best-practices
  prompt: What are the key best practices and pitfalls for azure servicebus dotnet?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure servicebus dotnet
  tags:
  - azure
  - best-practices
- id: azure-servicebus-dotnet-antipatterns
  prompt: What are the most common mistakes to avoid with azure servicebus dotnet?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
