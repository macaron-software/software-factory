...
metadata:
  ...
  triggers:
  - when working on sql injection testing
eval_cases:
- id: sql-injection-testing-approach
  prompt: How should I approach sql injection testing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on sql injection testing
  tags:
  - sql
- id: sql-injection-testing-best-practices
  prompt: What are the key best practices and pitfalls for sql injection testing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for sql injection testing
  tags:
  - sql
  - best-practices
- id: sql-injection-testing-antipatterns
  prompt: What are the most common mistakes to avoid with sql injection testing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
