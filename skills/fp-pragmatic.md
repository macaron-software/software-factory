...
metadata:
  ...
  triggers:
  - when working on fp pragmatic
eval_cases:
- id: fp-pragmatic-approach
  prompt: How should I approach fp pragmatic for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on fp pragmatic
  tags:
  - fp
- id: fp-pragmatic-best-practices
  prompt: What are the key best practices and pitfalls for fp pragmatic?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for fp pragmatic
  tags:
  - fp
  - best-practices
- id: fp-pragmatic-antipatterns
  prompt: What are the most common mistakes to avoid with fp pragmatic?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
