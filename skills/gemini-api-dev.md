...
metadata:
  ...
  triggers:
  - when working on gemini api dev
eval_cases:
- id: gemini-api-dev-approach
  prompt: How should I approach gemini api dev for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on gemini api dev
  tags:
  - gemini
- id: gemini-api-dev-best-practices
  prompt: What are the key best practices and pitfalls for gemini api dev?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for gemini api dev
  tags:
  - gemini
  - best-practices
- id: gemini-api-dev-antipatterns
  prompt: What are the most common mistakes to avoid with gemini api dev?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
