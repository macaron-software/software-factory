...
metadata:
  ...
  triggers:
  - when working on azure servicebus py
eval_cases:
- id: azure-servicebus-py-approach
  prompt: How should I approach azure servicebus py for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure servicebus py
  tags:
  - azure
- id: azure-servicebus-py-best-practices
  prompt: What are the key best practices and pitfalls for azure servicebus py?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure servicebus py
  tags:
  - azure
  - best-practices
- id: azure-servicebus-py-antipatterns
  prompt: What are the most common mistakes to avoid with azure servicebus py?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
