...
metadata:
  ...
  triggers:
  - adding devcontainer support to a project, setting up isolated development e
eval_cases:
- id: devcontainer-setup-approach
  prompt: How should I approach devcontainer setup for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on devcontainer setup
  tags:
  - devcontainer
- id: devcontainer-setup-best-practices
  prompt: What are the key best practices and pitfalls for devcontainer setup?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for devcontainer setup
  tags:
  - devcontainer
  - best-practices
- id: devcontainer-setup-antipatterns
  prompt: What are the most common mistakes to avoid with devcontainer setup?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
