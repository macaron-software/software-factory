...
metadata:
  ...
  triggers:
  - implementing zero-trust networking, certificate management, or securing internal
eval_cases:
- id: mtls-configuration-approach
  prompt: How should I approach mtls configuration for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on mtls configuration
  tags:
  - mtls
- id: mtls-configuration-best-practices
  prompt: What are the key best practices and pitfalls for mtls configuration?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for mtls configuration
  tags:
  - mtls
  - best-practices
- id: mtls-configuration-antipatterns
  prompt: What are the most common mistakes to avoid with mtls configuration?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
