...
metadata:
  ...
  triggers:
  - 'writing, reviewing, or refactoring angular code for optimal performance, bundle '
  - writing new angular components or pages
  - implementing data fetching patterns
  - reviewing code for performance issues
eval_cases:
- id: angular-best-practices-approach
  prompt: How should I approach angular best practices for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on angular best practices
  tags:
  - angular
- id: angular-best-practices-best-practices
  prompt: What are the key best practices and pitfalls for angular best practices?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for angular best practices
  tags:
  - angular
  - best-practices
- id: angular-best-practices-antipatterns
  prompt: What are the most common mistakes to avoid with angular best practices?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
