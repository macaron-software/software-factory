...
metadata:
  ...
  triggers:
  - when working on energy procurement
eval_cases:
- id: energy-procurement-approach
  prompt: How should I approach energy procurement for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on energy procurement
  tags:
  - energy
- id: energy-procurement-best-practices
  prompt: What are the key best practices and pitfalls for energy procurement?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for energy procurement
  tags:
  - energy
  - best-practices
- id: energy-procurement-antipatterns
  prompt: What are the most common mistakes to avoid with energy procurement?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
