...
metadata:
  ...
  triggers:
  - creating dashboards, admin panels, or data-rich interfaces
eval_cases:
- id: frontend-ui-dark-ts-approach
  prompt: How should I approach frontend ui dark ts for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on frontend ui dark ts
  tags:
  - frontend
- id: frontend-ui-dark-ts-best-practices
  prompt: What are the key best practices and pitfalls for frontend ui dark ts?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for frontend ui dark ts
  tags:
  - frontend
  - best-practices
- id: frontend-ui-dark-ts-antipatterns
  prompt: What are the most common mistakes to avoid with frontend ui dark ts?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
