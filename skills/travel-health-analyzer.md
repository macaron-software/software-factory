...
metadata:
  ...
  triggers:
  - when working on travel health analyzer
eval_cases:
- id: travel-health-analyzer-approach
  prompt: How should I approach travel health analyzer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on travel health analyzer
  tags:
  - travel
- id: travel-health-analyzer-best-practices
  prompt: What are the key best practices and pitfalls for travel health analyzer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for travel health analyzer
  tags:
  - travel
  - best-practices
- id: travel-health-analyzer-antipatterns
  prompt: What are the most common mistakes to avoid with travel health analyzer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
