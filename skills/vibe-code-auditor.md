...
metadata:
  ...
  triggers:
  - when working on vibe code auditor
eval_cases:
- id: vibe-code-auditor-approach
  prompt: How should I approach vibe code auditor for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on vibe code auditor
  tags:
  - vibe
- id: vibe-code-auditor-best-practices
  prompt: What are the key best practices and pitfalls for vibe code auditor?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for vibe code auditor
  tags:
  - vibe
  - best-practices
- id: vibe-code-auditor-antipatterns
  prompt: What are the most common mistakes to avoid with vibe code auditor?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
