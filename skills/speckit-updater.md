...
metadata:
  ...
  triggers:
  - when working on speckit updater
eval_cases:
- id: speckit-updater-approach
  prompt: How should I approach speckit updater for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on speckit updater
  tags:
  - speckit
- id: speckit-updater-best-practices
  prompt: What are the key best practices and pitfalls for speckit updater?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for speckit updater
  tags:
  - speckit
  - best-practices
- id: speckit-updater-antipatterns
  prompt: What are the most common mistakes to avoid with speckit updater?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
