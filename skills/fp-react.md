...
metadata:
  ...
  triggers:
  - when working on fp react
eval_cases:
- id: fp-react-approach
  prompt: How should I approach fp react for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on fp react
  tags:
  - fp
- id: fp-react-best-practices
  prompt: What are the key best practices and pitfalls for fp react?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for fp react
  tags:
  - fp
  - best-practices
- id: fp-react-antipatterns
  prompt: What are the most common mistakes to avoid with fp react?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
