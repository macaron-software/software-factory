...
eval_cases:
- id: graphql-architect-approach
  prompt: How should I approach graphql architect for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on graphql architect
  tags:
  - graphql
- id: graphql-architect-best-practices
  prompt: What are the key best practices and pitfalls for graphql architect?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for graphql architect
  tags:
  - graphql
  - best-practices
- id: graphql-architect-antipatterns
  prompt: What are the most common mistakes to avoid with graphql architect?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
