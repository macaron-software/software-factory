...
description: Write JavaScript code in n8n Code nodes. Use when writing JavaScript
  ...
  with dates using DateTime, troubleshooting ...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - writing javascript in n8n, using $input/$json/$node syntax, making http requests
eval_cases:
- id: n8n-code-javascript-approach
  prompt: How should I approach n8n code javascript for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on n8n code javascript
  tags:
  - n8n
- id: n8n-code-javascript-best-practices
  prompt: What are the key best practices and pitfalls for n8n code javascript?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for n8n code javascript
  tags:
  - n8n
  - best-practices
- id: n8n-code-javascript-antipatterns
  prompt: What are the most common mistakes to avoid with n8n code javascript?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
