...
metadata:
  ...
  triggers:
  - when working on mobile design
eval_cases:
- id: mobile-design-approach
  prompt: How should I approach mobile design for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on mobile design
  tags:
  - mobile
- id: mobile-design-best-practices
  prompt: What are the key best practices and pitfalls for mobile design?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for mobile design
  tags:
  - mobile
  - best-practices
- id: mobile-design-antipatterns
  prompt: What are the most common mistakes to avoid with mobile design?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
