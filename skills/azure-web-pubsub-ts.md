...
eval_cases:
- id: azure-web-pubsub-ts-approach
  prompt: How should I approach azure web pubsub ts for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure web pubsub ts
  tags:
  - azure
- id: azure-web-pubsub-ts-best-practices
  prompt: What are the key best practices and pitfalls for azure web pubsub ts?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure web pubsub ts
  tags:
  - azure
  - best-practices
- id: azure-web-pubsub-ts-antipatterns
  prompt: What are the most common mistakes to avoid with azure web pubsub ts?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
