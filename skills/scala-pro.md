...
eval_cases:
- id: scala-pro-approach
  prompt: How should I approach scala pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on scala pro
  tags:
  - scala
- id: scala-pro-best-practices
  prompt: What are the key best practices and pitfalls for scala pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for scala pro
  tags:
  - scala
  - best-practices
- id: scala-pro-antipatterns
  prompt: What are the most common mistakes to avoid with scala pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
