...
eval_cases:
- id: free-tool-strategy-approach
  prompt: How should I approach free tool strategy for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on free tool strategy
  tags:
  - free
- id: free-tool-strategy-best-practices
  prompt: What are the key best practices and pitfalls for free tool strategy?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for free tool strategy
  tags:
  - free
  - best-practices
- id: free-tool-strategy-antipatterns
  prompt: What are the most common mistakes to avoid with free tool strategy?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
