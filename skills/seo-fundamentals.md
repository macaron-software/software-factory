...
metadata:
  ...
  triggers:
  - when working on seo fundamentals
eval_cases:
- id: seo-fundamentals-approach
  prompt: How should I approach seo fundamentals for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on seo fundamentals
  tags:
  - seo
- id: seo-fundamentals-best-practices
  prompt: What are the key best practices and pitfalls for seo fundamentals?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for seo fundamentals
  tags:
  - seo
  - best-practices
- id: seo-fundamentals-antipatterns
  prompt: What are the most common mistakes to avoid with seo fundamentals?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
