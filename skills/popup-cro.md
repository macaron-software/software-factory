...
metadata:
  ...
  triggers:
  - when working on popup cro
eval_cases:
- id: popup-cro-approach
  prompt: How should I approach popup cro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on popup cro
  tags:
  - popup
- id: popup-cro-best-practices
  prompt: What are the key best practices and pitfalls for popup cro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for popup cro
  tags:
  - popup
  - best-practices
- id: popup-cro-antipatterns
  prompt: What are the most common mistakes to avoid with popup cro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
