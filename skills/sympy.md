...
name: sympy
version: 1.0.0
description: sympy skill
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on sympy
eval_cases:
- id: sympy-approach
  prompt: How should I approach sympy for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on sympy
  tags:
  - sympy
- id: sympy-best-practices
  prompt: What are the key best practices and pitfalls for sympy?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for sympy
  tags:
  - sympy
  - best-practices
- id: sympy-antipatterns
  prompt: What are the most common mistakes to avoid with sympy?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
