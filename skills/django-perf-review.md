...
metadata:
  ...
  triggers:
  - asked to "review django performance", "find n+1 queries", "optimize django", "ch
eval_cases:
- id: django-perf-review-approach
  prompt: How should I approach django perf review for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on django perf review
  tags:
  - django
- id: django-perf-review-best-practices
  prompt: What are the key best practices and pitfalls for django perf review?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for django perf review
  tags:
  - django
  - best-practices
- id: django-perf-review-antipatterns
  prompt: What are the most common mistakes to avoid with django perf review?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
