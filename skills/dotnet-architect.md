...
eval_cases:
- id: dotnet-architect-approach
  prompt: How should I approach dotnet architect for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on dotnet architect
  tags:
  - dotnet
- id: dotnet-architect-best-practices
  prompt: What are the key best practices and pitfalls for dotnet architect?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for dotnet architect
  tags:
  - dotnet
  - best-practices
- id: dotnet-architect-antipatterns
  prompt: What are the most common mistakes to avoid with dotnet architect?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
