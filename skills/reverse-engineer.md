...
metadata:
  ...
  triggers:
  - when working on reverse engineer
eval_cases:
- id: reverse-engineer-approach
  prompt: How should I approach reverse engineer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on reverse engineer
  tags:
  - reverse
- id: reverse-engineer-best-practices
  prompt: What are the key best practices and pitfalls for reverse engineer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for reverse engineer
  tags:
  - reverse
  - best-practices
- id: reverse-engineer-antipatterns
  prompt: What are the most common mistakes to avoid with reverse engineer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
