...
metadata:
  ...
  triggers:
  - 'designing protobuf contracts with buf or implementing secure service-to-service '
...
eval_cases:
- id: grpc-golang-approach
  prompt: How should I approach grpc golang for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on grpc golang
  tags:
  - grpc
- id: grpc-golang-best-practices
  prompt: What are the key best practices and pitfalls for grpc golang?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for grpc golang
  tags:
  - grpc
  - best-practices
- id: grpc-golang-antipatterns
  prompt: What are the most common mistakes to avoid with grpc golang?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
