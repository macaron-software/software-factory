...
eval_cases:
- id: api-documenter-approach
  prompt: How should I approach api documenter for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on api documenter
  tags:
  - api
- id: api-documenter-best-practices
  prompt: What are the key best practices and pitfalls for api documenter?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for api documenter
  tags:
  - api
  - best-practices
- id: api-documenter-antipatterns
  prompt: What are the most common mistakes to avoid with api documenter?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
