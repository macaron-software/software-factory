...
metadata:
  ...
  triggers:
  - when working on emergency card
eval_cases:
- id: emergency-card-approach
  prompt: How should I approach emergency card for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on emergency card
  tags:
  - emergency
- id: emergency-card-best-practices
  prompt: What are the key best practices and pitfalls for emergency card?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for emergency card
  tags:
  - emergency
  - best-practices
- id: emergency-card-antipatterns
  prompt: What are the most common mistakes to avoid with emergency card?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
