...
metadata:
  ...
  triggers:
  - when working on hig components system
eval_cases:
- id: hig-components-system-approach
  prompt: How should I approach hig components system for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hig components system
  tags:
  - hig
- id: hig-components-system-best-practices
  prompt: What are the key best practices and pitfalls for hig components system?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hig components system
  tags:
  - hig
  - best-practices
- id: hig-components-system-antipatterns
  prompt: What are the most common mistakes to avoid with hig components system?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
