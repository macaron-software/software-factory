...
eval_cases:
- id: seo-content-writer-approach
  prompt: How should I approach seo content writer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on seo content writer
  tags:
  - seo
- id: seo-content-writer-best-practices
  prompt: What are the key best practices and pitfalls for seo content writer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for seo content writer
  tags:
  - seo
  - best-practices
- id: seo-content-writer-antipatterns
  prompt: What are the most common mistakes to avoid with seo content writer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
