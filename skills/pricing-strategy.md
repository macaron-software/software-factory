...
metadata:
  ...
  triggers:
  - when working on pricing strategy
eval_cases:
- id: pricing-strategy-approach
  prompt: How should I approach pricing strategy for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on pricing strategy
  tags:
  - pricing
- id: pricing-strategy-best-practices
  prompt: What are the key best practices and pitfalls for pricing strategy?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for pricing strategy
  tags:
  - pricing
  - best-practices
- id: pricing-strategy-antipatterns
  prompt: What are the most common mistakes to avoid with pricing strategy?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
