...
eval_cases:
- id: cloud-devops-approach
  prompt: How should I approach cloud devops for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on cloud devops
  tags:
  - cloud
- id: cloud-devops-best-practices
  prompt: What are the key best practices and pitfalls for cloud devops?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for cloud devops
  tags:
  - cloud
  - best-practices
- id: cloud-devops-antipatterns
  prompt: What are the most common mistakes to avoid with cloud devops?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
