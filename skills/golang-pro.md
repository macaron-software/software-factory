...
eval_cases:
- id: golang-pro-approach
  prompt: How should I approach golang pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on golang pro
  tags:
  - golang
- id: golang-pro-best-practices
  prompt: What are the key best practices and pitfalls for golang pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for golang pro
  tags:
  - golang
  - best-practices
- id: golang-pro-antipatterns
  prompt: What are the most common mistakes to avoid with golang pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
