...
eval_cases:
- id: devops-troubleshooter-approach
  prompt: How should I approach devops troubleshooter for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on devops troubleshooter
  tags:
  - devops
- id: devops-troubleshooter-best-practices
  prompt: What are the key best practices and pitfalls for devops troubleshooter?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for devops troubleshooter
  tags:
  - devops
  - best-practices
- id: devops-troubleshooter-antipatterns
  prompt: What are the most common mistakes to avoid with devops troubleshooter?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
