...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: https://github.com/jackjin1997/ClawForge'
  triggers:
  - when working on oss hunter
eval_cases:
- id: oss-hunter-approach
  prompt: How should I approach oss hunter for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on oss hunter
  tags:
  - oss
- id: oss-hunter-best-practices
  prompt: What are the key best practices and pitfalls for oss hunter?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for oss hunter
  tags:
  - oss
  - best-practices
- id: oss-hunter-antipatterns
  prompt: What are the most common mistakes to avoid with oss hunter?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
