...
metadata:
  ...
  triggers:
  - when working on skin health analyzer
eval_cases:
- id: skin-health-analyzer-approach
  prompt: How should I approach skin health analyzer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on skin health analyzer
  tags:
  - skin
- id: skin-health-analyzer-best-practices
  prompt: What are the key best practices and pitfalls for skin health analyzer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for skin health analyzer
  tags:
  - skin
  - best-practices
- id: skin-health-analyzer-antipatterns
  prompt: What are the most common mistakes to avoid with skin health analyzer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
