...
eval_cases:
- id: startup-business-analyst-financial-projections-approach
  prompt: How should I approach startup business analyst financial projections for
    a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on startup business analyst financial projections
  tags:
  - startup
- id: startup-business-analyst-financial-projections-best-practices
  prompt: What are the key best practices and pitfalls for startup business analyst
  ...
  - no_placeholder
  expectations:
  - Lists concrete best practices for startup business analyst financial projections
  tags:
  - startup
  - best-practices
- id: startup-business-analyst-financial-projections-antipatterns
  prompt: What are the most common mistakes to avoid with startup business analyst
    financial projections?
  should_trigger: true
  checks:
  - length_min:80
