...
metadata:
  ...
  triggers:
  - creating container-based agents in azure ai foundry
eval_cases:
- id: hosted-agents-v2-py-approach
  prompt: How should I approach hosted agents v2 py for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hosted agents v2 py
  tags:
  - hosted
- id: hosted-agents-v2-py-best-practices
  prompt: What are the key best practices and pitfalls for hosted agents v2 py?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hosted agents v2 py
  tags:
  - hosted
  - best-practices
- id: hosted-agents-v2-py-antipatterns
  prompt: What are the most common mistakes to avoid with hosted agents v2 py?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
