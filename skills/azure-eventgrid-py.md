...
metadata:
  ...
  triggers:
  - when working on azure eventgrid py
eval_cases:
- id: azure-eventgrid-py-approach
  prompt: How should I approach azure eventgrid py for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure eventgrid py
  tags:
  - azure
- id: azure-eventgrid-py-best-practices
  prompt: What are the key best practices and pitfalls for azure eventgrid py?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure eventgrid py
  tags:
  - azure
  - best-practices
- id: azure-eventgrid-py-antipatterns
  prompt: What are the most common mistakes to avoid with azure eventgrid py?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
