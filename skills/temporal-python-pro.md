...
eval_cases:
- id: temporal-python-pro-approach
  prompt: How should I approach temporal python pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on temporal python pro
  tags:
  - temporal
- id: temporal-python-pro-best-practices
  prompt: What are the key best practices and pitfalls for temporal python pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for temporal python pro
  tags:
  - temporal
  - best-practices
- id: temporal-python-pro-antipatterns
  prompt: What are the most common mistakes to avoid with temporal python pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
