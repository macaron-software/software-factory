...
metadata:
  ...
  triggers:
  - when working on azure ai contentunderstanding py
eval_cases:
- id: azure-ai-contentunderstanding-py-approach
  prompt: How should I approach azure ai contentunderstanding py for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on azure ai contentunderstanding py
  tags:
  - azure
- id: azure-ai-contentunderstanding-py-best-practices
  prompt: What are the key best practices and pitfalls for azure ai contentunderstanding
    py?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for azure ai contentunderstanding py
  tags:
  - azure
  - best-practices
- id: azure-ai-contentunderstanding-py-antipatterns
  prompt: What are the most common mistakes to avoid with azure ai contentunderstanding
    py?
  should_trigger: true
  checks:
  - length_min:80
