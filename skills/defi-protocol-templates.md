...
metadata:
  ...
  triggers:
  - building decentralized finance applications or smart contract protocols
eval_cases:
- id: defi-protocol-templates-approach
  prompt: How should I approach defi protocol templates for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on defi protocol templates
  tags:
  - defi
- id: defi-protocol-templates-best-practices
  prompt: What are the key best practices and pitfalls for defi protocol templates?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for defi protocol templates
  tags:
  - defi
  - best-practices
- id: defi-protocol-templates-antipatterns
  prompt: What are the most common mistakes to avoid with defi protocol templates?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
