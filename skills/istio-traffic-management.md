...
metadata:
  ...
  triggers:
  - implementing service mesh traffic policies, progressive delivery, or resilie
eval_cases:
- id: istio-traffic-management-approach
  prompt: How should I approach istio traffic management for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on istio traffic management
  tags:
  - istio
- id: istio-traffic-management-best-practices
  prompt: What are the key best practices and pitfalls for istio traffic management?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for istio traffic management
  tags:
  - istio
  - best-practices
- id: istio-traffic-management-antipatterns
  prompt: What are the most common mistakes to avoid with istio traffic management?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
