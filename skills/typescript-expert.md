...
metadata:
  ...
  triggers:
  - when working on typescript expert
eval_cases:
- id: typescript-expert-approach
  prompt: How should I approach typescript expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on typescript expert
  tags:
  - typescript
- id: typescript-expert-best-practices
  prompt: What are the key best practices and pitfalls for typescript expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for typescript expert
  tags:
  - typescript
  - best-practices
- id: typescript-expert-antipatterns
  prompt: What are the most common mistakes to avoid with typescript expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
