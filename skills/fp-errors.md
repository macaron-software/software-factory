...
metadata:
  ...
  triggers:
  - when working on fp errors
eval_cases:
- id: fp-errors-approach
  prompt: How should I approach fp errors for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on fp errors
  tags:
  - fp
- id: fp-errors-best-practices
  prompt: What are the key best practices and pitfalls for fp errors?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for fp errors
  tags:
  - fp
  - best-practices
- id: fp-errors-antipatterns
  prompt: What are the most common mistakes to avoid with fp errors?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
