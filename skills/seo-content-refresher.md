...
eval_cases:
- id: seo-content-refresher-approach
  prompt: How should I approach seo content refresher for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on seo content refresher
  tags:
  - seo
- id: seo-content-refresher-best-practices
  prompt: What are the key best practices and pitfalls for seo content refresher?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for seo content refresher
  tags:
  - seo
  - best-practices
- id: seo-content-refresher-antipatterns
  prompt: What are the most common mistakes to avoid with seo content refresher?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
