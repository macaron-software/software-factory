...
metadata:
  ...
  triggers:
  - when working on idor testing
eval_cases:
- id: idor-testing-approach
  prompt: How should I approach idor testing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on idor testing
  tags:
  - idor
- id: idor-testing-best-practices
  prompt: What are the key best practices and pitfalls for idor testing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for idor testing
  tags:
  - idor
  - best-practices
- id: idor-testing-antipatterns
  prompt: What are the most common mistakes to avoid with idor testing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
