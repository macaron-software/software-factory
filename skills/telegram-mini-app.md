...
eval_cases:
- id: telegram-mini-app-approach
  prompt: How should I approach telegram mini app for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on telegram mini app
  tags:
  - telegram
- id: telegram-mini-app-best-practices
  prompt: What are the key best practices and pitfalls for telegram mini app?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for telegram mini app
  tags:
  - telegram
  - best-practices
- id: telegram-mini-app-antipatterns
  prompt: What are the most common mistakes to avoid with telegram mini app?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
