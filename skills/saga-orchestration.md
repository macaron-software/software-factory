...
metadata:
  ...
  triggers:
  - 'coordinating multi-step business processes, handling compensating transactions, '
eval_cases:
- id: saga-orchestration-approach
  prompt: How should I approach saga orchestration for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on saga orchestration
  tags:
  - saga
- id: saga-orchestration-best-practices
  prompt: What are the key best practices and pitfalls for saga orchestration?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for saga orchestration
  tags:
  - saga
  - best-practices
- id: saga-orchestration-antipatterns
  prompt: What are the most common mistakes to avoid with saga orchestration?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
