...
metadata:
  ...
  triggers:
  - when working on privilege escalation methods
eval_cases:
- id: privilege-escalation-methods-approach
  prompt: How should I approach privilege escalation methods for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on privilege escalation methods
  tags:
  - privilege
- id: privilege-escalation-methods-best-practices
  prompt: What are the key best practices and pitfalls for privilege escalation methods?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for privilege escalation methods
  tags:
  - privilege
  - best-practices
- id: privilege-escalation-methods-antipatterns
  prompt: What are the most common mistakes to avoid with privilege escalation methods?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
