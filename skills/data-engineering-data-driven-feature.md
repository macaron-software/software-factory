...
eval_cases:
- id: data-engineering-data-driven-feature-approach
  prompt: How should I approach data engineering data driven feature for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on data engineering data driven feature
  tags:
  - data
- id: data-engineering-data-driven-feature-best-practices
  prompt: What are the key best practices and pitfalls for data engineering data driven
    feature?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for data engineering data driven feature
  tags:
  - data
  - best-practices
- id: data-engineering-data-driven-feature-antipatterns
  prompt: What are the most common mistakes to avoid with data engineering data driven
    feature?
  should_trigger: true
  checks:
  - length_min:80
