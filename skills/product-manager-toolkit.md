...
metadata:
  ...
  triggers:
  - when working on product manager toolkit
eval_cases:
- id: product-manager-toolkit-approach
  prompt: How should I approach product manager toolkit for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on product manager toolkit
  tags:
  - product
- id: product-manager-toolkit-best-practices
  prompt: What are the key best practices and pitfalls for product manager toolkit?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for product manager toolkit
  tags:
  - product
  - best-practices
- id: product-manager-toolkit-antipatterns
  prompt: What are the most common mistakes to avoid with product manager toolkit?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
