...
eval_cases:
- id: julia-pro-approach
  prompt: How should I approach julia pro for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on julia pro
  tags:
  - julia
- id: julia-pro-best-practices
  prompt: What are the key best practices and pitfalls for julia pro?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for julia pro
  tags:
  - julia
  - best-practices
- id: julia-pro-antipatterns
  prompt: What are the most common mistakes to avoid with julia pro?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
