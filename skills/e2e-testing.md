...
eval_cases:
- id: e2e-testing-approach
  prompt: How should I approach e2e testing for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on e2e testing
  tags:
  - e2e
- id: e2e-testing-best-practices
  prompt: What are the key best practices and pitfalls for e2e testing?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for e2e testing
  tags:
  - e2e
  - best-practices
- id: e2e-testing-antipatterns
  prompt: What are the most common mistakes to avoid with e2e testing?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
