...
eval_cases:
- id: deployment-engineer-approach
  prompt: How should I approach deployment engineer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on deployment engineer
  tags:
  - deployment
- id: deployment-engineer-best-practices
  prompt: What are the key best practices and pitfalls for deployment engineer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for deployment engineer
  tags:
  - deployment
  - best-practices
- id: deployment-engineer-antipatterns
  prompt: What are the most common mistakes to avoid with deployment engineer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
