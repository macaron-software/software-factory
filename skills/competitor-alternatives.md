...
metadata:
  ...
  triggers:
  - the user mentions 'alternative page,' 'vs page,' 'competitor comparison,' 'compa
eval_cases:
- id: competitor-alternatives-approach
  prompt: How should I approach competitor alternatives for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on competitor alternatives
  tags:
  - competitor
- id: competitor-alternatives-best-practices
  prompt: What are the key best practices and pitfalls for competitor alternatives?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for competitor alternatives
  tags:
  - competitor
  - best-practices
- id: competitor-alternatives-antipatterns
  prompt: What are the most common mistakes to avoid with competitor alternatives?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
