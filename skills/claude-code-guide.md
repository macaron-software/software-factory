...
metadata:
  ...
  - 'build: `npm run build`'
eval_cases:
- id: claude-code-guide-approach
  prompt: How should I approach claude code guide for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on claude code guide
  tags:
  - claude
- id: claude-code-guide-best-practices
  prompt: What are the key best practices and pitfalls for claude code guide?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for claude code guide
  tags:
  - claude
  - best-practices
- id: claude-code-guide-antipatterns
  prompt: What are the most common mistakes to avoid with claude code guide?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
