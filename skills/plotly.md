...
description: Interactive visualization library. Use when you need hover info, zoom,
  ...
  For static publication figures us...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - you need hover info, zoom, pan, or web-embeddable charts
  - working with pandas dataframes
  - creating common chart types (scatter, line, bar, histogram, etc.)
eval_cases:
- id: plotly-approach
  prompt: How should I approach plotly for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on plotly
  tags:
  - plotly
- id: plotly-best-practices
  prompt: What are the key best practices and pitfalls for plotly?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for plotly
  tags:
  - plotly
  - best-practices
- id: plotly-antipatterns
  prompt: What are the most common mistakes to avoid with plotly?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
