...
eval_cases:
- id: kaizen-approach
  prompt: How should I approach kaizen for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on kaizen
  tags:
  - kaizen
- id: kaizen-best-practices
  prompt: What are the key best practices and pitfalls for kaizen?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for kaizen
  tags:
  - kaizen
  - best-practices
- id: kaizen-antipatterns
  prompt: What are the most common mistakes to avoid with kaizen?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
