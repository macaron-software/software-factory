...
metadata:
  ...
  triggers:
  - the user wants an in-depth investigation, needs to understand how
eval_cases:
- id: wiki-researcher-approach
  prompt: How should I approach wiki researcher for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on wiki researcher
  tags:
  - wiki
- id: wiki-researcher-best-practices
  prompt: What are the key best practices and pitfalls for wiki researcher?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for wiki researcher
  tags:
  - wiki
  - best-practices
- id: wiki-researcher-antipatterns
  prompt: What are the most common mistakes to avoid with wiki researcher?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
