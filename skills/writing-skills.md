...
metadata:
  ...
  triggers:
  - creating, updating, or improving agent skills
eval_cases:
- id: writing-skills-approach
  prompt: How should I approach writing skills for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on writing skills
  tags:
  - writing
- id: writing-skills-best-practices
  prompt: What are the key best practices and pitfalls for writing skills?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for writing skills
  tags:
  - writing
  - best-practices
- id: writing-skills-antipatterns
  prompt: What are the most common mistakes to avoid with writing skills?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
