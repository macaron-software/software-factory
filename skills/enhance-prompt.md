...
metadata:
  ...
  triggers:
  - when working on enhance prompt
eval_cases:
- id: enhance-prompt-approach
  prompt: How should I approach enhance prompt for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on enhance prompt
  tags:
  - enhance
- id: enhance-prompt-best-practices
  prompt: What are the key best practices and pitfalls for enhance prompt?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for enhance prompt
  tags:
  - enhance
  - best-practices
- id: enhance-prompt-antipatterns
  prompt: What are the most common mistakes to avoid with enhance prompt?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
