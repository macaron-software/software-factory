...
eval_cases:
- id: issues-approach
  prompt: How should I approach issues for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on issues
  tags:
  - issues
- id: issues-best-practices
  prompt: What are the key best practices and pitfalls for issues?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for issues
  tags:
  - issues
  - best-practices
- id: issues-antipatterns
  prompt: What are the most common mistakes to avoid with issues?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
