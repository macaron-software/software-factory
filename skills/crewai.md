...
eval_cases:
- id: crewai-approach
  prompt: How should I approach crewai for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on crewai
  tags:
  - crewai
- id: crewai-best-practices
  prompt: What are the key best practices and pitfalls for crewai?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for crewai
  tags:
  - crewai
  - best-practices
- id: crewai-antipatterns
  prompt: What are the most common mistakes to avoid with crewai?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
