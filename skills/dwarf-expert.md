...
description: Provides expertise for analyzing DWARF debug files and understanding
  ...
  interacting with DWARF files, answering ...
metadata:
...
eval_cases:
- id: dwarf-expert-approach
  prompt: How should I approach dwarf expert for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on dwarf expert
  tags:
  - dwarf
- id: dwarf-expert-best-practices
  prompt: What are the key best practices and pitfalls for dwarf expert?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for dwarf expert
  tags:
  - dwarf
  - best-practices
- id: dwarf-expert-antipatterns
  prompt: What are the most common mistakes to avoid with dwarf expert?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
