...
metadata:
  ...
  source: 'antigravity-awesome-skills (MIT) — source: vibeship-spawner-skills (Apache
    2.0)'
  triggers:
  - when working on langgraph
eval_cases:
- id: langgraph-approach
  prompt: How should I approach langgraph for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on langgraph
  tags:
  - langgraph
- id: langgraph-best-practices
  prompt: What are the key best practices and pitfalls for langgraph?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for langgraph
  tags:
  - langgraph
  - best-practices
- id: langgraph-antipatterns
  prompt: What are the most common mistakes to avoid with langgraph?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
