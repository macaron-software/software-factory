...
metadata:
  ...
  triggers:
  - when working on windows privilege escalation
eval_cases:
- id: windows-privilege-escalation-approach
  prompt: How should I approach windows privilege escalation for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on windows privilege escalation
  tags:
  - windows
- id: windows-privilege-escalation-best-practices
  prompt: What are the key best practices and pitfalls for windows privilege escalation?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for windows privilege escalation
  tags:
  - windows
  - best-practices
- id: windows-privilege-escalation-antipatterns
  prompt: What are the most common mistakes to avoid with windows privilege escalation?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
