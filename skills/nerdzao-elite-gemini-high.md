...
metadata:
  ...
  triggers:
  - when working on nerdzao elite gemini high
eval_cases:
- id: nerdzao-elite-gemini-high-approach
  prompt: How should I approach nerdzao elite gemini high for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on nerdzao elite gemini high
  tags:
  - nerdzao
- id: nerdzao-elite-gemini-high-best-practices
  prompt: What are the key best practices and pitfalls for nerdzao elite gemini high?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for nerdzao elite gemini high
  tags:
  - nerdzao
  - best-practices
- id: nerdzao-elite-gemini-high-antipatterns
  prompt: What are the most common mistakes to avoid with nerdzao elite gemini high?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
