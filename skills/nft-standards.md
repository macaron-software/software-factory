...
metadata:
  ...
  triggers:
  - creating nft contracts, building nft marketplaces, or implementi
eval_cases:
- id: nft-standards-approach
  prompt: How should I approach nft standards for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on nft standards
  tags:
  - nft
- id: nft-standards-best-practices
  prompt: What are the key best practices and pitfalls for nft standards?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for nft standards
  tags:
  - nft
  - best-practices
- id: nft-standards-antipatterns
  prompt: What are the most common mistakes to avoid with nft standards?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
