...
metadata:
  ...
  triggers:
  - '**use this skill for**: dataset creation, content editing, sql queries, data
    tra'
eval_cases:
- id: hugging-face-datasets-approach
  prompt: How should I approach hugging face datasets for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hugging face datasets
  tags:
  - hugging
- id: hugging-face-datasets-best-practices
  prompt: What are the key best practices and pitfalls for hugging face datasets?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hugging face datasets
  tags:
  - hugging
  - best-practices
- id: hugging-face-datasets-antipatterns
  prompt: What are the most common mistakes to avoid with hugging face datasets?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
