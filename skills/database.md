...
eval_cases:
- id: database-approach
  prompt: How should I approach database for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on database
  tags:
  - database
- id: database-best-practices
  prompt: What are the key best practices and pitfalls for database?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for database
  tags:
  - database
  - best-practices
- id: database-antipatterns
  prompt: What are the most common mistakes to avoid with database?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
