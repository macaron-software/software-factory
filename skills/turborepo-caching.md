...
metadata:
  ...
  triggers:
  - setting up turborepo, optimizing build pipelines, or implementing distributed
    ca
eval_cases:
- id: turborepo-caching-approach
  prompt: How should I approach turborepo caching for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on turborepo caching
  tags:
  - turborepo
- id: turborepo-caching-best-practices
  prompt: What are the key best practices and pitfalls for turborepo caching?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for turborepo caching
  tags:
  - turborepo
  - best-practices
- id: turborepo-caching-antipatterns
  prompt: What are the most common mistakes to avoid with turborepo caching?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
