...
description: Integrate digital health data sources (Apple Health, Fitbit, Oura Ring)
  ...
  standardize to local format, and recommend r...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on wellally tech
eval_cases:
- id: wellally-tech-approach
  prompt: How should I approach wellally tech for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on wellally tech
  tags:
  - wellally
- id: wellally-tech-best-practices
  prompt: What are the key best practices and pitfalls for wellally tech?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for wellally tech
  tags:
  - wellally
  - best-practices
- id: wellally-tech-antipatterns
  prompt: What are the most common mistakes to avoid with wellally tech?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
