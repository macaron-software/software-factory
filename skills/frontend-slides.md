...
metadata:
  ...
  triggers:
  - the user wants to build a presentation, convert a ppt/pptx to web, or create sli
eval_cases:
- id: frontend-slides-approach
  prompt: How should I approach frontend slides for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on frontend slides
  tags:
  - frontend
- id: frontend-slides-best-practices
  prompt: What are the key best practices and pitfalls for frontend slides?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for frontend slides
  tags:
  - frontend
  - best-practices
- id: frontend-slides-antipatterns
  prompt: What are the most common mistakes to avoid with frontend slides?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
