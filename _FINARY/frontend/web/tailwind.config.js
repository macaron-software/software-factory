...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'source': ['9px', { lineHeight: '1.3', letterSpacing: '0.02em' }],
        'caption': ['10px', { lineHeight: '1.4', letterSpacing: '0.04em' }],
        'label': ['11px', { lineHeight: '1.4', letterSpacing: '0.03em' }],
        'body': ['13px', { lineHeight: '1.5' }],
        'body-lg': ['14px', { lineHeight: '1.5' }],
        'title': ['15px', { lineHeight: '1.3', letterSpacing: '-0.01em' }],
        'heading': ['18px', { lineHeight: '1.3', letterSpacing: '-0.01em' }],
        'hero': ['32px', { lineHeight: '1', letterSpacing: '-0.025em' }],
        'hero-lg': ['40px', { lineHeight: '1', letterSpacing: '-0.03em' }],
      },
      borderRadius: {
        sm: 'var(--radius-sm)',
        md: 'var(--radius-md)',
