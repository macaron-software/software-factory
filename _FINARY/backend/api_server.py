...
def get_sca_legal():
    ...
    return {
        ...
        "beaussier_legal_estimate": {
            ...
            # Préjudices potentiels pour Beaussier
            "prejudices": {
                "vs_sca": [
                    {"desc": "AF impayés (appels de fonds)", "amount": 25334.71,
                     "note": "Appels de fonds non réglés depuis 2021"},
                    {"desc": "Capital non libéré", "amount": 192127.97,
                     "note": "Capital souscrit 343 795€ − versé 151 667€"},
                    {"desc": "QP procédures impayées (ci-dessus)", "amount": 11486.51,
                     "note": "Avocats, huissiers, mandataire, études — avancés par Legland"},
                    {"desc": "Occupation sans droit ni titre", "amount_low": 5000, "amount_high": 20000,
                     "note": "Indemnité d'occupation mensuelle estimée ~500-800€/mois × 12-24 mois"},
                    {"desc": "Blocage chantier / retard livraison", "amount_low": 10000, "amount_high": 30000,
                     "note": "Préjudice de jouissance, surcoûts liés à l'arrêt de chantier, frais bancaires (intérêts crédit)"},
                ],
                "total_vs_sca_certain": 25334.71 + 192127.97 + 11486.51,
                "total_vs_sca_potentiel_low": 25334.71 + 192127.97 + 11486.51 + 5000 + 10000,
                "total_vs_sca_potentiel_high": 25334.71 + 192127.97 + 11486.51 + 20000 + 30000,
                "vs_legland": [
                    {"desc": "Expertise 100% avancée par Legland (QP Beaussier ~49,4%)", "amount": 5454.10,
                     "note": "11 039,57€ × 49,4% = 5 454,10€ — consignation payée en intégralité par Legland"},
                    {"desc": "Frais avocat perso (Legland hors SCA)", "amount": 4650,
                     "note": "Virements perso à Me Saint Martin pour défense des intérêts Legland"},
                    {"desc": "Préjudice moral / harcèlement procédural", "amount_low": 3000, "amount_high": 10000,
                     "note": "Multiples procédures dilatoires, HAH systématiques sur AG, blocage projet"},
                    {"desc": "Perte de chance (retard projet immobilier)", "amount_low": 15000, "amount_high": 40000,
                     "note": "Surcoût crédit, perte valeur temps, impossibilité d'habiter le bien"},
                ],
                "total_vs_legland_certain": 5454.10 + 4650,
                "total_vs_legland_potentiel_low": 5454.10 + 4650 + 3000 + 15000,
                "total_vs_legland_potentiel_high": 5454.10 + 4650 + 10000 + 40000,
            },
        },
