...
تصوّر **مصنع برمجيات افتراضي** حيث يتعاون 192 وكيل ذكاء اصطناعي عبر سير عمل منظم، باتباع منهجية SAFe، وتطبيق ممارسات TDD، واستخدام بوابات الجودة الآلية.
...
<tr>
<td width="50%">
<strong>سير العمل — 46 خط أنابيب مدمج (/workflows)</strong><br>
...
**تطبيق macOS أصلي بـ SwiftUI** (يدعم Apple Silicon وRosetta 2) متاح إلى جانب منصة الويب، مع نسخة SF محلية تعمل بدون إنترنت وموصلات بعيدة لـ OVH وAzure.
...
> إذا حظر macOS التطبيق: **إعدادات النظام ← الخصوصية والأمان ← فتح على أي حال**

### الميزات
- **SF محلية مدمجة** — تشغيل العوامل مع Ollama/MLX (Qwen، Llama...) أو مفاتيح API
- **3 موصلات بعيدة** — SF محلية / عرض OVH / إنتاج Azure (HA عقدتان)
- **100% مطابق للويب** — العوامل، المهام، المشاريع، TMA، Wiki، التحليلات، DORA، Evals، الابتكار، RBAC
- **22 اختباراً وحدوياً** — WSJF، LLMConfig، الإعداد، إدارة النسخ
...
### استوديو التعليقات التوضيحية — ملاحظات مرئية على أي صفحة

طبقة تعليقات توضيحية مرئية مدمجة تحول كل صفحة SF إلى لوحة مراجعة تعاونية:

- **✏️ زر التعليق التوضيحي** — انقر لتفعيل وضع التعليقات؛ شريط أدوات عائم على كل صفحة
- **انقر للتعليق** — انقر على أي عنصر: خطأ 🐛، تعليق 💬، ميزة ✨، تصميم 🎨 أو تصحيح نص 📝
- **شريط قابلية التتبع SAFe** — أيقونة الشخصية في الشريط العلوي → **البرنامج → الملحمة → الميزة → القصص**
- **وضع الإطار السلكي** — أيقونة الشبكة → عرض هيكلي/شيمر لفحص UX
- **توليد التذاكر** — كل تعليق يمكنه إطلاق مهمة إصلاح مباشرة
- **تكيّف مع السمة** — يستخدم متغيرات CSS، يتكيف مع السمة الفاتحة/الداكنة
