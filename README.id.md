...
**Pabrik Perangkat Lunak Multi-Agen — Agen AI Otonom Mengorkestrasi Siklus Hidup Produk Lengkap**

[![License: AGPL v3](https://img.shields.io/badge/License-AGPL%20v3-blue.svg)](https://www.gnu.org/licenses/agpl-3.0)
[![Python 3.10+](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/downloads/)
[![FastAPI](https://img.shields.io/badge/FastAPI-0.104+-green.svg)](https://fastapi.tiangolo.com/)

**[Demo: sf.macaron-software.com](https://sf.macaron-software.com)**

[Fitur](#fitur) · [Mulai Cepat](#mulai-cepat) · [Tangkapan Layar](#tangkapan-layar) · [Arsitektur](#arsitektur) · [Kontribusi](#kontribusi)
...
Software Factory adalah **platform multi-agen otonom** yang mengorkestrasi seluruh siklus pengembangan perangkat lunak — dari ideasi hingga deployment — menggunakan agen AI khusus yang bekerja sama.

Bayangkan sebuah **pabrik perangkat lunak virtual** di mana 192 agen AI berkolaborasi melalui alur kerja terstruktur, mengikuti metodologi SAFe, menerapkan praktik TDD, dan menggunakan gerbang kualitas otomatis.
...
<tr>
<td width="50%">
<strong>Alur Kerja — 46 Pipeline Bawaan (/workflows)</strong><br>
...
**Aplikasi macOS native SwiftUI** (Apple Silicon dan Rosetta 2) tersedia bersama platform web, dengan instans SF lokal yang sepenuhnya offline dan konektor jarak jauh ke OVH dan Azure.
...
> Jika macOS memblokir: **Pengaturan Sistem → Privasi & Keamanan → Tetap Buka**

### Fitur
- **SF lokal terintegrasi** — agen dengan Ollama/MLX (Qwen, Llama…) atau kunci API
- **3 konektor jarak jauh** — SF lokal / demo OVH / prod Azure (HA 2 node)
- **100% ISO web** — Agen, Misi, Proyek, TMA, Wiki, Analitik, DORA, Evals, Ideasi, RBAC
- **22 unit test** — WSJF, LLMConfig, onboarding, manajemen instans
...
### Alur Kerja zur kontinuierlichen Verbesserung
