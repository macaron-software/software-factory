...
class LLMConfig:
    ...
    providers: dict = field(default_factory=lambda: {
        "anthropic": LLMProviderConfig(
            ...
            models=["claude-opus-4-5-20250520", "claude-sonnet-4-20250514", "claude-haiku-4-5-20250520"],
    ...
    role_defaults: dict = field(default_factory=lambda: {
