...
def get_builtin_workflows() -> list[WorkflowDef]:
    ...
    builtins = [
        ...
        WorkflowDef(
            ...
            phases=[
                ...
                WorkflowPhase(id="qa-validation", pattern_id="loop",
                              ...
                              gate="qa_approved",
                              config={"agents": ["test_manager", "qa_lead", "test_auto", "api_tester"], "max_iterations": 3}),
                WorkflowPhase(id="release", pattern_id="sequential",
    ...
    builtins.append(
        WorkflowDef(
            ...
            phases=[
                WorkflowPhase(
                    id="ideation", pattern_id="network", name="Idéation",
                    ...
                    gate="always",
                    config={"agents": ["business_analyst", "enterprise_architect", "ux_designer", "securite", "product_manager"]},
                ),
                WorkflowPhase(
                    id="po-structure", pattern_id="sequential", name="Structuration PO",
                ...
                WorkflowPhase(
                    id="comite-strat", pattern_id="human-in-the-loop", name="Comité Stratégique — GO/NOGO",
                    description="Le comité de direction évalue: alignement stratégique, ROI, risques, capacité. Décision GO/NOGO/PIVOT.",
                    gate="checkpoint",
                    config={"agents": ["strat-cpo", "strat-cto", "lean_portfolio_manager", "strat-portfolio", "dsi"]},
                ),
                WorkflowPhase(
                    id="project-setup", pattern_id="sequential", name="Constitution Projet",
                ...
                WorkflowPhase(
                    id="architecture", pattern_id="aggregator", name="Architecture & Design",
                    ...
                    gate="always",
                    config={"agents": ["enterprise_architect", "ux_designer", "securite", "devops", "lead_dev"]},
                ),
                WorkflowPhase(
                    id="dev-sprint", pattern_id="hierarchical", name="Sprint Dev",
                ...
                WorkflowPhase(
                    id="cicd-pipeline", pattern_id="sequential", name="Pipeline CI/CD",
                ...
                WorkflowPhase(
                    id="qa-validation", pattern_id="loop", name="Campagne QA",
                ...
                WorkflowPhase(
                    id="deploy-prod", pattern_id="human-in-the-loop", name="Déploiement Production — GO/NOGO",
                    description="Revue pré-production: QA sign-off, sécu sign-off, DevOps plan de déploiement. Décision GO/NOGO.",
                    gate="checkpoint",
                    config={"agents": ["devops", "qa_lead", "securite", "sre", "release_train_engineer"]},
                ),
                WorkflowPhase(
                    id="tma-handoff", pattern_id="sequential", name="Handoff TMA",
            ...
            config={
                "graph": {
                    "nodes": [
                        {"id": "n1", "agent_id": "business_analyst", "x": 50, "y": 100, "label": "BA Idéation", "phase": "ideation"},
                        {"id": "n2", "agent_id": "enterprise_architect", "x": 50, "y": 200, "label": "Archi", "phase": "ideation"},
                        {"id": "n3", "agent_id": "product_manager", "x": 200, "y": 150, "label": "PO Structure", "phase": "po-structure"},
                        {"id": "n4", "agent_id": "strat-cpo", "x": 350, "y": 100, "label": "CPO GO/NOGO", "phase": "comite-strat"},
                        {"id": "n5", "agent_id": "strat-cto", "x": 350, "y": 200, "label": "CTO GO/NOGO", "phase": "comite-strat"},
                        {"id": "n6", "agent_id": "devops", "x": 500, "y": 150, "label": "Setup Projet", "phase": "project-setup"},
                        {"id": "n7", "agent_id": "enterprise_architect", "x": 650, "y": 100, "label": "Archi Design", "phase": "architecture"},
                        {"id": "n8", "agent_id": "lead_dev", "x": 800, "y": 150, "label": "Sprint Dev", "phase": "dev-sprint"},
                        {"id": "n9", "agent_id": "pipeline_engineer", "x": 950, "y": 150, "label": "CI/CD", "phase": "cicd-pipeline"},
                        {"id": "n10", "agent_id": "qa_lead", "x": 1100, "y": 150, "label": "QA Loop", "phase": "qa-validation"},
                        {"id": "n11", "agent_id": "sre", "x": 1250, "y": 100, "label": "Deploy Prod", "phase": "deploy-prod"},
                        {"id": "n12", "agent_id": "responsable_tma", "x": 1400, "y": 150, "label": "TMA Handoff", "phase": "tma-handoff"},
                    ],
                    "edges": [
    ...
    builtins.append(
        WorkflowDef(
            id="mobile-ios-epic", name="Epic iOS App (SwiftUI)",
            description="Full Epic workflow for native iOS app: Architecture → Networking → Features → Tests → Integration.",
            icon="smartphone", is_builtin=True,
            phases=[
                WorkflowPhase(id="ios-archi", pattern_id="aggregator", name="Architecture & UX",
                ...
                WorkflowPhase(id="ios-network", pattern_id="hierarchical", name="Networking Layer",
                ...
                WorkflowPhase(id="ios-features", pattern_id="hierarchical", name="Features Sprint",
                              description="Lead delegates UI screens to dev: Dashboard, Missions, Agents, Chat, Ideation",
                              gate="always",
                              config={"agents": ["mobile_ios_lead", "mobile_ios_dev_ui", "mobile_ios_dev_net"]}),
                WorkflowPhase(id="ios-tests", pattern_id="loop", name="Testing & QA",
                ...
                WorkflowPhase(id="ios-integration", pattern_id="sequential", name="Integration & Polish",
            ...
            config={
                ...
                "graph": {
                    "nodes": [
                        {"id": "n1", "agent_id": "mobile_archi", "x": 300, "y": 20, "label": "Archi", "phase": "ios-archi"},
                        {"id": "n2", "agent_id": "mobile_ux", "x": 500, "y": 20, "label": "UX", "phase": "ios-archi"},
                        {"id": "n3", "agent_id": "mobile_ios_lead", "x": 400, "y": 130, "label": "Lead iOS", "phase": "ios-network"},
                        {"id": "n4", "agent_id": "mobile_ios_dev_net", "x": 250, "y": 240, "label": "Dev Network", "phase": "ios-network"},
                        {"id": "n5", "agent_id": "mobile_ios_dev_ui", "x": 550, "y": 240, "label": "Dev UI", "phase": "ios-features"},
                        {"id": "n6", "agent_id": "mobile_ios_qa", "x": 400, "y": 350, "label": "QA iOS", "phase": "ios-tests"},
                    ],
                    "edges": [
    ...
    builtins.append(
        WorkflowDef(
            id="mobile-android-epic", name="Epic Android App (Kotlin/Compose)",
            ...
            icon="smartphone", is_builtin=True,
            phases=[
                WorkflowPhase(id="android-archi", pattern_id="aggregator", name="Architecture & UX",
                              description="Mobile architect + UX define app structure, navigation, API contract",
                              gate="always",
                              config={"agents": ["mobile_archi", "mobile_ux", "mobile_android_lead"]}),
                WorkflowPhase(id="android-network", pattern_id="hierarchical", name="Networking Layer",
                              description="Lead Android delegates: ApiClient, SseClient, DTOs, AuthManager to network dev",
                              gate="always",
                              config={"agents": ["mobile_android_lead", "mobile_android_dev_net", "mobile_android_qa"]}),
                WorkflowPhase(id="android-features", pattern_id="hierarchical", name="Features Sprint",
                              description="Lead delegates Compose screens: Dashboard, Missions, Agents, Chat, Ideation",
                              gate="always",
                              config={"agents": ["mobile_android_lead", "mobile_android_dev_ui", "mobile_android_dev_net"]}),
                WorkflowPhase(id="android-tests", pattern_id="loop", name="Testing & QA",
                              description="QA writes JUnit + Compose tests, runs android_build + android_test + android_emulator_test, coverage > 80%",
                              gate="always",
                              config={"agents": ["mobile_android_qa", "mobile_android_lead"], "max_iterations": 3}),
                WorkflowPhase(id="android-integration", pattern_id="sequential", name="Integration & Polish",
                              description="Final: navigation flows, Material 3 theming, error states, app shell. Run android_lint.",
                              gate="always",
                              config={"agents": ["mobile_android_lead", "mobile_android_dev_ui", "mobile_android_qa"]}),
            ],
            config={
                "type": "epic",
                ...
                "graph": {
                    "nodes": [
                        {"id": "n1", "agent_id": "mobile_archi", "x": 300, "y": 20, "label": "Archi", "phase": "android-archi"},
                        {"id": "n2", "agent_id": "mobile_ux", "x": 500, "y": 20, "label": "UX", "phase": "android-archi"},
                        {"id": "n3", "agent_id": "mobile_android_lead", "x": 400, "y": 130, "label": "Lead Android", "phase": "android-network"},
                        {"id": "n4", "agent_id": "mobile_android_dev_net", "x": 250, "y": 240, "label": "Dev Network", "phase": "android-network"},
                        {"id": "n5", "agent_id": "mobile_android_dev_ui", "x": 550, "y": 240, "label": "Dev UI", "phase": "android-features"},
                        {"id": "n6", "agent_id": "mobile_android_qa", "x": 400, "y": 350, "label": "QA Android", "phase": "android-tests"},
                    ],
                    "edges": [
                        {"from": "n1", "to": "n3", "label": "architecture", "color": "#58a6ff"},
                        {"from": "n2", "to": "n3", "label": "ux specs", "color": "#ec4899"},
            ...
            config={
                ...
                "graph": {
                    "nodes": [
                        ...
                        {"id": "n2", "agent_id": "lead_dev", "x": 300, "y": 100, "label": "Fix Dev", "phase": "fix"},
                        {"id": "n3", "agent_id": "testeur", "x": 300, "y": 200, "label": "QA Verify", "phase": "fix"},
                        {"id": "n4", "agent_id": "sre", "x": 500, "y": 150, "label": "SRE Verify", "phase": "verify"},
    ...
    builtins.append(
        WorkflowDef(
            ...
            icon="calendar", is_builtin=True,
            phases=[
                WorkflowPhase(
                    id="pi-vision", pattern_id="sequential", name="Présentation Vision & Backlog",
                    ...
                    gate="always",
                    config={"agents": ["product_manager", "enterprise_architect", "release_train_engineer"]},
                ),
                WorkflowPhase(
                    id="pi-estimation", pattern_id="parallel", name="Estimation Features",
                    ...
                    gate="always",
                    config={"agents": ["lead_dev", "plat-lead-dev", "qa_lead", "devops", "securite"]},
                ),
                WorkflowPhase(
                    id="pi-capacity", pattern_id="aggregator", name="Capacity & Dépendances",
                    ...
                    gate="always",
                    config={"agents": ["release_train_engineer", "lean_portfolio_manager", "scrum_master", "chef_projet"]},
                ),
                WorkflowPhase(
                    id="pi-commitment", pattern_id="human-in-the-loop", name="Engagement Équipe — GO/NOGO",
                    ...
                    gate="checkpoint",
                    config={"agents": ["strat-cpo", "strat-cto", "release_train_engineer", "product_manager", "scrum_master"]},
                ),
                WorkflowPhase(
                    id="pi-publish", pattern_id="sequential", name="Publication Plan PI",
            ...
            config={
                "graph": {
                    "nodes": [
                        {"id": "n1", "agent_id": "product_manager", "x": 100, "y": 100, "label": "PM Vision", "phase": "pi-vision"},
                        {"id": "n2", "agent_id": "enterprise_architect", "x": 100, "y": 200, "label": "Archi Runway", "phase": "pi-vision"},
                        {"id": "n3", "agent_id": "release_train_engineer", "x": 100, "y": 300, "label": "RTE Cadre", "phase": "pi-vision"},
                        {"id": "n4", "agent_id": "lead_dev", "x": 300, "y": 80, "label": "Lead Estim", "phase": "pi-estimation"},
                        {"id": "n5", "agent_id": "qa_lead", "x": 300, "y": 180, "label": "QA Estim", "phase": "pi-estimation"},
                        {"id": "n6", "agent_id": "devops", "x": 300, "y": 280, "label": "DevOps Estim", "phase": "pi-estimation"},
                        {"id": "n7", "agent_id": "release_train_engineer", "x": 500, "y": 150, "label": "RTE Capacity", "phase": "pi-capacity"},
                        {"id": "n8", "agent_id": "lean_portfolio_manager", "x": 500, "y": 250, "label": "LPM Align", "phase": "pi-capacity"},
                        {"id": "n9", "agent_id": "strat-cpo", "x": 700, "y": 100, "label": "CPO GO/NOGO", "phase": "pi-commitment"},
                        {"id": "n10", "agent_id": "strat-cto", "x": 700, "y": 200, "label": "CTO GO/NOGO", "phase": "pi-commitment"},
                        {"id": "n11", "agent_id": "tech_writer", "x": 900, "y": 150, "label": "Publish", "phase": "pi-publish"},
                    ],
                    "edges": [
