...
**Многоагентная программная фабрика — автономные ИИ-агенты оркеструют полный жизненный цикл продукта**

[![License: AGPL v3](https://img.shields.io/badge/License-AGPL%20v3-blue.svg)](https://www.gnu.org/licenses/agpl-3.0)
[![Python 3.10+](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/downloads/)
[![FastAPI](https://img.shields.io/badge/FastAPI-0.104+-green.svg)](https://fastapi.tiangolo.com/)

**[Демо: sf.macaron-software.com](https://sf.macaron-software.com)**

[Возможности](#vozmozhnosti) · [Быстрый старт](#bystryy-start) · [Скриншоты](#skrinsoty) · [Архитектура](#arkhitektura) · [Участие](#uchastie)
...
**Нативное SwiftUI-приложение для macOS** (Apple Silicon и Rosetta 2) доступно вместе с веб-платформой — офлайн-экземпляр SF и удалённые коннекторы к OVH и Azure.
...
> Если macOS блокирует бинарник: **Системные настройки → Конфиденциальность и безопасность → Всё равно открыть**

### Возможности
- **Встроенная локальная SF** — агенты с Ollama/MLX (Qwen, Llama…) или API-ключами
- **3 удалённых коннектора** — Локальная SF / Демо OVH / Прод Azure (HA 2 узла)
- **100% ISO веб** — Агенты, Миссии, Проекты, TMA, Wiki, Аналитика, DORA, Evals, Идеация, RBAC
- **22 unit-теста** — WSJF, LLMConfig, онбординг, управление инстансами
...
### Рабочие процессы zur kontinuierlichen Verbesserung
...
### Студия Аннотаций — Визуальная Обратная Связь на Любой Странице

Встроенный визуальный слой аннотаций, превращающий любую страницу SF в совместный холст для проверки:

- **✏️ Кнопка Аннотировать** — нажмите для активации режима аннотаций; плавающая панель инструментов на каждой странице
- **Нажми для аннотации** — нажмите на любой элемент: баг 🐛, комментарий 💬, фича ✨, дизайн 🎨 или исправление текста 📝
- **Панель трассировки SAFe** — иконка персоны в топбаре → **Программа → Эпик → Фича → Истории**
- **Режим wireframe** — иконка сетки → скелет/shimmer вид для UX-инспекции
- **Создание тикетов** — каждая аннотация может запустить миссию исправления
- **Адаптация к теме** — использует CSS-переменные, подстраивается под светлую/тёмную тему
