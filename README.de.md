...
Stellen Sie sich eine **virtuelle Softwarefabrik** vor, in der 192 KI-Agenten ueber strukturierte Workflows zusammenarbeiten, der SAFe-Methodik folgen, TDD-Praktiken anwenden und automatisierte Qualitaets-Gates nutzen.
...
<tr>
<td width="50%">
<strong>Workflows — 46 integrierte Pipelines (/workflows)</strong><br>
...
Eine **native SwiftUI-macOS-App** (Apple Silicon und Rosetta 2) ergänzt die Web-Plattform mit einer vollständig offline-fähigen lokalen SF-Instanz und Remote-Verbindungen zu OVH und Azure.
...
> Falls macOS die App blockiert: **Systemeinstellungen → Datenschutz & Sicherheit → Trotzdem öffnen**

### Funktionen
- **Lokale SF integriert** — Agenten mit Ollama/MLX (Qwen, Llama…) oder API-Schlüsseln
- **3 Remote-Verbindungen** — Lokale SF / OVH Demo / Azure Prod (HA 2 Knoten)
- **100% ISO Web** — Agenten, Missionen, Projekte, TMA, Wiki, Analytik, DORA, Evals, Ideation, RBAC
- **22 Unit-Tests** — WSJF, LLMConfig, Onboarding, Instanzverwaltung
