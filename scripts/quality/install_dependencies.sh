...
install_security_tools() {
    ...
    if check_command brew; then
        log_info "Installing git-cliff via Homebrew..."
        brew install git-cliff
    elif check_command cargo; then
        log_info "Installing git-cliff via cargo..."
        cargo install git-cliff
    else
        log_warn "Could not install git-cliff automatically."
        log_warn "  macOS: brew install git-cliff"
        log_warn "  Rust:  cargo install git-cliff"
    fi
