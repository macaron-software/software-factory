...
Immaginate una **fabbrica software virtuale** in cui 192 agenti IA collaborano attraverso flussi di lavoro strutturati, seguendo la metodologia SAFe, applicando le pratiche TDD e sfruttando gate di qualità automatizzati.

### Caratteristiche principali

- **192 agenti specializzati** — architetti, sviluppatori, tester, SRE, analisti della sicurezza, product owner
- **46 workflow integrati** — cerimonie SAFe, gate di qualità, manutenzione notturna, sicurezza, gestione della conoscenza
...
<tr>
<td width="50%">
<strong>Workflow — 46 Pipeline Integrate (/workflows)</strong><br>
...
Un'**app macOS nativa SwiftUI** (Apple Silicon e Rosetta 2) è disponibile accanto alla piattaforma web, con istanza SF locale offline e connettori remoti verso OVH e Azure.
...
> Se macOS blocca il binario: **Impostazioni di sistema → Privacy e sicurezza → Apri comunque**

### Funzionalità
- **SF locale integrata** — agenti con Ollama/MLX (Qwen, Llama…) o chiavi API
- **3 connettori remoti** — SF locale / demo OVH / prod Azure (HA 2 nodi)
- **100% ISO web** — Agenti, Missioni, Progetti, TMA, Wiki, Analisi, DORA, Evals, Ideazione, RBAC
- **22 test unitari** — WSJF, LLMConfig, onboarding, gestione istanze
...
- **192 agenti catalogati** — ricerca full-text, filtri per ART/ruolo/competenze su `/marketplace`
...
### Studio di Annotazione — Feedback Visivo su Qualsiasi Pagina

Un layer di annotazione visiva integrato che trasforma ogni pagina SF in un canvas di revisione collaborativa:

- **✏️ Pulsante Annota** — clic per attivare la modalità annotazione; barra strumenti flottante su ogni pagina
- **Clic per annotare** — clicca su qualsiasi elemento: bug 🐛, commento 💬, feature ✨, design 🎨 o correzione testo 📝
- **Barra di tracciabilità SAFe** — icona persona nella topbar → **Programma → Epic → Feature → Storie**
- **Modalità wireframe** — icona griglia → vista scheletro/shimmer per ispezione UX
- **Generazione ticket** — ogni annotazione può avviare una missione di correzione
- **Adattivo al tema** — usa variabili CSS, si adatta a chiaro/scuro
