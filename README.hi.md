...
**नेटिव SwiftUI macOS ऐप** (Apple Silicon और Rosetta 2 सपोर्ट) वेब प्लेटफॉर्म के साथ उपलब्ध है — पूरी तरह ऑफलाइन लोकल SF इंस्टेंस और OVH/Azure रिमोट कनेक्टर्स के साथ।
...
> अगर macOS ब्लॉक करे: **सिस्टम सेटिंग्स → प्राइवेसी & सिक्योरिटी → फिर भी खोलें**

### विशेषताएं
- **लोकल SF इन-बिल्ट** — Ollama/MLX (Qwen, Llama...) या API कीज़ के साथ एजेंट
- **3 रिमोट कनेक्टर** — लोकल SF / OVH डेमो / Azure प्रोड (HA 2 नोड्स)
- **वेब से 100% ISO** — एजेंट, मिशन, प्रोजेक्ट, TMA, Wiki, एनालिटिक्स, DORA, Evals, आइडिएशन, RBAC
- **22 यूनिट टेस्ट** — WSJF, LLMConfig, ऑनबोर्डिंग, इंस्टेंस मैनेजमेंट
...
### एनोटेशन स्टूडियो — किसी भी पृष्ठ पर दृश्य प्रतिक्रिया

एक अंतर्निहित दृश्य एनोटेशन परत जो प्रत्येक SF पृष्ठ को सहयोगी समीक्षा कैनवास में बदल देती है:

- **✏️ एनोटेट बटन** — एनोटेशन मोड सक्रिय करने के लिए क्लिक करें; प्रत्येक पृष्ठ पर फ्लोटिंग टूलबार
- **एनोटेट करने के लिए क्लिक करें** — किसी भी तत्व पर क्लिक करें: बग 🐛, टिप्पणी 💬, फीचर ✨, डिज़ाइन 🎨 या पाठ सुधार 📝
- **SAFe ट्रेसेबिलिटी बार** — टॉपबार में पर्सोना आइकन → **प्रोग्राम → एपिक → फीचर → स्टोरी**
- **वायरफ्रेम मोड** — ग्रिड आइकन → UX निरीक्षण के लिए स्केलेटन/शिमर व्यू
- **टिकट जनरेशन** — प्रत्येक एनोटेशन से सीधे फिक्स मिशन शुरू किया जा सकता है
- **थीम-अनुकूली** — CSS चर का उपयोग करता है, लाइट/डार्क थीम के अनुसार अनुकूलित होता है
