...
**Multi-Agent Softwarefabriek — Autonome AI-agenten orkestreren de volledige productlevenscyclus**
...
[Functies](#functies) · [Snel starten](#snel-starten) · [Screenshots](#screenshots) · [Architectuur](#architectuur) · [Bijdragen](#bijdragen)
...
Software Factory is een **autonoom multi-agent platform** dat de volledige softwareontwikkelingscyclus orkestreert — van idee tot deployment — met behulp van gespecialiseerde AI-agenten die samenwerken.

Stel je een **virtuele softwarefabriek** voor waar 192 AI-agenten samenwerken via gestructureerde workflows, de SAFe-methodologie volgen, TDD-praktijken toepassen en geautomatiseerde kwaliteitspoorten gebruiken.
...
<tr>
<td width="50%">
<strong>Werkstromen — 46 Ingebouwde Pipelines (/workflows)</strong><br>
...
Een **native SwiftUI macOS-app** (Apple Silicon en Rosetta 2) is beschikbaar naast het webplatform, met een volledig offline lokale SF-instantie en externe verbindingen naar OVH en Azure.
...
> Als macOS blokkeert: **Systeeminstellingen → Privacy en beveiliging → Toch openen**

### Functies
- **Lokale SF ingebouwd** — agenten met Ollama/MLX (Qwen, Llama…) of API-sleutels
- **3 externe connectors** — Lokale SF / OVH-demo / Azure prod (HA 2 nodes)
- **100% ISO web** — Agenten, Missies, Projecten, TMA, Wiki, Analytics, DORA, Evals, Ideatie, RBAC
- **22 unit-tests** — WSJF, LLMConfig, onboarding, instantiebeheer
