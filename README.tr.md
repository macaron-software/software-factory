...
**Cok Ajanli Yazilim Fabrikasi — Otonon Yapay Zeka Ajanlari Tam Urun Yasam Dongusu Orkestrasyon Yapar**
...
[Ozellikler](#ozellikler) · [Hizli Baslangic](#hizli-baslangic) · [Ekran Goruntuleri](#ekran-goruntuleri) · [Mimari](#mimari) · [Katki](#katki)
...
**Yerel SwiftUI macOS uygulaması** (Apple Silicon ve Rosetta 2 desteği) web platformuyla birlikte kullanılabilir — tamamen çevrimdışı yerel SF örneği ve OVH/Azure uzak bağlayıcıları.
...
> macOS engellerse: **Sistem Ayarları → Gizlilik ve Güvenlik → Yine de Aç**

### Özellikler
- **Yerleşik yerel SF** — Ollama/MLX (Qwen, Llama…) veya API anahtarlarıyla ajanlar
- **3 uzak bağlayıcı** — Yerel SF / OVH demo / Azure prod (HA 2 düğüm)
- **Web ile %100 eşdeğer** — Ajanlar, Görevler, Projeler, TMA, Wiki, Analitik, DORA, Evals, İdeасyon, RBAC
- **22 birim testi** — WSJF, LLMConfig, katılım, örnek yönetimi
...
### Is Akislari zur kontinuierlichen Verbesserung
