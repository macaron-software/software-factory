...
**Fleragents Mjukvarifabrik — Autonoma AI-agenter orkestrerar hela produktens livscykel**
...
[Funktioner](#funktioner) · [Snabbstart](#snabbstart) · [Skarmbilder](#skarmbilder) · [Arkitektur](#arkitektur) · [Bidra](#bidra)
...
En **native SwiftUI macOS-app** (Apple Silicon och Rosetta 2) finns tillgänglig vid sidan av webbplattformen, med en helt offline lokal SF-instans och fjärranslutningar till OVH och Azure.
...
> Om macOS blockerar: **Systeminställningar → Integritet och säkerhet → Öppna ändå**

### Funktioner
- **Inbyggd lokal SF** — agenter med Ollama/MLX (Qwen, Llama…) eller API-nycklar
- **3 fjärranslutningar** — Lokal SF / OVH-demo / Azure prod (HA 2 noder)
- **100% ISO webb** — Agenter, Uppdrag, Projekt, TMA, Wiki, Analys, DORA, Evals, Idéation, RBAC
- **22 enhetstester** — WSJF, LLMConfig, onboarding, instanshantering
...
### Arbetsflöden zur kontinuierlichen Verbesserung
