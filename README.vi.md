...
**Nhà máy phần mềm đa tác nhân — Tác nhân AI tự trị điều phối vòng đời sản phẩm hoàn chỉnh**
...
[Tính năng](#tinh-nang) · [Bắt đầu nhanh](#bat-dau-nhanh) · [Ảnh chụp màn hình](#anh-chup-man-hinh) · [Kiến trúc](#kien-truc) · [Đóng góp](#dong-gop)
...
Software Factory là **nền tảng đa tác nhân tự trị** điều phối toàn bộ chu trình phát triển phần mềm — từ ý tưởng đến triển khai — sử dụng các tác nhân AI chuyên biệt làm việc cùng nhau.

Hãy tưởng tượng một **nhà máy phần mềm ảo** nơi 192 tác nhân AI cộng tác thông qua các quy trình làm việc có cấu trúc, tuân theo phương pháp SAFe, áp dụng thực hành TDD và sử dụng các cổng chất lượng tự động.
...
<tr>
<td width="50%">
<strong>Luồng công việc — 46 Pipeline tích hợp sẵn (/workflows)</strong><br>
...
**Ứng dụng macOS native SwiftUI** (hỗ trợ Apple Silicon và Rosetta 2) có sẵn cùng với nền tảng web — phiên bản SF cục bộ hoàn toàn ngoại tuyến và kết nối từ xa đến OVH và Azure.
...
> Nếu macOS chặn: **Cài đặt hệ thống → Quyền riêng tư & Bảo mật → Vẫn mở**

### Tính năng
- **SF cục bộ tích hợp** — agent với Ollama/MLX (Qwen, Llama…) hoặc API key
- **3 kết nối từ xa** — SF cục bộ / Demo OVH / Prod Azure (HA 2 node)
- **100% ISO web** — Agent, Nhiệm vụ, Dự án, TMA, Wiki, Phân tích, DORA, Evals, Sáng tạo, RBAC
- **22 unit test** — WSJF, LLMConfig, onboarding, quản lý phiên bản
...
### Quy trình làm việc zur kontinuierlichen Verbesserung
